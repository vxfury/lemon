...
int main()
{
    ...
    // containers
    {
        ...
        {
            std::cout << "key6: [";
            for (auto mm : mgr.get<std::unordered_map<std::string, std::vector<int>>, std::string>("key6", {})) {
                std::cout << mm.first << ": [";
...

        {
            std::cout << "key7: [";
            for (auto mm :
                 mgr.get<std::unordered_map<std::vector<int>, std::vector<std::string>, hashfun>, std::string>("key7",
                                                                                                               {})) {
                std::cout << "[";
                for (auto v : mm.first) {
                    std::cout << v << ", ";
