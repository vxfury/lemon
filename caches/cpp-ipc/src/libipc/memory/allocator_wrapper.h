...
class allocator_wrapper {
  ...
  public:
    ...
    allocator_wrapper &operator=(const allocator_wrapper<T, AllocP> &) noexcept
    {
        return *this;
    }
    ...
    template <typename U, typename AllocU>
    allocator_wrapper(const allocator_wrapper<U, AllocU> &) noexcept
    {
    }
    template <typename U, typename AllocU>
    allocator_wrapper &operator=(const allocator_wrapper<U, AllocU> &) noexcept
    {
        return *this;
    }
