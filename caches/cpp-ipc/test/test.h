...
template <>
struct unit<std::chrono::nanoseconds> {
...
template <>
struct unit<std::chrono::microseconds> {
    constexpr static char const *str() noexcept
    {
        return "us";
    }
...
template <>
struct unit<std::chrono::milliseconds> {
    constexpr static char const *str() noexcept
    {
        return "ms";
    }
...
template <>
struct unit<std::chrono::seconds> {
    constexpr static char const *str() noexcept
    {
        return "sec";
    }
...
struct test_stopwatch {
    ...
    void print_elapsed(int N, int Loops, char const *message = "")
    {
        ...
        std::cout << "[" << N << ", \t" << Loops << "] " << message << "\t" << (double(ts) / double(Loops)) << " "
                  << unit<ToDur>::str() << std::endl;
    }
    ...
    void print_elapsed(int N, int M, int Loops, char const *message = "")
    {
        ...
        std::cout << "[" << N << "-" << M << ", \t" << Loops << "] " << message << "\t"
                  << (double(ts) / double(Factor ? (Loops * Factor) : (Loops * N))) << " " << unit<ToDur>::str()
                  << std::endl;
    }
