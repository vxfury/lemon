...
#define EXPECT(ACTUAL, IS_ZERO, TYPE, INITIAL)                                                                   \
    do {                                                                                                         \
        ...
        if ((ACTUAL) != expected) {                                                                              \
            ...
            exit(EXIT_FAILURE);                                                                                  \
                                                                                                                 ...
                                                                                                                 \
        if ((IS_ZERO) != ((ACTUAL) == 0)) {                                                                      \
            printf("FAIL [ %s != %s ]\n", ((IS_ZERO) ? "true" : "false"), (((ACTUAL) == 0) ? "true" : "false")); \
            exit(EXIT_FAILURE);                                                                                  \
        }                                                                                                        \
    } while (0)

#define TEST_ZERO(TYPE, SUFFIX)                      \
    do {                                             \
        TYPE datum;                                  \
        bool is_zero;                                \
                                                     \
...
#define TEST_IS_ZERO(TYPE, SUFFIX)                      \
    do {                                                \
        TYPE datum;                                     \
        bool is_zero;                                   \
                                                        \
