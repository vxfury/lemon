 ...
 * the value.
 */
auint16_t::auint16_t(uint16_t aValue) : _value(aValue) {}
 ...
 * around.
 */
auint16_t::auint16_t(const auint16_t &anOther) : _value(anOther.getValue()) {}
 ...
 * the value.
 */
aint16_t::aint16_t(int16_t aValue) : _value(aValue) {}
 ...
 * around.
 */
aint16_t::aint16_t(const aint16_t &anOther) : _value(anOther.getValue()) {}
