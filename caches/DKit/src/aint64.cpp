 ...
 * the value.
 */
auint64_t::auint64_t(uint64_t aValue) : _value(aValue) {}
 ...
 * around.
 */
auint64_t::auint64_t(const auint64_t &anOther) : _value(anOther.getValue()) {}
...
bool auint64_t::operator<(const auint64_t &aValue) const
{
    return (getValue() < aValue.getValue());
}
 ...
 * the value.
 */
aint64_t::aint64_t(int64_t aValue) : _value(aValue) {}
 ...
 * around.
 */
aint64_t::aint64_t(const aint64_t &anOther) : _value(anOther.getValue()) {}
...
bool aint64_t::operator<(const aint64_t &aValue) const
{
    return (getValue() < aValue.getValue());
}
