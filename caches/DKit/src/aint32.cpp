 ...
 * the value.
 */
auint32_t::auint32_t(uint32_t aValue) : _value(aValue) {}
 ...
 * around.
 */
auint32_t::auint32_t(const auint32_t &anOther) : _value(anOther.getValue()) {}
 ...
 * the value.
 */
aint32_t::aint32_t(int32_t aValue) : _value(aValue) {}
 ...
 * around.
 */
aint32_t::aint32_t(const aint32_t &anOther) : _value(anOther.getValue()) {}
