 ...
 * the value.
 */
auint8_t::auint8_t(uint8_t aValue) : _value(aValue) {}
 ...
 * around.
 */
auint8_t::auint8_t(const auint8_t &anOther) : _value(anOther.getValue()) {}
 ...
 * the value.
 */
aint8_t::aint8_t(int8_t aValue) : _value(aValue) {}
 ...
 * around.
 */
aint8_t::aint8_t(const aint8_t &anOther) : _value(anOther.getValue()) {}
