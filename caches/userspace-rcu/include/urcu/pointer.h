...
#define rcu_dereference(p)                                                                                           \
    __extension__({                                                                                                  \
        __typeof__(p) _________p1 = URCU_FORCE_CAST(__typeof__(p), rcu_dereference_sym(URCU_FORCE_CAST(void *, p))); \
        (_________p1);                                                                                               \
    })
...
#define rcu_cmpxchg_pointer(p, old, _new)                                                                          \
    __extension__({                                                                                                \
        ...
        __typeof__(*(p)) _________p1 = URCU_FORCE_CAST(                                                            \
            __typeof__(*(p)), rcu_cmpxchg_pointer_sym(URCU_FORCE_CAST(void **, p), _________pold, _________pnew)); \
        (_________p1);                                                                                             \
    })
...
#define rcu_xchg_pointer(p, v)                                                                                 \
    __extension__({                                                                                            \
        ...
        __typeof__(*(p)) _________p1 =                                                                         \
            URCU_FORCE_CAST(__typeof__(*(p)), rcu_xchg_pointer_sym(URCU_FORCE_CAST(void **, p), _________pv)); \
        (_________p1);                                                                                         \
    })
...
#define rcu_set_pointer(p, v)                                                \
    do {                                                                     \
        __typeof__(*(p)) _________pv = (v);                                  \
        (void)rcu_set_pointer_sym(URCU_FORCE_CAST(void **, p), _________pv); \
    } while (0)
