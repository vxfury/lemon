...
static inline void _cds_lfs_node_init_rcu(struct cds_lfs_node_rcu *node __attribute__((unused))) {}
 ...
 */
static inline int _cds_lfs_push_rcu(struct cds_lfs_stack_rcu *s, struct cds_lfs_node_rcu *node)
{
