 ...
 */
static inline void _cds_lfs_node_init(struct cds_lfs_node *node __attribute__((unused))) {}
 ...
 * cds_lfs_init().
 */
static inline void _cds_lfs_destroy(struct cds_lfs_stack *s)
{
...
static inline bool ___cds_lfs_empty_head(struct cds_lfs_head *head)
{
    return head == NULL;
}
 ...
 */
static inline bool _cds_lfs_empty(cds_lfs_stack_ptr_t s)
{
 ...
 */
static inline bool _cds_lfs_push(cds_lfs_stack_ptr_t u_s, struct cds_lfs_node *node)
{
    struct __cds_lfs_stack *s = u_s._s;
    struct cds_lfs_head *head = NULL;
    struct cds_lfs_head *new_head = caa_container_of(node, struct cds_lfs_head, node);
 ...
 */
static inline struct cds_lfs_node *___cds_lfs_pop(cds_lfs_stack_ptr_t u_s)
{
    struct __cds_lfs_stack *s = u_s._s;
    ...
    for (;;) {
        ...
        if (___cds_lfs_empty_head(head)) return NULL; /* Empty stack */
        ...
        if (uatomic_cmpxchg(&s->head, head, next_head) == head) return &head->node;
 ...
 *    __cds_lfs_pop_all(). (multi-provider/single-consumer scheme).
 */
static inline struct cds_lfs_head *___cds_lfs_pop_all(cds_lfs_stack_ptr_t u_s)
{
    struct __cds_lfs_stack *s = u_s._s;
