...
#define cds_wfcq_dequeue_with_state_blocking _cds_wfcq_dequeue_with_state_blocking
...
#define __cds_wfcq_dequeue_with_state_blocking ___cds_wfcq_dequeue_with_state_blocking
...
#define __cds_wfcq_dequeue_with_state_nonblocking ___cds_wfcq_dequeue_with_state_nonblocking
 ...
 * cds_wfcq_init().
 */
extern void cds_wfcq_destroy(struct cds_wfcq_head *head, struct cds_wfcq_tail *tail);
 ...
 */
extern bool cds_wfcq_empty(cds_wfcq_head_ptr_t head, struct cds_wfcq_tail *tail);
 ...
 */
extern bool cds_wfcq_enqueue(cds_wfcq_head_ptr_t head, struct cds_wfcq_tail *tail, struct cds_wfcq_node *node);
 ...
 */
extern struct cds_wfcq_node *cds_wfcq_dequeue_with_state_blocking(struct cds_wfcq_head *head,
 ...
 * dest queue.
 */
extern enum cds_wfcq_ret cds_wfcq_splice_blocking(struct cds_wfcq_head *dest_q_head, struct cds_wfcq_tail *dest_q_tail,
                                                  struct cds_wfcq_head *src_q_head, struct cds_wfcq_tail *src_q_tail);
 ...
 * caller.
 */
extern struct cds_wfcq_node *__cds_wfcq_dequeue_blocking(cds_wfcq_head_ptr_t head, struct cds_wfcq_tail *tail);
 ...
 * last node of the queue into state (CDS_WFCQ_STATE_LAST).
 */
extern struct cds_wfcq_node *__cds_wfcq_dequeue_with_state_blocking(cds_wfcq_head_ptr_t head,
                                                                    struct cds_wfcq_tail *tail, int *state);
 ...
 */
extern struct cds_wfcq_node *__cds_wfcq_dequeue_nonblocking(cds_wfcq_head_ptr_t head, struct cds_wfcq_tail *tail);
 ...
 */
extern struct cds_wfcq_node *__cds_wfcq_dequeue_with_state_nonblocking(cds_wfcq_head_ptr_t head,
                                                                       struct cds_wfcq_tail *tail, int *state);
 ...
 */
extern enum cds_wfcq_ret __cds_wfcq_splice_blocking(cds_wfcq_head_ptr_t dest_q_head, struct cds_wfcq_tail *dest_q_tail,
                                                    cds_wfcq_head_ptr_t src_q_head, struct cds_wfcq_tail *src_q_tail);
 ...
 */
extern enum cds_wfcq_ret __cds_wfcq_splice_nonblocking(cds_wfcq_head_ptr_t dest_q_head,
 ...
 */
extern struct cds_wfcq_node *__cds_wfcq_first_blocking(cds_wfcq_head_ptr_t head, struct cds_wfcq_tail *tail);
 ...
 * it needs to block.
 */
extern struct cds_wfcq_node *__cds_wfcq_first_nonblocking(cds_wfcq_head_ptr_t head, struct cds_wfcq_tail *tail);
 ...
 * otherwise.
 */
extern struct cds_wfcq_node *__cds_wfcq_next_blocking(cds_wfcq_head_ptr_t head, struct cds_wfcq_tail *tail,
                                                      struct cds_wfcq_node *node);
 ...
 * it needs to block.
 */
extern struct cds_wfcq_node *__cds_wfcq_next_nonblocking(cds_wfcq_head_ptr_t head, struct cds_wfcq_tail *tail,
                                                         struct cds_wfcq_node *node);
...
#define __cds_wfcq_for_each_blocking(head, tail, node) \
    for (node = __cds_wfcq_first_blocking(head, tail); node != NULL; node = __cds_wfcq_next_blocking(head, tail, node))
...
#define __cds_wfcq_for_each_blocking_safe(head, tail, node, n)                                                         \
    for (node = __cds_wfcq_first_blocking(head, tail), n = (node ? __cds_wfcq_next_blocking(head, tail, node) : NULL); \
         node != NULL; node = n, n = (node ? __cds_wfcq_next_blocking(head, tail, node) : NULL))
...
template <typename T>
static inline bool cds_wfcq_empty(T head, struct cds_wfcq_tail *tail)
{
    return cds_wfcq_empty(cds_wfcq_head_cast_cpp(head), tail);
}

template <typename T>
static inline bool cds_wfcq_enqueue(T head, struct cds_wfcq_tail *tail, struct cds_wfcq_node *node)
{
    return cds_wfcq_enqueue(cds_wfcq_head_cast_cpp(head), tail, node);
}

template <typename T>
static inline struct cds_wfcq_node *__cds_wfcq_dequeue_blocking(T head, struct cds_wfcq_tail *tail)
{
    return __cds_wfcq_dequeue_blocking(cds_wfcq_head_cast_cpp(head), tail);
}

template <typename T>
static inline struct cds_wfcq_node *__cds_wfcq_dequeue_with_state_blocking(T head, struct cds_wfcq_tail *tail,
                                                                           int *state)
{
    return __cds_wfcq_dequeue_with_state_blocking(cds_wfcq_head_cast_cpp(head), tail, state);
}

template <typename T>
static inline struct cds_wfcq_node *__cds_wfcq_dequeue_nonblocking(T head, struct cds_wfcq_tail *tail)
{
    return __cds_wfcq_dequeue_nonblocking(cds_wfcq_head_cast_cpp(head), tail);
}

template <typename T>
static inline struct cds_wfcq_node *__cds_wfcq_dequeue_with_state_nonblocking(T head, struct cds_wfcq_tail *tail,
                                                                              int *state)
{
    return __cds_wfcq_dequeue_with_state_nonblocking(cds_wfcq_head_cast_cpp(head), tail, state);
}

template <typename T, typename U>
static inline enum cds_wfcq_ret __cds_wfcq_splice_blocking(T dest_q_head, struct cds_wfcq_tail *dest_q_tail,
                                                           U src_q_head, struct cds_wfcq_tail *src_q_tail)
{
    return __cds_wfcq_splice_blocking(cds_wfcq_head_cast_cpp(dest_q_head), dest_q_tail,
                                      cds_wfcq_head_cast_cpp(src_q_head), src_q_tail);
}

template <typename T, typename U>
static inline enum cds_wfcq_ret __cds_wfcq_splice_nonblocking(T dest_q_head, struct cds_wfcq_tail *dest_q_tail,
                                                              U *src_q_head, struct cds_wfcq_tail *src_q_tail)
{
    return __cds_wfcq_splice_nonblocking(cds_wfcq_head_cast_cpp(dest_q_head), dest_q_tail,
                                         cds_wfcq_head_cast_cpp(src_q_head), src_q_tail);
}

template <typename T>
static inline struct cds_wfcq_node *__cds_wfcq_first_blocking(T head, struct cds_wfcq_tail *tail)
{
    return __cds_wfcq_first_blocking(cds_wfcq_head_cast_cpp(head), tail);
}

template <typename T>
static inline struct cds_wfcq_node *__cds_wfcq_first_nonblocking(T head, struct cds_wfcq_tail *tail)
{
    return __cds_wfcq_first_nonblocking(cds_wfcq_head_cast_cpp(head), tail);
}

template <typename T>
static inline struct cds_wfcq_node *__cds_wfcq_next_blocking(T head, struct cds_wfcq_tail *tail,
                                                             struct cds_wfcq_node *node)
{
...
template <typename T>
static inline struct cds_wfcq_node *__cds_wfcq_next_nonblocking(T head, struct cds_wfcq_tail *tail,
                                                                struct cds_wfcq_node *node)
{
