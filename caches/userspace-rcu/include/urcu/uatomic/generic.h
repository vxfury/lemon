...
static inline __attribute__((always_inline, noreturn)) void _uatomic_link_error(void)
{
#ifdef ILLEGAL_INSTR
    /*
...
static inline __attribute__((always_inline)) unsigned long _uatomic_cmpxchg(void *addr, unsigned long old,
...
#define uatomic_cmpxchg(addr, old, _new)                                                                        \
    ((__typeof__(*(addr)))_uatomic_cmpxchg((addr), caa_cast_long_keep_sign(old), caa_cast_long_keep_sign(_new), \
                                           sizeof(*(addr))))
...
#ifndef uatomic_and
static inline __attribute__((always_inline)) void _uatomic_and(void *addr, unsigned long val, int len)
{
    switch (len) {
#ifdef UATOMIC_HAS_ATOMIC_BYTE
        case 1:
...
#define uatomic_and(addr, v)             (_uatomic_and((addr), caa_cast_long_keep_sign(v), sizeof(*(addr))))
...
#ifndef uatomic_or
static inline __attribute__((always_inline)) void _uatomic_or(void *addr, unsigned long val, int len)
{
    switch (len) {
#ifdef UATOMIC_HAS_ATOMIC_BYTE
        case 1:
...
#define uatomic_or(addr, v)             (_uatomic_or((addr), caa_cast_long_keep_sign(v), sizeof(*(addr))))
...
static inline __attribute__((always_inline)) unsigned long _uatomic_add_return(void *addr, unsigned long val, int len)
{
    switch (len) {
#ifdef UATOMIC_HAS_ATOMIC_BYTE
        case 1:
...
#define uatomic_add_return(addr, v) \
    ((__typeof__(*(addr)))_uatomic_add_return((addr), caa_cast_long_keep_sign(v), sizeof(*(addr))))
#endif /* #ifndef uatomic_add_return */

#ifndef uatomic_xchg
/* xchg */

static inline __attribute__((always_inline)) unsigned long _uatomic_exchange(void *addr, unsigned long val, int len)
{
    switch (len) {
#ifdef UATOMIC_HAS_ATOMIC_BYTE
        case 1: {
...
#define uatomic_xchg(addr, v) \
    ((__typeof__(*(addr)))_uatomic_exchange((addr), caa_cast_long_keep_sign(v), sizeof(*(addr))))
...
static inline __attribute__((always_inline)) unsigned long _uatomic_add_return(void *addr, unsigned long val, int len)
{
    switch (len) {
        ...
        case 1: {
            ...
            do {
                old = oldt;
                oldt = uatomic_cmpxchg((uint8_t *)addr, old, old + val);
            } while (oldt != old);
        ...
        case 2: {
            ...
            do {
                old = oldt;
                oldt = uatomic_cmpxchg((uint16_t *)addr, old, old + val);
            } while (oldt != old);
        ...
        case 4: {
            ...
            do {
                old = oldt;
                oldt = uatomic_cmpxchg((uint32_t *)addr, old, old + val);
            } while (oldt != old);
        ...
        case 8: {
            ...
            do {
                old = oldt;
                oldt = uatomic_cmpxchg((uint64_t *)addr, old, old + val);
            } while (oldt != old);
...
static inline __attribute__((always_inline)) unsigned long _uatomic_exchange(void *addr, unsigned long val, int len)
{
    switch (len) {
        ...
        case 1: {
            ...
            do {
                old = oldt;
                oldt = uatomic_cmpxchg((uint8_t *)addr, old, val);
            } while (oldt != old);
        ...
        case 2: {
            ...
            do {
                old = oldt;
                oldt = uatomic_cmpxchg((uint16_t *)addr, old, val);
            } while (oldt != old);
        ...
        case 4: {
            ...
            do {
                old = oldt;
                oldt = uatomic_cmpxchg((uint32_t *)addr, old, val);
            } while (oldt != old);
        ...
        case 8: {
            ...
            do {
                old = oldt;
                oldt = uatomic_cmpxchg((uint64_t *)addr, old, val);
            } while (oldt != old);
...
#define uatomic_sub_return(addr, v)      uatomic_add_return((addr), -(caa_cast_long_keep_sign(v)))
#define uatomic_sub(addr, v)             uatomic_add((addr), -(caa_cast_long_keep_sign(v)))
