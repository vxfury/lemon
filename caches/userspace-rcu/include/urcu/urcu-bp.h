...
#define urcu_bp_dereference(p)                                                                   \
    __extension__({                                                                              \
        __typeof__(p) _________p1 =                                                              \
            URCU_FORCE_CAST(__typeof__(p), urcu_bp_dereference_sym(URCU_FORCE_CAST(void *, p))); \
        (_________p1);                                                                           \
    })
...
#define urcu_bp_cmpxchg_pointer(p, old, _new)                                                                          \
    __extension__({                                                                                                    \
        ...
        __typeof__(*(p)) _________p1 = URCU_FORCE_CAST(                                                                \
            __typeof__(*(p)), urcu_bp_cmpxchg_pointer_sym(URCU_FORCE_CAST(void **, p), _________pold, _________pnew)); \
        (_________p1);                                                                                                 \
    })
...
#define urcu_bp_xchg_pointer(p, v)                                                                                 \
    __extension__({                                                                                                \
        ...
        __typeof__(*(p)) _________p1 =                                                                             \
            URCU_FORCE_CAST(__typeof__(*(p)), urcu_bp_xchg_pointer_sym(URCU_FORCE_CAST(void **, p), _________pv)); \
        (_________p1);                                                                                             \
    })
...
#define urcu_bp_set_pointer(p, v)                                                                                 \
    __extension__({                                                                                               \
        __typeof__(*(p)) _________pv = (v);                                                                       \
        __typeof__(*(p)) _________p1 =                                                                            \
            URCU_FORCE_CAST(__typeof__(*(p)), urcu_bp_set_pointer_sym(URCU_FORCE_CAST(void **, p), _________pv)); \
        (_________p1);                                                                                            \
    })
