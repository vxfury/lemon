...
struct hash_list<std::tuple<Functors...>> {
    ...
    hash_list(hash_tuple_type const &t) : hash_tuple(t) {}
    hash_list(hash_tuple_type &&t) : hash_tuple(std::forward<hash_tuple_type>(t)) {}
...
struct hash_list_wrapper {
    ...
    hash_list_wrapper() {}
    hash_list_wrapper(hash_tuple_type const &t) : m_wrappedList(t) {}
    hash_list_wrapper(hash_tuple_type &&t) : m_wrappedList(std::forward<hash_tuple_type>(t)) {}
