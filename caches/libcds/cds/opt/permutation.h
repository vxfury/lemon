...
class random_permutation {
  ...
  public:
    ...
    random_permutation(size_t nLength) : m_nCur(0), m_nStart(0), m_nMod(integer_type(nLength))
    {
        reset();
    }
...
class random2_permutation {
  ...
  public:
    ...
    */
    random2_permutation(size_t nLength) : m_nCur(0), m_nStart(0), m_nMask(integer_type(nLength) - 1)
    {
...
class random_shuffle_permutation {
  ...
  public:
    /// Initializes the generator of arbitrary length \p nLength
    random_shuffle_permutation(size_t nLength) : m_pCur(nullptr)
    {
...
class skew_permutation {
  ...
  public:
    ...
    skew_permutation(integer_type nOffset, ///< The offset, i.e. first value of generated sequence
                     size_t nLength        ///< The length of sequence
                     )
        : m_Gen(nLength), m_nOffset(nOffset)
    {
    }
