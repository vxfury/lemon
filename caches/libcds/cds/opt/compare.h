...
/**
    The option sets a binary predicate that tests whether a value of a specified type is less than another value of that
   type. \p Functor interface is similar to \p std::less predicate interface. The standard predicate \p std::less can
   act as \p Functor: \code typedef cds::opt::less< std::less< int > > opt_less \endcode
...
struct make_comparator_from {
    ...
    typedef typename std::conditional<std::is_same<compare, opt::none>::value,
                                      typename std::conditional<std::is_same<less, opt::none>::value, DefaultCmp,
                                                                make_comparator_from_less<less>>::type,
                                      compare>::type type;
};


template <typename T, typename Traits, bool Forced = true>
using make_comparator =
    make_comparator_from<T, Traits,
...
struct make_comparator_from_option_list {
    ...
    typedef typename make_comparator<
        T, typename opt::make_options<typename opt::find_type_traits<default_traits, Options...>::type,
...
/**
    The option sets a binary predicate that tests whether a value of a specified type is equal to another value of that
   type. \p Functor interface is similar to \p std::equal_to predicate interface. The standard predicate \p
   std::equal_to can act as \p Functor: \code typedef cds::opt::equal_to< std::equal_to< int > > opt_equal_to \endcode
...
struct make_equal_to {
    ...
    typedef typename std::conditional<
        ...
        typename std::conditional<
            ...
            typename std::conditional<std::is_same<less, opt::none>::value,
