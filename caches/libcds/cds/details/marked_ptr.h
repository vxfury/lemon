...
class atomic<cds::details::marked_ptr<T, Bitmask> > {
  ...
  public:
    ...
    bool compare_exchange_weak(marked_ptr &expected, marked_ptr desired, memory_order success_order,
    ...
    bool compare_exchange_strong(marked_ptr &expected, marked_ptr desired, memory_order success_order,
                                 memory_order failure_order) volatile noexcept
    {
    ...
    bool compare_exchange_weak(marked_ptr &expected, marked_ptr desired,
                               memory_order success_order = memory_order_seq_cst) noexcept
    {
        return m_atomic.compare_exchange_weak(expected.impl_ref(), desired.all(), success_order);
    }
    ...
    constexpr atomic() noexcept : m_atomic(nullptr) {}

    constexpr explicit atomic(marked_ptr val) noexcept : m_atomic(val.all()) {}
    constexpr explicit atomic(T *p) noexcept : m_atomic(p) {}
