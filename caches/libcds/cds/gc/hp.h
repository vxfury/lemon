...
class basic_smr {
  ...
  public:
    ...
    */
    ...
    static void Construct(size_t nHazardPtrCount = 0, ///< Hazard pointer count per thread
                          size_t nMaxThreadCount = 0, ///< Max count of simultaneous working thread in your application
                          size_t nMaxRetiredPtrCount = 0, ///< Capacity of the array of retired objects for the thread
                          scan_type nScanType = inplace   ///< Scan type (see \ref scan_type enum)
    )
  ...
  private:
    CDS_EXPORT_API basic_smr(size_t nHazardPtrCount, ///< Hazard pointer count per thread
...
class generic_smr : public basic_smr {
  public:
    ...
    {
        if (!tls_manager::getTLS()) tls_manager::setTLS(instance().alloc_thread_data());
    }
...
class generic_HP {
    ...
    */
    class Guard {
      public:
        ...
        */
        Guard() : guard_(hp_implementation::tls()->hazards_.alloc()) {}
        ...
        */
        void link()
        {
            if (!guard_) guard_ = hp_implementation::tls()->hazards_.alloc();
        }
    ...
    */
    ...
    class guarded_ptr {
      ...
      public:
        ...
        //@cond
        explicit guarded_ptr(hp::details::guard *g) noexcept : guard_(g) {}
  ...
  public:
    ...
    */
    generic_HP(size_t nHazardPtrCount = 0,     ///< Hazard pointer count per thread
               size_t nMaxThreadCount = 0,     ///< Max count of simultaneous working thread in your application
               size_t nMaxRetiredPtrCount = 0, ///< Capacity of the array of retired objects for the thread
               scan_type nScanType = scan_type::inplace ///< Scan type (see \p scan_type enum)
    )
    {
        hp_implementation::construct(nHazardPtrCount, nMaxThreadCount, nMaxRetiredPtrCount,
    ...
    */
    ...
    static void retire(T *p, void (*func)(void *))
    {
        ...
        if (!rec->retired_.push(hp::details::retired_ptr(p, func))) hp_implementation::instance().scan(rec);
    }
    ...
    */
    ...
    {
        if (!hp_implementation::tls()->retired_.push(hp::details::retired_ptr(
                p, +[](void *p) {
