...
/** @ingroup cds_nonintrusive_set
    ...
    @note Before including <tt><cds/container/ellen_bintree_set_rcu.h></tt> you should include appropriate RCU header
...
#endif
{
  ...
  public:
    ...
    */
    ...
    {
        scoped_node_ptr sp(cxx_leaf_node_allocator().New(val));
        if (base_class::insert(*sp.get(), [&f](leaf_node &v) {
                f(v.m_Value);
            })) {
            sp.release();
            return true;
    ...
    */
    ...
    std::pair<bool, bool> update(Q const &val, Func func, bool bAllowInsert = true)
    {
        ...
        std::pair<bool, bool> bRes = base_class::update(
            *sp,
            [&func, &val](bool bNew, leaf_node &node, leaf_node &) {
    ...
    */
    ...
    bool erase_with(Q const &key, Less pred)
    {
        ...
        return base_class::erase_with(
            key, cds::details::predicate_wrapper<leaf_node, Less, typename maker::value_accessor>());
    }
    ...
    */
    ...
    {
        return base_class::erase(key, [&f](leaf_node const &node) {
            f(node.m_Value);
        });
    }
    ...
    */
    ...
    {
        return base_class::find(key, [&f](leaf_node &node, Q &v) {
            f(node.m_Value, v);
        });
    }
    //@cond
    ...
    {
        return base_class::find(key, [&f](leaf_node &node, Q const &v) {
            f(node.m_Value, v);
        });
    }
    //@endcond
    ...
    */
    ...
    {
        CDS_UNUSED(pred);
        leaf_node *pNode = base_class::get_with(
            key, cds::details::predicate_wrapper<leaf_node, Less, typename maker::value_accessor>());
        return pNode ? &pNode->m_Value : nullptr;
    }
