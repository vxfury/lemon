...
/** @ingroup cds_nonintrusive_list
   ...
   \p Traits template argument. For example, the following traits-based declaration of \p gc::HP lazy list \code
        ...
        typedef cds::container::LazyList< cds::urcu::gc< cds::urcu::general_instant<> >, int, my_traits >
   traits_based_list; \endcode is equal to the following option-based list \code #include <cds/urcu/general_instant.h>
        #include <cds/container/lazy_list_rcu.h>
...
#endif
{
  ...
  public:
    using exempt_ptr = cds::urcu::exempt_ptr<gc, node_type, value_type,
                                             typename maker::intrusive_traits::disposer>; ///< pointer to extracted node
