...
#endif
{
  ...
  public:
    ...
    FCStack(unsigned int nCompactFactor ///< Flat combining: publication list compacting factor
            ,
    ...
    */
    bool push(value_type const &val)
    {
        ...
        constexpr_if(c_bEliminationEnabled) m_FlatCombining.batch_combine(op_push, pRec, *this);
        else m_FlatCombining.combine(op_push, pRec, *this);
    ...
    */
    bool push(value_type &&val)
    {
        ...
        constexpr_if(c_bEliminationEnabled) m_FlatCombining.batch_combine(op_push_move, pRec, *this);
        else m_FlatCombining.combine(op_push_move, pRec, *this);
    ...
    */
    bool pop(value_type &val)
    {
        ...
        constexpr_if(c_bEliminationEnabled) m_FlatCombining.batch_combine(op_pop, pRec, *this);
        else m_FlatCombining.combine(op_pop, pRec, *this);
    ...
    */
    ...
    {
        auto &stack = m_Stack;
        m_FlatCombining.invoke_exclusive([&stack, &f]() {
            f(stack);
        });
    }
    ...
    */
    bool empty()
    {
        ...
        constexpr_if(c_bEliminationEnabled) m_FlatCombining.batch_combine(op_empty, pRec, *this);
        else m_FlatCombining.combine(op_empty, pRec, *this);
