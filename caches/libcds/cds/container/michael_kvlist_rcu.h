...
/** @ingroup cds_nonintrusive_list
    ...
    It is possible to declare option-based list using \p cds::container::michael_list::make_traits metafunction istead
   of \p Traits template argument. For example, the following traits-based declaration of Michael's list \code #include
   <cds/urcu/general_buffered.h> #include <cds/container/michael_kvlist_rcu.h>
    ...
    typedef cds::container::MichaelKVList< cds::urcu::gc< cds::urcu::general_buffered<> >, int, int, my_traits >
   traits_based_list; \endcode
    ...
    \endcode
*/
template <typename RCU, typename Key, typename Value,
...
#endif
{
  ...
  public:
    ...
    typedef
        typename base_class::memory_model memory_model; ///< Memory ordering. See \p michael_list::traits::memory_model
    ...
    static constexpr const bool c_bExtractLockExternal =
        base_class::c_bExtractLockExternal; ///< Group of \p extract_xxx functions do not require external locking
  ...
  public:
    ...
    */
    ...
    /** \anchor cds_nonintrusive_MichaelKVList_rcu_get
        ...
        \code
        typedef cds::container::MichaelKVList< cds::urcu::gc< cds::urcu::general_buffered<> >, int, foo, my_traits >
       ord_list; ord_list theList;
        // ...
