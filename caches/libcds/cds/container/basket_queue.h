...
/**
    ...
    - \p opt::allocator - allocator (like \p std::allocator) used for allocating queue nodes. Default is \ref
   ...
   supports \p %basket_queue::stat interface. Default is \p %basket_queue::empty_stat.
...
struct make_basket_queue {
    ...
    struct intrusive_traits : public traits {
        ...
        static constexpr const cds::intrusive::opt::link_check_type link_checker =
            cds::intrusive::basket_queue::traits::link_checker;
    };
