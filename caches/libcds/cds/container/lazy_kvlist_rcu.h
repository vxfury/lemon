...
/** @ingroup cds_nonintrusive_list
   ...
   <cds/urcu/general_threaded.h> #include <cds/container/lazy_kvlist_rcu.h>
        ...
        typedef cds::container::LazyKVList< cds::urcu::gc< cds::urcu::general_threaded<> >, int, int, my_traits >
   traits_based_list; \endcode is equal to the following option-based list \code #include <cds/urcu/general_threaded.h>
...
#endif
{
  ...
  public:
    ...
    static constexpr const bool c_bExtractLockExternal =
        base_class::c_bExtractLockExternal; ///< Group of \p extract_xxx functions require external locking
  ...
  public:
    ...
    */
    ...
    /** \anchor cds_nonintrusive_LazyKVList_rcu_get
        ...
        \code
        typedef cds::container::LazyKVList< cds::urcu::gc< cds::urcu::general_buffered<> >, int, foo, my_traits >
