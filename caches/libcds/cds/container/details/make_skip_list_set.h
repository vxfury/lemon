...
struct make_skip_list_set {
    ...
    struct node_type : public intrusive_node_type {
        ...
        template <typename Q>
        node_type(unsigned int nHeight, atomic_marked_ptr *pTower, Q &&v) : m_Value(std::forward<Q>(v))
        {
    ...
    class intrusive_traits
        : public cds::intrusive::skip_list::make_traits<
              ...
              cds::opt::compare<cds::details::compare_wrapper<node_type, key_comparator, value_accessor> > >::type {};
