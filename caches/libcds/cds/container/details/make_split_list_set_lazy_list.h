...
struct make_split_list_set<GC, T, lazy_list_tag, Traits> {
    ...
    typedef typename cds::opt::select_default<typename original_traits::ordered_list_traits,
                                              cds::container::lazy_list::traits>::type original_ordered_list_traits;

    typedef typename cds::opt::select_default<typename original_ordered_list_traits::lock_type,
                                              typename cds::container::lazy_list::traits::lock_type>::type lock_type;
    ...
    struct ordered_list_traits : public original_ordered_list_traits {
        typedef cds::intrusive::lazy_list::base_hook<opt::gc<gc>, opt::lock_type<lock_type> > hook;
