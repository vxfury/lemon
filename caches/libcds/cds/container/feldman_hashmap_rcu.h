...
*/
template <class RCU, typename Key, typename T
...
#endif
{
  ...
  public:
    ...
    typedef implementation_defined
        iterator; ///< @ref cds_container_FeldmanHashMap_rcu_iterators "bidirectional iterator" type
    typedef implementation_defined
        const_iterator; ///< @ref cds_container_FeldmanHashMap_rcu_iterators "bidirectional const iterator" type
    typedef implementation_defined
        reverse_iterator; ///< @ref cds_container_FeldmanHashMap_rcu_iterators "bidirectional reverse iterator" type
    typedef implementation_defined const_reverse_iterator; ///< @ref cds_container_FeldmanHashMap_rcu_iterators
  ...
  public:
    ...
    */
    ...
    /**
        ...
        Example:
        \code
        typedef cds::container::FeldmanHashMap< cds::urcu::gc< cds::urcu::general_buffered<>>, int, foo, my_traits >
       map_type; map_type theMap;
        // ...
    ...
    */
    ...
    exempt_ptr extract(K const &key)
    {
        ...
        {
            rcu_lock rcuLock;
            p = base_class::do_erase(m_Hasher(key_type(key)), [](node_type const &) -> bool {
                return true;
            });
        }
        return exempt_ptr(p);
