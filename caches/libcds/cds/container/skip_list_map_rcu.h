...
#endif
{
  ...
  public:
    ...
    using exempt_ptr =
        cds::urcu::exempt_ptr<gc, node_type, value_type, typename maker::intrusive_type_traits::disposer>;
  ...
  public:
    ...
    */
    ...
    exempt_ptr extract_with(K const &key, Less pred)
    {
        ...
        return exempt_ptr(base_class::do_extract_with(
            key, cds::details::predicate_wrapper<node_type, Less, typename maker::key_accessor>()));
    }
    ...
    */
    ...
    /** \anchor cds_nonintrusive_SkipListMap_rcu_get
        The function searches the item with key equal to \p key and returns a \p raw_ptr object pointing to an item
       found. If \p key is not found it returns empty \p raw_ptr.
        ...
        \code
        typedef cds::container::SkipListMap< cds::urcu::gc< cds::urcu::general_buffered<> >, int, foo, my_traits >
       skip_list; skip_list theList;
        // ...
