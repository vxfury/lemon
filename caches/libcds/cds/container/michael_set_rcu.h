  ...
  public:
    ...
    */
    ...
    /**
        ...
        @warning For \ref cds_nonintrusive_MichaelList_rcu "MichaelList" as the bucket see \ref
       cds_intrusive_item_creating "insert item troubleshooting". \ref cds_nonintrusive_LazyList_rcu "LazyList" provides
