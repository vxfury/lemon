...
struct make_skip_list_set_nogc {
    ...
    struct node_type : public intrusive_node_type {
        ...
        template <typename Q>
        node_type(unsigned int nHeight, atomic_ptr *pTower, Q const &v) : m_Value(v)
        {
            if (nHeight > 1) {
    ...
    */
    ...
    typedef typename cds::intrusive::skip_list::make_traits<
        cds::opt::type_traits<traits>, cds::intrusive::opt::hook<intrusive::skip_list::base_hook<cds::opt::gc<gc> > >,
        cds::intrusive::opt::disposer<node_deallocator>,
        cds::intrusive::skip_list::internal_node_builder<dummy_node_builder>,
        cds::opt::compare<cds::details::compare_wrapper<node_type, key_comparator, key_accessor> > >::type
        intrusive_type_traits;
...
/** @ingroup cds_nonintrusive_set
    ...
    It is possible to declare option-based list with cds::container::skip_list::make_traits metafunction istead of \p
   Traits template argument. \p Options template arguments of cds::container::skip_list::make_traits metafunction are:
...
#else
    protected details::make_skip_list_set_nogc<
        T, typename cds::opt::replace_key_accessor<Traits, skip_list::details::set_key_accessor>::type>::type
#endif
{
    //@cond
    typedef details::make_skip_list_set_nogc<
        T, typename cds::opt::replace_key_accessor<Traits, skip_list::details::set_key_accessor>::type>
        maker;
  ...
  public:
    ...
    typedef
        typename options::allocator allocator_type; ///< Allocator type used for allocate/deallocate the skip-list nodes
  ...
  protected:
    ...
    typedef typename std::conditional<std::is_same<typename options::key_accessor, opt::none>::value,
                                      skip_list::details::set_key_accessor, typename options::key_accessor>::type
        key_accessor;
  ...
  public:
    ...
    */
    ...
    std::pair<iterator, bool> update(const Q &val, bool bInsert = true)
    {
        ...
        std::pair<bool, bool> bRes = base_class::update(
            *sp,
            [&pNode](bool, node_type &item, node_type &) {
                pNode = &item;
            },
            bInsert);
    ...
    */
    ...
    iterator contains(Q const &key) const
    {
        ...
        if (pNode) return node_to_iterator(pNode);
