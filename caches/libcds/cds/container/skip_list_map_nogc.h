...
#else
    protected SkipListSet<cds::gc::nogc, std::pair<Key const, T>,
                          typename cds::opt::replace_key_accessor<Traits, skip_list::details::map_key_accessor>::type>
#endif
{
    //@cond
    typedef SkipListSet<cds::gc::nogc, std::pair<Key const, T>,
                        typename cds::opt::replace_key_accessor<Traits, skip_list::details::map_key_accessor>::type>
        base_class;
    //@endcond
  ...
  public:
    ...
    typedef typename base_class::allocator_type
        allocator_type; ///< Allocator type used for allocate/deallocate the skip-list nodes
