...
template <typename T, typename Hash, typename Pred, typename Alloc>
struct swap_item_policy<std::unordered_set<T, Hash, Pred, Alloc> >
    : public copy_item_policy<std::unordered_set<T, Hash, Pred, Alloc> > {
};
    ...
    class adapted_container : public cds::container::striped_set::adapted_container {
      ...
      private:
        ...
        typedef typename cds::opt::select<
            ...
            cds::container::striped_set::swap_item_policy<container_type> // not defined
            ,
