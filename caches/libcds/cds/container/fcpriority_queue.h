...
#endif
{
  ...
  protected:
    ...
    enum fc_operation { op_push = cds::algo::flat_combining::req_Operation, op_push_move, op_pop, op_clear };
  ...
  public:
    ...
    FCPriorityQueue(unsigned int nCompactFactor ///< Flat combining: publication list compacting factor
                    ,
    ...
    */
    bool push(value_type const &val ///< Value to be copied to inserted element
    )
    {
    ...
    /**
        The function always returns \p true
    */
    bool push(value_type &&val ///< Value to be moved to inserted element
    )
    {
        auto pRec = m_FlatCombining.acquire_record();
        pRec->pValPush = &val;
    ...
    */
    bool pop(value_type &val ///< Target to be received the copy of top element
    )
    {
        auto pRec = m_FlatCombining.acquire_record();
        pRec->pValPop = &val;
    ...
    */
    ...
    void apply(Func f)
    {
        ...
        m_FlatCombining.invoke_exclusive([&pqueue, &f]() {
            f(pqueue);
        });
    }
    ...
    */
    bool empty()
    {
        ...
        m_FlatCombining.invoke_exclusive([&pq, &bRet]() {
            bRet = pq.empty();
        });
        return bRet;
    }
