...
#else
    : protected details::make_split_list_set<cds::gc::nogc, T, typename Traits::ordered_list,
                                             split_list::details::wrap_set_traits<T, Traits> >::type
#endif
{
  protected:
    //@cond
    typedef details::make_split_list_set<cds::gc::nogc, T, typename Traits::ordered_list,
  ...
  public:
    ...
    */
    ...
    std::pair<iterator, bool> update(Q const &key, bool bAllowInsert = true)
    {
        ...
        std::pair<typename base_class::iterator, bool> ret = base_class::update_(
            *pNode,
