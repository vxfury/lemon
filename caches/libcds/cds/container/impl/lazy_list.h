...
/** @ingroup cds_nonintrusive_list
    ...
    - \p Traits - type traits, default is \p lazy_list::traits.
        It is possible to declare option-based list with \p lazy_list::make_traits metafunction istead of \p Traits
   template argument. For example, the following traits-based declaration of \p gc::HP lazy list \code #include
   <cds/container/lazy_list_hp.h>
    ...
    The key is a function (or a part) of type \p T, and the comparing function is specified by \p Traits::compare
   functor or \p Traits::less predicate.
...
#endif
{
  ...
  protected:
    ...
    class iterator_type : protected base_class::template iterator_type<IsConst> {
        ...
        iterator_type(head_type const &pNode) : iterator_base(const_cast<head_type *>(&pNode)) {}
  ...
  public:
    ...
    explicit LazyList(Stat &st) : base_class(st)
    {
    }
    //@endcond
