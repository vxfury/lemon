...
/** @ingroup cds_nonintrusive_list
    ...
    It is possible to declare option-based list with \p cds::container::iterable_list::make_traits metafunction instead
   of \p Traits template argument. For example, the following traits-based declaration of \p gc::HP iterable list \code
...
#endif
{
  ...
  public:
    ...
    struct rebind_traits {
        typedef IterableKVList<gc, key_type, mapped_type, typename cds::opt::make_options<traits, Options...>::type>
            type;
    };
  ...
  public:
    ...
    /**
       ...
       free guard" may be thrown if the limit of guard count per thread is exceeded.
        ...
        - Iterator is thread-safe: even if an element the iterator points to is removed, the iterator stays valid
       ...
       even after such changing. Other iterator can observe modified value of the element.
    */
  ...
  public:
    ...
    */
    ...
    explicit IterableKVList(Stat &st) : base_class(st)
    {
    }
    //@endcond
    ...
    */
    ...
    /**
        ...
        Preconditions:
        - The \p key_type should be constructible from value of type \p K. In trivial case, \p K is equal to \p
       key_type.
    ...
    */
    ...
    {
        return base_class::upsert(value_type(key_type(std::forward<Q>(key)), mapped_type(std::forward<V>(val))),
                                  bInsert);
    }
    ...
    */
    ...
    {
        return base_class::find(key, [&f](value_type &v, Q const &) {
            f(v);
        });
    }
    ...
    */
    ...
    {
        CDS_UNUSED(pred);
        return base_class::find_with(key, less_wrapper<Less>(), [&f](value_type &v, Q const &) {
            f(v);
        });
    }
  ...
  protected:
    ...
    {
        return base_class::update_at(refHead, value_type(key_type(std::forward<K>(key)), mapped_type()), f,
                                     bAllowInsert);
    }
