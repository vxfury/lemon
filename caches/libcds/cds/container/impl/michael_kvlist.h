...
/** @ingroup cds_nonintrusive_list
    ...
    It is possible to declare option-based list with \p cds::container::michael_list::make_traits metafunction instead
   of \p Traits template argument. For example, the following traits-based declaration of \p gc::HP Michael's list \code
...
#endif
{
  ...
  public:
    ...
    struct rebind_traits {
        typedef MichaelKVList<gc, key_type, mapped_type, typename cds::opt::make_options<traits, Options...>::type>
            type;
    };
  ...
  public:
    ...
    */
    ...
    explicit MichaelKVList(Stat &st) : base_class(st)
    {
    }
    //@endcond
  ...
  protected:
    ...
    {
        return base_class::find_at(refHead, key, cmp, [&f](node_type &node, K const &) {
            f(node.m_Data);
        });
    }
