...
/** @ingroup cds_nonintrusive_set
   ...
   the appropiate \p less functor is: \code struct Foo
    {
        std::string m_strKey;
        ...
    };
...
#endif
{
  ...
  public:
    /// Guarded pointer
    typedef
        typename gc::template guarded_ptr<leaf_node, value_type, details::guarded_ptr_cast_set<leaf_node, value_type> >
            guarded_ptr;
  ...
  public:
    ...
    */
    ...
    {
        CDS_UNUSED(pred);
        return base_class::extract_with_(
            key, cds::details::predicate_wrapper<leaf_node, Less, typename maker::value_accessor>());
    }
