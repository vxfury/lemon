...
/** @ingroup cds_nonintrusive_list
    ...
    \p IterableKVList is a key-value version of iterable non-intrusive list that is closer to the C++ std library
   approach.

    It is possible to declare option-based list with cds::container::iterable_list::make_traits metafunction istead of
   \p Traits template argument. For example, the following traits-based declaration of gc::HP iterable list \code
...
#endif
{
  ...
  protected:
    ...
    class iterator_type : protected base_class::template iterator_type<IsConst> {
        ...
        iterator_type(iterator_base it) : iterator_base(it) {}
  ...
  public:
    ...
    */
    ...
    explicit IterableList(Stat &st) : base_class(st)
    {
    }
    //@endcond
