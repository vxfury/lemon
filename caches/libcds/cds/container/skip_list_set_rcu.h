...
/** @ingroup cds_nonintrusive_set
   ...
   Traits template argument. Template argument list \p Options of cds::container::skip_list::make_traits metafunction
   are:
...
#endif
{
  ...
  public:
    ...
    */
    ...
    {
        CDS_UNUSED(pred);
        return exempt_ptr(base_class::do_extract_with(
            key, cds::details::predicate_wrapper<node_type, Less, typename maker::value_accessor>()));
    }
    ...
    */
    ...
    {
        return base_class::find(val, [&f](node_type &node, Q &v) {
            f(node.m_Value, v);
        });
    }
    //@cond
    ...
    */
    ...
    {
        CDS_UNUSED(pred);
        return base_class::find_with(val,
    ...
    */
    ...
    {
        CDS_UNUSED(pred);
        return raw_ptr(base_class::get_with(
            val, cds::details::predicate_wrapper<node_type, Less, typename maker::value_accessor>()));
    }
