...
/** @ingroup cds_nonintrusive_map
    ...
    @note Before including <tt><cds/container/ellen_bintree_map_rcu.h></tt> you should include appropriate RCU header
...
#endif
{
  ...
  public:
    ...
    using exempt_ptr =
        cds::urcu::exempt_ptr<gc, leaf_node, value_type, typename maker::intrusive_traits::disposer,
                              cds::urcu::details::conventional_exempt_member_cast<leaf_node, value_type> >;

  public:
    /// Default constructor
    EllenBinTreeMap() : base_class() {}
    ...
    */
    ...
    bool insert_with(K const &key, Func func)
    {
        ...
        if (base_class::insert(*pNode, [&func](leaf_node &item) {
                func(item.m_Value);
            })) {
            pNode.release();
            return true;
    ...
    */
    ...
    {
        scoped_node_ptr pNode(cxx_leaf_node_allocator().MoveNew(key_type(std::forward<K>(key)),
    ...
    */
    ...
    std::pair<bool, bool> update(K const &key, Func func, bool bAllowInsert = true)
    {
        ...
        std::pair<bool, bool> res = base_class::update(
            *pNode,
            [&func](bool bNew, leaf_node &item, leaf_node const &) {
                func(bNew, item.m_Value);
            },
            bAllowInsert);
    ...
    */
    ...
    {
        return base_class::erase(key, [&f](leaf_node &node) {
            f(node.m_Value);
        });
    }
    ...
    */
    ...
    {
        CDS_UNUSED(pred);
        return exempt_ptr(base_class::extract_with_(
            key, cds::details::predicate_wrapper<leaf_node, Less, typename maker::key_accessor>()));
    }
    ...
    */
    ...
    {
        return base_class::find(key, [&f](leaf_node &item, K const &) {
            f(item.m_Value);
        });
    }
    ...
    */
    ...
    value_type *get_with(Q const &key, Less pred) const
    {
        CDS_UNUSED(pred);
        leaf_node *pNode =
            base_class::get_with(key, cds::details::predicate_wrapper<leaf_node, Less, typename maker::key_accessor>());
        return pNode ? &pNode->m_Value : nullptr;
    }
