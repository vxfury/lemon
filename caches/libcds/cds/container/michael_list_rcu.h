...
/** @ingroup cds_nonintrusive_list
    ...
    This class is non-intrusive version of \ref cds_intrusive_MichaelList_rcu "cds::intrusive::MichaelList" RCU
   specialization.
   ...
   Traits template argument. For example, the following traits-based declaration of Michael's list
    ...
    typedef cds::container::MichaelList< cds::urcu::gc< cds::urcu::general_buffered<> >, int, my_traits >
   traits_based_list; \endcode
    ...
    - opt::item_counter - the type of item counting feature. Default is \ref atomicity::empty_item_counter that is no
   item counting.
    - opt::allocator - the allocator used for creating and freeing list's item. Default is \ref CDS_DEFAULT_ALLOCATOR
   macro.
