...
class MichaelHashMap<cds::gc::nogc, OrderedList, Traits> {
  ...
  public:
    ...
    */
    MichaelHashMap(size_t nMaxItemCount, ///< estimation of max item count in the hash set
    ...
    */
    ...
    /**
        ...
        @warning For \ref cds_nonintrusive_MichaelKVList_nogc "MichaelKVList" as the bucket see \ref
       cds_intrusive_item_creating "insert item troubleshooting". \ref cds_nonintrusive_LazyKVList_nogc "LazyKVList"
    ...
    */
    ...
    iterator contains(K const &key)
    {
        ...
        if (it != refBucket.end()) return iterator(it, &refBucket, m_Buckets + bucket_count());
