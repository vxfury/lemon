  ...
  public:
    ...
    */
    ...
    /**
        ...
        Example:
        \code
        typedef cds::container::FeldmanHashSet< cds::urcu::gc< cds::urcu::general_buffered<> >, foo, my_traits >
  ...
  public:
    ...
    */
    ...
    typedef typename base_class::const_iterator
        const_iterator; ///< @ref cds_container_FeldmanHashSet_rcu_iterators "bidirectional const iterator" type
    typedef typename base_class::reverse_iterator
        reverse_iterator; ///< @ref cds_container_FeldmanHashSet_rcu_iterators "bidirectional reverse iterator" type
    typedef typename base_class::const_reverse_iterator
        const_reverse_iterator; ///< @ref cds_container_FeldmanHashSet_rcu_iterators "bidirectional reverse const
                                ///< iterator" type
