...
/** @ingroup cds_intrusive_map
    ...
    - \p Traits - type traits. See \p michael_set::traits for explanation.
        Instead of defining \p Traits struct you can use option-based syntax with \p michael_set::make_traits
   metafunction.
...
class MichaelHashSet {
  ...
  public:
    ...
    /**
        ...
        - The iterator cannot be moved across thread boundary because it may contain GC's guard that is thread-private
       GC data.
  ...
  public:
    ...
    /**
        ...
        The bucket is an ordered single-linked list, searching in the bucket has linear complexity
       <tt>O(nLoadFactor)</tt>. The constructor defines hash table size as rounding <tt>nMaxItemCount / nLoadFactor</tt>
    ...
    */
    ...
    /**
        ...
        If there are a thread that performs insertion while \p %clear() is working the result is undefined in general
       case: \p empty() may return \p true but the set may contain item(s). Therefore, \p %clear() may be used only for
       debugging purposes.
