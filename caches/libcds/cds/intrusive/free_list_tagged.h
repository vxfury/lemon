...
class TaggedFreeList {
  ...
  public:
    ...
    TaggedFreeList() : m_Head(tagged_ptr())
    {
    ...
    */
    ...
    void put(node *pNode)
    {
        ...
        } while (cds_unlikely(!m_Head.compare_exchange_weak(currentHead, newHead, atomics::memory_order_release,
    ...
    node *get()
    {
        ...
        while (currentHead.ptr != nullptr) {
            ...
            newHead.tag = currentHead.tag + 1;
            if (cds_likely(m_Head.compare_exchange_weak(currentHead, newHead, atomics::memory_order_release,
                                                        atomics::memory_order_acquire)))
                break;
        }
