  ...
  public:
    ...
    */
    ...
    /**
       ...
       case: <tt> empty() </tt> may return \p true but the set may contain item(s). Therefore, \p %clear() may be used
    ...
    */
    void clear()
    {
        m_List.erase_for([](value_type const &val) -> bool {
            return !node_traits::to_node_ptr(val)->is_dummy();
        });
        m_ItemCounter.reset();
    }
