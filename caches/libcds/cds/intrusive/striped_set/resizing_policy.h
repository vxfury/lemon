...
struct load_factor_resizing {
    ...
    bool operator()(size_t nSize,               ///< Current item count of \p container
...
struct load_factor_resizing<0> {
  ...
  public:
    ...
    load_factor_resizing() : m_nLoadFactor(4) {}

    /// Ctor with explicitly defined \p nLoadFactor
    explicit load_factor_resizing(size_t nLoadFactor) : m_nLoadFactor(nLoadFactor) {}

    /// Copy ctor
    load_factor_resizing(load_factor_resizing const &src) : m_nLoadFactor(src.m_nLoadFactor) {}

    /// Move ctor
    load_factor_resizing(load_factor_resizing &&src) : m_nLoadFactor(src.m_nLoadFactor) {}
...
struct rational_load_factor_resizing<0, Denominator> {
  ...
  public:
    ...
    rational_load_factor_resizing() : m_nNumerator(1), m_nDenominator(2) {}
...
struct single_bucket_size_threshold {
    /// Main policy operator returns \p true when resizing is needed
    template <typename Container, typename Bucket>
    bool operator()(size_t /*nSize*/,                ///< Current item count of \p container (not used)
...
struct single_bucket_size_threshold<0> {
    ...
    single_bucket_size_threshold() : m_nThreshold(4) {}

    /// Ctor with explicitly defined \p nThreshold
    explicit single_bucket_size_threshold(size_t nThreshold) : m_nThreshold(nThreshold) {}

    /// Copy ctor
    single_bucket_size_threshold(single_bucket_size_threshold const &src) : m_nThreshold(src.m_nThreshold) {}

    /// Move ctor
    single_bucket_size_threshold(single_bucket_size_threshold &&src) : m_nThreshold(src.m_nThreshold) {}
