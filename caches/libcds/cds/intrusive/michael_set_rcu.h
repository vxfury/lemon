...
class MichaelHashSet<cds::urcu::gc<RCU>, OrderedList, Traits> {
  ...
  public:
    ...
    typedef
        typename internal_bucket_type::raw_ptr raw_ptr; ///< Return type of \p get() member function and its derivatives
  ...
  public:
    ...
    */
    ...
    {
        return const_iterator(m_Buckets[bucket_count() - 1].cend(), m_Buckets + bucket_count() - 1,
                              m_Buckets + bucket_count());
    }
    //@}
  ...
  public:
    ...
    /**
        ...
        The bucket is an ordered single-linked list, the complexity of searching in the bucket is linear
