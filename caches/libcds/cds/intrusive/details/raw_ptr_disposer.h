...
struct raw_ptr_disposer {
    ...
    raw_ptr_disposer() : pReclaimedChain(nullptr) {}

    template <typename Position>
    explicit raw_ptr_disposer(Position &pos) : pReclaimedChain(pos.pDelChain)
    {
        pos.pDelChain = nullptr;
    }

    raw_ptr_disposer(raw_ptr_disposer &&d) : pReclaimedChain(d.pReclaimedChain)
    {
