...
{
    int nRet;
    __asm__ __volatile__("bsrl        %[nArg], %[nRet]     ;\n\t"
                         "jnz        1f                    ;\n\t"
                         "xorl        %[nRet], %[nRet]    ;\n\t"
                         "subl        $1, %[nRet]         ;\n\t"
                         "1:"
...
static inline int msb32nz(uint32_t nArg)
{
    assert(nArg != 0);
    int nRet;
    __asm__ __volatile__("bsrl        %[nArg], %[nRet]    ;" : [nRet] "=a"(nRet) : [nArg] "r"(nArg) : "cc");
    return nRet;
}
...
{
    int nRet;
    __asm__ __volatile__("bsfl        %[nArg], %[nRet]     ;"
                         "jnz        1f        ;"
                         "xorl        %[nRet], %[nRet]    ;"
                         "subl        $1, %[nRet]         ;"
                         "1:"
...
static inline int lsb32nz(uint32_t nArg)
{
    assert(nArg != 0);
    int nRet;
    __asm__ __volatile__("bsfl        %[nArg], %[nRet]    ;" : [nRet] "=a"(nRet) : [nArg] "r"(nArg) : "cc");
    return nRet;
}
...
static inline int msb64nz(uint64_t nArg)
{
    assert(nArg != 0);
    uint64_t nRet;
    __asm__ __volatile__("bsrq        %[nArg], %[nRet]    ;" : [nRet] "=a"(nRet) : [nArg] "r"(nArg) : "cc");
    return (int)nRet;
}
...
{
    uint64_t nRet;
    __asm__ __volatile__("bsfq        %[nArg], %[nRet]     ;"
                         "jnz        1f        ;"
                         "xorq        %[nRet], %[nRet]    ;"
                         "subq        $1, %[nRet]         ;"
                         "1:"
...
static inline int lsb64nz(uint64_t nArg)
{
    assert(nArg != 0);
    uint64_t nRet;
    __asm__ __volatile__("bsfq        %[nArg], %[nRet]    ;" : [nRet] "=a"(nRet) : [nArg] "r"(nArg) : "cc");
    return (int)nRet;
}
