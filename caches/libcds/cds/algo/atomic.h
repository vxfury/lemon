...
#define CDS_CXX11_ATOMIC_BEGIN_NAMESPACE \
    namespace boost                      \
    {
...
class event_counter {
  ...
  public:
    ...
    event_counter() noexcept : m_counter(size_t(0)) {}

    /// Assign operator
    /**
        Returns \p n.
    */
    value_type operator=(value_type n ///< new value of the counter
                         ) noexcept
    {
    ...
    */
    size_t operator+=(size_t n ///< addendum
                      ) noexcept
    {
    ...
    /**
        Returns new value of the atomic counter.
    */
    size_t operator-=(size_t n ///< subtrahend
                      ) noexcept
    {
...
class item_counter {
  ...
  public:
    ...
    item_counter() : m_Counter(counter_type(0)) {}
...
class cache_friendly_item_counter {
  ...
  public:
    /// Default ctor initializes the counter to zero.
    cache_friendly_item_counter() : m_Counter(counter_type(0)) {}
