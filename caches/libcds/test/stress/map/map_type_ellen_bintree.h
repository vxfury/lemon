...
class EllenBinTreeMap : public cc::EllenBinTreeMap<GC, Key, T, Traits> {
  ...
  public:
    ...
    EllenBinTreeMap(Config const & /*cfg*/) : base_class()
    {
    }
...
struct map_type<tag_EllenBinTreeMap, Key, Value> : public map_type_base<Key, Value> {
    ...
    struct traits_EllenBinTreeMap
        : public cc::ellen_bintree::make_set_traits<
              co::less<less>, co::node_allocator<ellen_bintree_pool::internal_node_allocator<int> >,
              co::item_counter<cds::atomicity::cache_friendly_item_counter> >::type {};
    struct traits_EllenBinTreeMap_hp : traits_EllenBinTreeMap {
        typedef cds::memory::pool_allocator<typename ellen_bintree_props::hp_gc::update_desc,
                                            ellen_bintree_pool::update_desc_pool_accessor>
    ...
    struct traits_EllenBinTreeMap_dhp : traits_EllenBinTreeMap {
        typedef cds::memory::pool_allocator<typename ellen_bintree_props::dhp_gc::update_desc,
                                            ellen_bintree_pool::update_desc_pool_accessor>
            update_desc_allocator;
    };
    ...
    struct traits_EllenBinTreeMap_gpi : traits_EllenBinTreeMap {
        typedef cds::memory::pool_allocator<typename ellen_bintree_props::gpi::update_desc,
                                            ellen_bintree_pool::update_desc_pool_accessor>
            update_desc_allocator;
    };
    ...
    struct traits_EllenBinTreeMap_gpb : traits_EllenBinTreeMap {
        typedef cds::memory::pool_allocator<typename ellen_bintree_props::gpb::update_desc,
                                            ellen_bintree_pool::update_desc_pool_accessor>
            update_desc_allocator;
    };
    ...
    struct traits_EllenBinTreeMap_gpt : traits_EllenBinTreeMap {
        typedef cds::memory::pool_allocator<typename ellen_bintree_props::gpt::update_desc,
                                            ellen_bintree_pool::update_desc_pool_accessor>
            update_desc_allocator;
    };
    ...
    struct traits_EllenBinTreeMap_shb : traits_EllenBinTreeMap {
        typedef cds::memory::pool_allocator<typename ellen_bintree_props::shb::update_desc,
                                            ellen_bintree_pool::update_desc_pool_accessor>
            update_desc_allocator;
    };
    ...
    struct traits_EllenBinTreeMap_stat
        : public cc::ellen_bintree::make_set_traits<
              co::less<less>,
              cc::ellen_bintree::update_desc_allocator<cds::memory::pool_allocator<
                  typename ellen_bintree_props::hp_gc::update_desc, ellen_bintree_pool::update_desc_pool_accessor> >,
...
static inline void check_stat(cds::intrusive::ellen_bintree::empty_stat const & /*s*/)
{
    ...
    /*
    CPPUNIT_CHECK_CURRENT_EX( ellen_bintree_pool::internal_node_counter::m_nAlloc.get() ==
    ellen_bintree_pool::internal_node_counter::m_nFree.get(), "m_nAlloc=" <<
    ellen_bintree_pool::internal_node_counter::m_nAlloc.get()
