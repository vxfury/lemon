...
struct lazy_list_type {
    ...
    struct traits_LazyList_cmp : public cc::lazy_list::make_traits<co::compare<compare> >::type {};
    ...
    struct traits_LazyList_unord : public cc::lazy_list::make_traits<co::equal_to<equal_to>, co::sort<false> >::type {};
    typedef cc::LazyKVList<cds::gc::nogc, Key, Value, traits_LazyList_unord> LazyList_NOGC_unord;

    struct traits_LazyList_cmp_seqcst
        : public cc::lazy_list::make_traits<co::compare<compare>,
                                            co::memory_model<co::v::sequential_consistent> >::type {};
    ...
    struct traits_LazyList_less : public cc::lazy_list::make_traits<co::less<less> >::type {};
    ...
    struct traits_LazyList_less_seqcst
        : public cc::lazy_list::make_traits<co::less<less>, co::memory_model<co::v::sequential_consistent> >::type {};
