...
struct michael_list_type {
    ...
    struct traits_MichaelList_cmp : public cc::michael_list::make_traits<co::compare<compare> >::type {};
    ...
    struct traits_MichaelList_cmp_seqcst
        : public cc::michael_list::make_traits<co::compare<compare>,
    ...
    struct traits_MichaelList_less : public cc::michael_list::make_traits<co::less<less> >::type {};
    ...
    struct traits_MichaelList_less_seqcst
        : public cc::michael_list::make_traits<co::less<less>, co::memory_model<co::v::sequential_consistent> >::type {
    };
