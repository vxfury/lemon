...
class BronsonAVLTreeMap : public cc::BronsonAVLTreeMap<GC, Key, T, Traits> {
  ...
  public:
    ...
    BronsonAVLTreeMap(Config const & /*cfg*/) : base_class()
    {
    }
    ...
    {
        Key key;
        typename base_class::exempt_ptr xp = base_class::extract_min([&key](Key const &k) {
            key = k;
        });
        if (xp) return std::make_pair(key, true);
    ...
    {
        Key key;
        typename base_class::exempt_ptr xp = base_class::extract_max([&key](Key const &k) {
            key = k;
        });
        if (xp) return std::make_pair(key, true);
        return std::make_pair(key, false);
...
struct map_type<tag_BronsonAVLTreeMap, Key, Value> : public map_type_base<Key, Value> {
    ...
    struct BronsonAVLTreeMap_less
        : public cc::bronson_avltree::make_traits<co::less<less>, cc::bronson_avltree::relaxed_insert<false>,
...
#endif
    struct BronsonAVLTreeMap_cmp_stat
        : public cc::bronson_avltree::make_traits<co::compare<compare>, cc::bronson_avltree::relaxed_insert<false>,
                                                  co::item_counter<cds::atomicity::cache_friendly_item_counter>,
                                                  co::stat<cc::bronson_avltree::stat<>>>::type {};
    ...
    typedef BronsonAVLTreeMap<rcu_gpi, Key, Value, BronsonAVLTreeMap_less_pool_simple>
        BronsonAVLTreeMap_rcu_gpi_less_pool_simple;
    typedef BronsonAVLTreeMap<rcu_gpb, Key, Value, BronsonAVLTreeMap_less_pool_simple>
        BronsonAVLTreeMap_rcu_gpb_less_pool_simple;
    typedef BronsonAVLTreeMap<rcu_gpt, Key, Value, BronsonAVLTreeMap_less_pool_simple>
        BronsonAVLTreeMap_rcu_gpt_less_pool_simple;
#ifdef CDS_URCU_SIGNAL_HANDLING_ENABLED
    typedef BronsonAVLTreeMap<rcu_shb, Key, Value, BronsonAVLTreeMap_less_pool_simple>
        BronsonAVLTreeMap_rcu_shb_less_pool_simple;
#endif
    ...
    typedef BronsonAVLTreeMap<rcu_gpi, Key, Value, BronsonAVLTreeMap_less_pool_simple_stat>
        BronsonAVLTreeMap_rcu_gpi_less_pool_simple_stat;
    typedef BronsonAVLTreeMap<rcu_gpb, Key, Value, BronsonAVLTreeMap_less_pool_simple_stat>
        BronsonAVLTreeMap_rcu_gpb_less_pool_simple_stat;
    typedef BronsonAVLTreeMap<rcu_gpt, Key, Value, BronsonAVLTreeMap_less_pool_simple_stat>
        BronsonAVLTreeMap_rcu_gpt_less_pool_simple_stat;
#ifdef CDS_URCU_SIGNAL_HANDLING_ENABLED
    typedef BronsonAVLTreeMap<rcu_shb, Key, Value, BronsonAVLTreeMap_less_pool_simple_stat>
        BronsonAVLTreeMap_rcu_shb_less_pool_simple_stat;
#endif
    ...
    typedef BronsonAVLTreeMap<rcu_gpi, Key, Value, BronsonAVLTreeMap_less_pool_lazy>
        BronsonAVLTreeMap_rcu_gpi_less_pool_lazy;
    typedef BronsonAVLTreeMap<rcu_gpb, Key, Value, BronsonAVLTreeMap_less_pool_lazy>
        BronsonAVLTreeMap_rcu_gpb_less_pool_lazy;
    typedef BronsonAVLTreeMap<rcu_gpt, Key, Value, BronsonAVLTreeMap_less_pool_lazy>
        BronsonAVLTreeMap_rcu_gpt_less_pool_lazy;
#ifdef CDS_URCU_SIGNAL_HANDLING_ENABLED
    typedef BronsonAVLTreeMap<rcu_shb, Key, Value, BronsonAVLTreeMap_less_pool_lazy>
        BronsonAVLTreeMap_rcu_shb_less_pool_lazy;
#endif
    ...
    typedef BronsonAVLTreeMap<rcu_gpi, Key, Value, BronsonAVLTreeMap_less_pool_lazy_stat>
        BronsonAVLTreeMap_rcu_gpi_less_pool_lazy_stat;
    typedef BronsonAVLTreeMap<rcu_gpb, Key, Value, BronsonAVLTreeMap_less_pool_lazy_stat>
        BronsonAVLTreeMap_rcu_gpb_less_pool_lazy_stat;
    typedef BronsonAVLTreeMap<rcu_gpt, Key, Value, BronsonAVLTreeMap_less_pool_lazy_stat>
        BronsonAVLTreeMap_rcu_gpt_less_pool_lazy_stat;
#ifdef CDS_URCU_SIGNAL_HANDLING_ENABLED
    typedef BronsonAVLTreeMap<rcu_shb, Key, Value, BronsonAVLTreeMap_less_pool_lazy_stat>
        BronsonAVLTreeMap_rcu_shb_less_pool_lazy_stat;
#endif
    ...
    typedef BronsonAVLTreeMap<rcu_gpi, Key, Value, BronsonAVLTreeMap_less_pool_bounded>
        BronsonAVLTreeMap_rcu_gpi_less_pool_bounded;
    typedef BronsonAVLTreeMap<rcu_gpb, Key, Value, BronsonAVLTreeMap_less_pool_bounded>
        BronsonAVLTreeMap_rcu_gpb_less_pool_bounded;
    typedef BronsonAVLTreeMap<rcu_gpt, Key, Value, BronsonAVLTreeMap_less_pool_bounded>
        BronsonAVLTreeMap_rcu_gpt_less_pool_bounded;
#ifdef CDS_URCU_SIGNAL_HANDLING_ENABLED
    typedef BronsonAVLTreeMap<rcu_shb, Key, Value, BronsonAVLTreeMap_less_pool_bounded>
        BronsonAVLTreeMap_rcu_shb_less_pool_bounded;
#endif
    ...
    typedef BronsonAVLTreeMap<rcu_gpi, Key, Value, BronsonAVLTreeMap_less_pool_bounded_stat>
        BronsonAVLTreeMap_rcu_gpi_less_pool_bounded_stat;
    typedef BronsonAVLTreeMap<rcu_gpb, Key, Value, BronsonAVLTreeMap_less_pool_bounded_stat>
        BronsonAVLTreeMap_rcu_gpb_less_pool_bounded_stat;
    typedef BronsonAVLTreeMap<rcu_gpt, Key, Value, BronsonAVLTreeMap_less_pool_bounded_stat>
        BronsonAVLTreeMap_rcu_gpt_less_pool_bounded_stat;
#ifdef CDS_URCU_SIGNAL_HANDLING_ENABLED
    typedef BronsonAVLTreeMap<rcu_shb, Key, Value, BronsonAVLTreeMap_less_pool_bounded_stat>
        BronsonAVLTreeMap_rcu_shb_less_pool_bounded_stat;
#endif
};
...
{
    o << m.statistics() << m.monitor().statistics();
}
...
#define CDSSTRESS_BronsonAVLTreeMap_SHRCU(fixture, test_case, key_type, value_type)                                    \
    CDSSTRESS_BronsonAVLTreeMap_case(fixture, test_case, BronsonAVLTreeMap_rcu_shb_less, key_type, value_type)         \
        CDSSTRESS_BronsonAVLTreeMap_case(fixture, test_case, BronsonAVLTreeMap_rcu_shb_cmp_stat, key_type, value_type) \
            CDSSTRESS_BronsonAVLTreeMap_case(fixture, test_case, BronsonAVLTreeMap_rcu_shb_less_pool_simple, key_type, \
                                             value_type)                                                               \
                CDSSTRESS_BronsonAVLTreeMap_case(fixture, test_case, BronsonAVLTreeMap_rcu_shb_less_pool_simple_stat,  \
                                                 key_type, value_type)                                                 \
                    CDSSTRESS_BronsonAVLTreeMap_case(fixture, test_case, BronsonAVLTreeMap_rcu_shb_less_pool_lazy,     \
                                                     key_type, value_type)                                             \
                        CDSSTRESS_BronsonAVLTreeMap_case(                                                              \
                            fixture, test_case, BronsonAVLTreeMap_rcu_shb_less_pool_lazy_stat, key_type, value_type)
...
#define CDSSTRESS_BronsonAVLTreeMap_1(fixture, test_case, key_type, value_type)                                        \
    CDSSTRESS_BronsonAVLTreeMap_case(fixture, test_case, BronsonAVLTreeMap_rcu_gpi_cmp_stat, key_type, value_type)     \
        CDSSTRESS_BronsonAVLTreeMap_case(fixture, test_case, BronsonAVLTreeMap_rcu_gpi_less_pool_simple, key_type,     \
                                         value_type)                                                                   \
            CDSSTRESS_BronsonAVLTreeMap_case(fixture, test_case, BronsonAVLTreeMap_rcu_gpi_less_pool_simple_stat,      \
                                             key_type, value_type)                                                     \
                CDSSTRESS_BronsonAVLTreeMap_case(fixture, test_case, BronsonAVLTreeMap_rcu_gpi_less_pool_lazy,         \
                                                 key_type, value_type)                                                 \
                    CDSSTRESS_BronsonAVLTreeMap_case(                                                                  \
                        fixture, test_case, BronsonAVLTreeMap_rcu_gpi_less_pool_lazy_stat, key_type, value_type)       \
                        CDSSTRESS_BronsonAVLTreeMap_case(                                                              \
                            fixture, test_case, BronsonAVLTreeMap_rcu_gpt_less_pool_simple, key_type, value_type)      \
                            CDSSTRESS_BronsonAVLTreeMap_case(                                                          \
                                fixture, test_case, BronsonAVLTreeMap_rcu_gpb_less_pool_simple_stat, key_type,         \
                                value_type) CDSSTRESS_BronsonAVLTreeMap_case(fixture, test_case,                       \
                                                                             BronsonAVLTreeMap_rcu_gpb_less_pool_lazy, \
                                                                             key_type, value_type)                     \
                                CDSSTRESS_BronsonAVLTreeMap_case(fixture, test_case,                                   \
                                                                 BronsonAVLTreeMap_rcu_gpt_less_pool_lazy_stat,        \
                                                                 key_type, value_type)                                 \
    ...
    CDSSTRESS_BronsonAVLTreeMap_case(fixture, test_case, BronsonAVLTreeMap_rcu_gpi_less, key_type, value_type)         \
        CDSSTRESS_BronsonAVLTreeMap_case(fixture, test_case, BronsonAVLTreeMap_rcu_gpb_less, key_type, value_type)     \
            CDSSTRESS_BronsonAVLTreeMap_case(fixture, test_case, BronsonAVLTreeMap_rcu_gpt_less, key_type, value_type) \
                CDSSTRESS_BronsonAVLTreeMap_case(fixture, test_case, BronsonAVLTreeMap_rcu_gpb_cmp_stat, key_type,     \
                                                 value_type)                                                           \
                    CDSSTRESS_BronsonAVLTreeMap_case(fixture, test_case, BronsonAVLTreeMap_rcu_gpt_cmp_stat, key_type, \
                                                     value_type)                                                       \
                        CDSSTRESS_BronsonAVLTreeMap_case(                                                              \
                            fixture, test_case, BronsonAVLTreeMap_rcu_gpb_less_pool_simple, key_type, value_type)      \
                            CDSSTRESS_BronsonAVLTreeMap_case(                                                          \
                                fixture, test_case, BronsonAVLTreeMap_rcu_gpt_less_pool_simple_stat, key_type,         \
                                value_type) CDSSTRESS_BronsonAVLTreeMap_case(fixture, test_case,                       \
                                                                             BronsonAVLTreeMap_rcu_gpt_less_pool_lazy, \
                                                                             key_type, value_type)                     \
                                CDSSTRESS_BronsonAVLTreeMap_case(fixture, test_case,                                   \
