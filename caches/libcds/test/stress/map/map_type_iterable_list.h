...
struct iterable_list_type {
    ...
    struct traits_IterableList_cmp : public cc::iterable_list::make_traits<co::compare<compare> >::type {};
    ...
    struct traits_IterableList_cmp_seqcst
        : public cc::iterable_list::make_traits<co::compare<compare>,
    ...
    struct traits_IterableList_less : public cc::iterable_list::make_traits<co::less<less> >::type {};
    ...
    struct traits_IterableList_less_seqcst
        : public cc::iterable_list::make_traits<co::less<less>, co::memory_model<co::v::sequential_consistent> >::type {
    };
