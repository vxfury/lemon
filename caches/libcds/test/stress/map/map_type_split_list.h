...
class SplitListMap : public cc::SplitListMap<GC, Key, T, Traits> {
  ...
  public:
    ...
    SplitListMap(Config const &cfg) : base_class(cfg.s_nMapSize, cfg.s_nLoadFactor)
    {
    }
...
struct map_type<tag_SplitListMap, Key, Value> : public map_type_base<Key, Value> {
    ...
    struct traits_SplitList_Michael_dyn_cmp
        : public cc::split_list::make_traits<cc::split_list::ordered_list<cc::michael_list_tag>, co::hash<hash>,
    ...
    typedef SplitListMap<cds::gc::HP, Key, Value, traits_SplitList_Michael_dyn_cmp_swar>
        SplitList_Michael_HP_dyn_cmp_swar;
    typedef SplitListMap<cds::gc::DHP, Key, Value, traits_SplitList_Michael_dyn_cmp_swar>
        SplitList_Michael_DHP_dyn_cmp_swar;
    typedef SplitListMap<cds::gc::nogc, Key, Value, traits_SplitList_Michael_dyn_cmp_swar>
        SplitList_Michael_NOGC_dyn_cmp_swar;
    typedef SplitListMap<rcu_gpi, Key, Value, traits_SplitList_Michael_dyn_cmp_swar>
        SplitList_Michael_RCU_GPI_dyn_cmp_swar;
    typedef SplitListMap<rcu_gpb, Key, Value, traits_SplitList_Michael_dyn_cmp_swar>
        SplitList_Michael_RCU_GPB_dyn_cmp_swar;
    typedef SplitListMap<rcu_gpt, Key, Value, traits_SplitList_Michael_dyn_cmp_swar>
        SplitList_Michael_RCU_GPT_dyn_cmp_swar;
#ifdef CDS_URCU_SIGNAL_HANDLING_ENABLED
    typedef SplitListMap<rcu_shb, Key, Value, traits_SplitList_Michael_dyn_cmp_swar>
        SplitList_Michael_RCU_SHB_dyn_cmp_swar;
#endif

    struct traits_SplitList_Michael_dyn_cmp_stat : public traits_SplitList_Michael_dyn_cmp {
        typedef cc::split_list::stat<> stat;
        typedef typename cc::michael_list::make_traits<co::compare<compare>, co::stat<cc::michael_list::stat<>>>::type
            ordered_list_traits;
    };
    typedef SplitListMap<cds::gc::HP, Key, Value, traits_SplitList_Michael_dyn_cmp_stat>
        SplitList_Michael_HP_dyn_cmp_stat;
    typedef SplitListMap<cds::gc::DHP, Key, Value, traits_SplitList_Michael_dyn_cmp_stat>
        SplitList_Michael_DHP_dyn_cmp_stat;
    typedef SplitListMap<cds::gc::nogc, Key, Value, traits_SplitList_Michael_dyn_cmp_stat>
        SplitList_Michael_NOGC_dyn_cmp_stat;
    typedef SplitListMap<rcu_gpi, Key, Value, traits_SplitList_Michael_dyn_cmp_stat>
        SplitList_Michael_RCU_GPI_dyn_cmp_stat;
    typedef SplitListMap<rcu_gpb, Key, Value, traits_SplitList_Michael_dyn_cmp_stat>
        SplitList_Michael_RCU_GPB_dyn_cmp_stat;
    typedef SplitListMap<rcu_gpt, Key, Value, traits_SplitList_Michael_dyn_cmp_stat>
        SplitList_Michael_RCU_GPT_dyn_cmp_stat;
#ifdef CDS_URCU_SIGNAL_HANDLING_ENABLED
    typedef SplitListMap<rcu_shb, Key, Value, traits_SplitList_Michael_dyn_cmp_stat>
        SplitList_Michael_RCU_SHB_dyn_cmp_stat;
#endif

    struct traits_SplitList_Michael_dyn_cmp_seqcst
        : public cc::split_list::make_traits<
              cc::split_list::ordered_list<cc::michael_list_tag>, co::hash<hash>,
              co::item_counter<cds::atomicity::cache_friendly_item_counter>,
              co::memory_model<co::v::sequential_consistent>,
              cc::split_list::ordered_list_traits<typename cc::michael_list::make_traits<
                  co::compare<compare>, co::memory_model<co::v::sequential_consistent>>::type>>::type {};
    typedef SplitListMap<cds::gc::HP, Key, Value, traits_SplitList_Michael_dyn_cmp_seqcst>
        SplitList_Michael_HP_dyn_cmp_seqcst;
    typedef SplitListMap<cds::gc::DHP, Key, Value, traits_SplitList_Michael_dyn_cmp_seqcst>
        SplitList_Michael_DHP_dyn_cmp_seqcst;
    typedef SplitListMap<cds::gc::nogc, Key, Value, traits_SplitList_Michael_dyn_cmp_seqcst>
        SplitList_Michael_NOGC_dyn_cmp_seqcst;
    typedef SplitListMap<rcu_gpi, Key, Value, traits_SplitList_Michael_dyn_cmp_seqcst>
        SplitList_Michael_RCU_GPI_dyn_cmp_seqcst;
    typedef SplitListMap<rcu_gpb, Key, Value, traits_SplitList_Michael_dyn_cmp_seqcst>
        SplitList_Michael_RCU_GPB_dyn_cmp_seqcst;
    typedef SplitListMap<rcu_gpt, Key, Value, traits_SplitList_Michael_dyn_cmp_seqcst>
        SplitList_Michael_RCU_GPT_dyn_cmp_seqcst;
#ifdef CDS_URCU_SIGNAL_HANDLING_ENABLED
    typedef SplitListMap<rcu_shb, Key, Value, traits_SplitList_Michael_dyn_cmp_seqcst>
        SplitList_Michael_RCU_SHB_dyn_cmp_seqcst;
#endif

    struct traits_SplitList_Michael_st_cmp
        : public cc::split_list::make_traits<
              cc::split_list::ordered_list<cc::michael_list_tag>, cc::split_list::dynamic_bucket_table<false>,
              co::hash<hash>, co::item_counter<cds::atomicity::cache_friendly_item_counter>,
              cc::split_list::ordered_list_traits<typename cc::michael_list::make_traits<co::compare<compare>>::type>>::
              type {};
    ...
    struct traits_SplitList_Michael_dyn_less
        : public cc::split_list::make_traits<
              cc::split_list::ordered_list<cc::michael_list_tag>, co::hash<hash>,
              co::item_counter<cds::atomicity::cache_friendly_item_counter>,
              cc::split_list::ordered_list_traits<typename cc::michael_list::make_traits<co::less<less>>::type>>::type {
    };
    ...
    struct traits_SplitList_Michael_st_less_stat : traits_SplitList_Michael_st_less {
        typedef cc::split_list::stat<> stat;
        typedef typename cc::michael_list::make_traits<co::less<less>, co::stat<cc::michael_list::stat<>>>::type
            ordered_list_traits;
    };
    typedef SplitListMap<cds::gc::HP, Key, Value, traits_SplitList_Michael_st_less_stat>
    ...
    typedef SplitListMap<cds::gc::nogc, Key, Value, traits_SplitList_Michael_st_less_stat>
        SplitList_Michael_NOGC_st_less_stat;
    typedef SplitListMap<rcu_gpi, Key, Value, traits_SplitList_Michael_st_less_stat>
        SplitList_Michael_RCU_GPI_st_less_stat;
    typedef SplitListMap<rcu_gpb, Key, Value, traits_SplitList_Michael_st_less_stat>
        SplitList_Michael_RCU_GPB_st_less_stat;
    typedef SplitListMap<rcu_gpt, Key, Value, traits_SplitList_Michael_st_less_stat>
        SplitList_Michael_RCU_GPT_st_less_stat;
#ifdef CDS_URCU_SIGNAL_HANDLING_ENABLED
    typedef SplitListMap<rcu_shb, Key, Value, traits_SplitList_Michael_st_less_stat>
        SplitList_Michael_RCU_SHB_st_less_stat;
#endif
    ...
    struct SplitList_Lazy_dyn_cmp
        : public cc::split_list::make_traits<cc::split_list::ordered_list<cc::lazy_list_tag>, co::hash<hash>,
                                             co::item_counter<cds::atomicity::cache_friendly_item_counter>,
    ...
    struct SplitList_Lazy_dyn_cmp_stat : public SplitList_Lazy_dyn_cmp {
        typedef cc::split_list::stat<> stat;
        typedef typename cc::lazy_list::make_traits<co::compare<compare>, co::stat<cc::lazy_list::stat<>>>::type
            ordered_list_traits;
    };
    ...
    struct SplitList_Lazy_dyn_cmp_seqcst
        : public cc::split_list::make_traits<
              cc::split_list::ordered_list<cc::lazy_list_tag>, co::hash<hash>,
              co::item_counter<cds::atomicity::cache_friendly_item_counter>,
              co::memory_model<co::v::sequential_consistent>,
              cc::split_list::ordered_list_traits<typename cc::lazy_list::make_traits<
                  co::compare<compare>, co::memory_model<co::v::sequential_consistent>>::type>>::type {};
    ...
    struct SplitList_Lazy_st_cmp
        : public cc::split_list::make_traits<
              cc::split_list::ordered_list<cc::lazy_list_tag>, cc::split_list::dynamic_bucket_table<false>,
              co::hash<hash>, co::item_counter<cds::atomicity::cache_friendly_item_counter>,
              cc::split_list::ordered_list_traits<typename cc::lazy_list::make_traits<co::compare<compare>>::type>>::
              type {};
    ...
    struct SplitList_Lazy_dyn_less
        : public cc::split_list::make_traits<
              cc::split_list::ordered_list<cc::lazy_list_tag>, co::hash<hash>,
              co::item_counter<cds::atomicity::cache_friendly_item_counter>,
              cc::split_list::ordered_list_traits<typename cc::lazy_list::make_traits<co::less<less>>::type>>::type {};
    ...
    struct SplitList_Lazy_st_less_stat : public SplitList_Lazy_st_less {
        typedef cc::split_list::stat<> stat;
        typedef typename cc::lazy_list::make_traits<co::less<less>, co::stat<cc::lazy_list::stat<>>>::type
            ordered_list_traits;
    };
    ...
    struct traits_SplitList_Iterable_dyn_cmp
        : public cc::split_list::make_traits<
              cc::split_list::ordered_list<cc::iterable_list_tag>, co::hash<hash>,
              co::item_counter<cds::atomicity::cache_friendly_item_counter>,
              cc::split_list::ordered_list_traits<
                  typename cc::iterable_list::make_traits<co::compare<compare>>::type>>::type {};
    ...
    struct traits_SplitList_Iterable_dyn_cmp_stat : public traits_SplitList_Iterable_dyn_cmp {
        typedef cc::split_list::stat<> stat;
        typedef typename cc::iterable_list::make_traits<co::compare<compare>, co::stat<cc::iterable_list::stat<>>>::type
            ordered_list_traits;
    };
    typedef SplitListMap<cds::gc::HP, Key, Value, traits_SplitList_Iterable_dyn_cmp_stat>
        SplitList_Iterable_HP_dyn_cmp_stat;
    typedef SplitListMap<cds::gc::DHP, Key, Value, traits_SplitList_Iterable_dyn_cmp_stat>
        SplitList_Iterable_DHP_dyn_cmp_stat;
    ...
    struct traits_SplitList_Iterable_dyn_cmp_seqcst
        : public cc::split_list::make_traits<
              ...
              co::item_counter<cds::atomicity::cache_friendly_item_counter>,
              co::memory_model<co::v::sequential_consistent>,
              cc::split_list::ordered_list_traits<typename cc::iterable_list::make_traits<
                  co::compare<compare>, co::memory_model<co::v::sequential_consistent>>::type>>::type {};
    typedef SplitListMap<cds::gc::HP, Key, Value, traits_SplitList_Iterable_dyn_cmp_seqcst>
        SplitList_Iterable_HP_dyn_cmp_seqcst;
    typedef SplitListMap<cds::gc::DHP, Key, Value, traits_SplitList_Iterable_dyn_cmp_seqcst>
        SplitList_Iterable_DHP_dyn_cmp_seqcst;

    struct traits_SplitList_Iterable_st_cmp
        : public cc::split_list::make_traits<
              cc::split_list::ordered_list<cc::iterable_list_tag>, cc::split_list::dynamic_bucket_table<false>,
              co::hash<hash>, co::item_counter<cds::atomicity::cache_friendly_item_counter>,
              cc::split_list::ordered_list_traits<
                  typename cc::iterable_list::make_traits<co::compare<compare>>::type>>::type {};
    ...
    struct traits_SplitList_Iterable_dyn_less
        : public cc::split_list::make_traits<cc::split_list::ordered_list<cc::iterable_list_tag>, co::hash<hash>,
                                             co::item_counter<cds::atomicity::cache_friendly_item_counter>,
                                             cc::split_list::ordered_list_traits<
                                                 typename cc::iterable_list::make_traits<co::less<less>>::type>>::type {
    };
    ...
    struct traits_SplitList_Iterable_st_less
        : public cc::split_list::make_traits<cc::split_list::ordered_list<cc::iterable_list_tag>,
                                             cc::split_list::dynamic_bucket_table<false>, co::hash<hash>,
                                             co::item_counter<cds::atomicity::cache_friendly_item_counter>,
                                             cc::split_list::ordered_list_traits<
                                                 typename cc::iterable_list::make_traits<co::less<less>>::type>>::type {
    };
    ...
    struct traits_SplitList_Iterable_st_less_stat : traits_SplitList_Iterable_st_less {
        typedef cc::split_list::stat<> stat;
        typedef typename cc::iterable_list::make_traits<co::less<less>, co::stat<cc::iterable_list::stat<>>>::type
            ordered_list_traits;
    };
    typedef SplitListMap<cds::gc::HP, Key, Value, traits_SplitList_Iterable_st_less_stat>
        SplitList_Iterable_HP_st_less_stat;
    typedef SplitListMap<cds::gc::DHP, Key, Value, traits_SplitList_Iterable_st_less_stat>
        SplitList_Iterable_DHP_st_less_stat;
};
...
{
    o << m.statistics() << cds_test::stat_prefix("list_stat") << m.list_statistics() << cds_test::stat_prefix("");
}
...
#define CDSSTRESS_SplitListMap_SHRCU_2(fixture, test_case, key_type, value_type)                                    \
    CDSSTRESS_SplitListMap_case(fixture, test_case, SplitList_Michael_RCU_SHB_dyn_cmp_seqcst, key_type, value_type) \
        CDSSTRESS_SplitListMap_case(fixture, test_case, SplitList_Michael_RCU_SHT_dyn_cmp_seqcst, key_type,         \
                                    value_type)
    ...
    CDSSTRESS_SplitListMap_case(fixture, test_case, SplitList_Michael_RCU_SHT_dyn_cmp, key_type, value_type)           \
        CDSSTRESS_SplitListMap_case(fixture, test_case, SplitList_Michael_RCU_SHB_dyn_cmp_stat, key_type, value_type)  \
            CDSSTRESS_SplitListMap_case(fixture, test_case, SplitList_Michael_RCU_SHB_st_cmp, key_type, value_type)    \
                CDSSTRESS_SplitListMap_case(                                                                           \
                    fixture, test_case, SplitList_Michael_RCU_SHT_st_cmp, key_type,                                    \
                    value_type) CDSSTRESS_SplitListMap_case(fixture, test_case, SplitList_Michael_RCU_SHB_dyn_less,    \
                                                            key_type, value_type)                                      \
                    CDSSTRESS_SplitListMap_case(fixture, test_case, SplitList_Michael_RCU_SHT_st_less, key_type,       \
                                                value_type)                                                            \
                        CDSSTRESS_SplitListMap_case(fixture, test_case, SplitList_Michael_RCU_SHB_st_less_stat,        \
                                                    key_type, value_type)                                              \
                            CDSSTRESS_SplitListMap_case(fixture, test_case, SplitList_Lazy_RCU_SHT_dyn_cmp, key_type,  \
                                                        value_type)                                                    \
                                CDSSTRESS_SplitListMap_case(fixture, test_case, SplitList_Lazy_RCU_SHB_dyn_cmp_stat,   \
                                                            key_type, value_type)                                      \
                                    CDSSTRESS_SplitListMap_case(fixture, test_case, SplitList_Lazy_RCU_SHB_st_cmp,     \
                                                                key_type, value_type)                                  \
                                        CDSSTRESS_SplitListMap_case(fixture, test_case, SplitList_Lazy_RCU_SHT_st_cmp, \
                                                                    key_type, value_type)                              \
                                            CDSSTRESS_SplitListMap_case(fixture, test_case,                            \
                                                                        SplitList_Lazy_RCU_SHB_dyn_less, key_type,     \
                                                                        value_type)                                    \
                                                CDSSTRESS_SplitListMap_case(fixture, test_case,                        \
                                                                            SplitList_Lazy_RCU_SHT_st_less, key_type,  \
                                                                            value_type)                                \
                                                    CDSSTRESS_SplitListMap_case(fixture, test_case,                    \
                                                                                SplitList_Lazy_RCU_SHB_st_less_stat,   \
                                                                                key_type, value_type)
    ...
    CDSSTRESS_SplitListMap_case(fixture, test_case, SplitList_Michael_RCU_SHB_dyn_cmp, key_type, value_type)           \
        CDSSTRESS_SplitListMap_case(fixture, test_case, SplitList_Michael_RCU_SHT_dyn_cmp_stat, key_type, value_type)  \
            CDSSTRESS_SplitListMap_case(fixture, test_case, SplitList_Michael_RCU_SHT_dyn_less, key_type, value_type)  \
                CDSSTRESS_SplitListMap_case(fixture, test_case, SplitList_Michael_RCU_SHB_st_less, key_type,           \
                                            value_type)                                                                \
                    CDSSTRESS_SplitListMap_case(                                                                       \
                        fixture, test_case, SplitList_Michael_RCU_SHT_st_less_stat, key_type,                          \
                        value_type) CDSSTRESS_SplitListMap_case(fixture, test_case, SplitList_Lazy_RCU_SHB_dyn_cmp,    \
                                                                key_type, value_type)                                  \
                        CDSSTRESS_SplitListMap_case(fixture, test_case, SplitList_Lazy_RCU_SHT_dyn_cmp_stat, key_type, \
                                                    value_type)                                                        \
                            CDSSTRESS_SplitListMap_case(fixture, test_case, SplitList_Lazy_RCU_SHT_dyn_less, key_type, \
                                                        value_type)                                                    \
                                CDSSTRESS_SplitListMap_case(fixture, test_case, SplitList_Lazy_RCU_SHB_st_less,        \
                                                            key_type, value_type)                                      \
                                    CDSSTRESS_SplitListMap_case(                                                       \
                                        fixture, test_case, SplitList_Lazy_RCU_SHT_st_less_stat, key_type, value_type) \
    ...
    CDSSTRESS_SplitListMap_case(fixture, test_case, SplitList_Michael_HP_dyn_cmp_seqcst, key_type, value_type)      \
        CDSSTRESS_SplitListMap_case(fixture, test_case, SplitList_Michael_DHP_dyn_cmp_seqcst, key_type, value_type) \
            CDSSTRESS_SplitListMap_case(fixture, test_case, SplitList_Lazy_HP_dyn_cmp_seqcst, key_type, value_type) \
                CDSSTRESS_SplitListMap_case(fixture, test_case, SplitList_Lazy_DHP_dyn_cmp_seqcst, key_type,        \
                                            value_type)
...
#define CDSSTRESS_SplitListMap_RCU_2(fixture, test_case, key_type, value_type)                                       \
    CDSSTRESS_SplitListMap_case(fixture, test_case, SplitList_Michael_RCU_GPI_dyn_cmp_seqcst, key_type, value_type)  \
        CDSSTRESS_SplitListMap_case(fixture, test_case, SplitList_Michael_RCU_GPB_dyn_cmp_seqcst, key_type,          \
                                    value_type)                                                                      \
            CDSSTRESS_SplitListMap_case(fixture, test_case, SplitList_Michael_RCU_GPT_dyn_cmp_seqcst, key_type,      \
                                        value_type)                                                                  \
                CDSSTRESS_SplitListMap_case(fixture, test_case, SplitList_Lazy_RCU_GPI_dyn_cmp_seqcst, key_type,     \
                                            value_type)                                                              \
                    CDSSTRESS_SplitListMap_case(fixture, test_case, SplitList_Lazy_RCU_GPB_dyn_cmp_seqcst, key_type, \
                                                value_type)                                                          \
                        CDSSTRESS_SplitListMap_case(fixture, test_case, SplitList_Lazy_RCU_GPT_dyn_cmp_seqcst,       \
                                                    key_type, value_type)
        ...
        CDSSTRESS_SplitListMap_case(fixture, test_case, SplitList_Michael_DHP_dyn_cmp_swar, key_type, value_type)      \
            CDSSTRESS_SplitListMap_case(fixture, test_case, SplitList_Michael_HP_dyn_cmp_stat, key_type, value_type)   \
                CDSSTRESS_SplitListMap_case(fixture, test_case, SplitList_Michael_HP_st_cmp, key_type, value_type)     \
                    CDSSTRESS_SplitListMap_case(fixture, test_case, SplitList_Michael_DHP_dyn_less, key_type,          \
                                                value_type) CDSSTRESS_SplitListMap_case(fixture, test_case,            \
                                                                                        SplitList_Michael_HP_st_less,  \
                                                                                        key_type, value_type)          \
                        CDSSTRESS_SplitListMap_case(fixture, test_case, SplitList_Michael_DHP_st_less_stat, key_type,  \
                                                    value_type)                                                        \
                            CDSSTRESS_SplitListMap_case(fixture, test_case, SplitList_Lazy_DHP_dyn_cmp, key_type,      \
                                                        value_type)                                                    \
                                CDSSTRESS_SplitListMap_case(fixture, test_case, SplitList_Lazy_HP_dyn_cmp_stat,        \
                                                            key_type, value_type)                                      \
                                    CDSSTRESS_SplitListMap_case(fixture, test_case, SplitList_Lazy_HP_st_cmp,          \
                                                                key_type, value_type)                                  \
                                        CDSSTRESS_SplitListMap_case(fixture, test_case, SplitList_Lazy_DHP_dyn_less,   \
                                                                    key_type, value_type)                              \
                                            CDSSTRESS_SplitListMap_case(fixture, test_case, SplitList_Lazy_HP_st_less, \
                                                                        key_type, value_type)                          \
                                                CDSSTRESS_SplitListMap_case(fixture, test_case,                        \
                                                                            SplitList_Lazy_DHP_st_less_stat, key_type, \
                                                                            value_type)
...
#define CDSSTRESS_SplitListMap_RCU_1(fixture, test_case, key_type, value_type)                                         \
    CDSSTRESS_SplitListMap_case(fixture, test_case, SplitList_Michael_RCU_GPI_dyn_cmp_stat, key_type, value_type)      \
        CDSSTRESS_SplitListMap_case(fixture, test_case, SplitList_Michael_RCU_GPT_dyn_cmp, key_type, value_type)       \
            CDSSTRESS_SplitListMap_case(fixture, test_case, SplitList_Michael_RCU_GPT_dyn_cmp_stat, key_type,          \
                                        value_type) CDSSTRESS_SplitListMap_case(fixture, test_case,                    \
                                                                                SplitList_Michael_RCU_GPI_st_cmp,      \
                                                                                key_type, value_type)                  \
                CDSSTRESS_SplitListMap_case(                                                                           \
                    fixture, test_case, SplitList_Michael_RCU_GPT_st_cmp, key_type,                                    \
                    value_type) CDSSTRESS_SplitListMap_case(fixture, test_case, SplitList_Michael_RCU_GPB_dyn_less,    \
                                                            key_type, value_type)                                      \
                    CDSSTRESS_SplitListMap_case(                                                                       \
                        fixture, test_case, SplitList_Michael_RCU_GPI_st_less, key_type,                               \
                        value_type) CDSSTRESS_SplitListMap_case(fixture, test_case, SplitList_Michael_RCU_GPT_st_less, \
                                                                key_type, value_type)                                  \
                        CDSSTRESS_SplitListMap_case(fixture, test_case, SplitList_Michael_RCU_GPB_st_less_stat,        \
                                                    key_type, value_type)                                              \
                            CDSSTRESS_SplitListMap_case(                                                               \
                                fixture, test_case, SplitList_Lazy_RCU_GPB_dyn_cmp, key_type,                          \
                                value_type) CDSSTRESS_SplitListMap_case(fixture, test_case,                            \
                                                                        SplitList_Lazy_RCU_GPI_dyn_cmp_stat, key_type, \
                                                                        value_type)                                    \
                                CDSSTRESS_SplitListMap_case(fixture, test_case, SplitList_Lazy_RCU_GPT_dyn_cmp_stat,   \
                                                            key_type, value_type)                                      \
                                    CDSSTRESS_SplitListMap_case(fixture, test_case, SplitList_Lazy_RCU_GPI_st_cmp,     \
                                                                key_type, value_type)                                  \
                                        CDSSTRESS_SplitListMap_case(fixture, test_case, SplitList_Lazy_RCU_GPT_st_cmp, \
                                                                    key_type, value_type)                              \
                                            CDSSTRESS_SplitListMap_case(fixture, test_case,                            \
                                                                        SplitList_Lazy_RCU_GPB_dyn_less, key_type,     \
                                                                        value_type)                                    \
                                                CDSSTRESS_SplitListMap_case(fixture, test_case,                        \
                                                                            SplitList_Lazy_RCU_GPI_st_less, key_type,  \
                                                                            value_type)                                \
                                                    CDSSTRESS_SplitListMap_case(fixture, test_case,                    \
                                                                                SplitList_Lazy_RCU_GPT_st_less,        \
                                                                                key_type, value_type)                  \
                                                        CDSSTRESS_SplitListMap_case(                                   \
                                                            fixture, test_case, SplitList_Lazy_RCU_GPB_st_less_stat,   \
                                                            key_type, value_type)                                      \
                                                            CDSSTRESS_SplitListMap_SHRCU(fixture, test_case, key_type, \
                                                                                         value_type)
        ...
        CDSSTRESS_SplitListMap_case(fixture, test_case, SplitList_Michael_HP_dyn_cmp_swar, key_type, value_type)       \
            CDSSTRESS_SplitListMap_case(fixture, test_case, SplitList_Michael_DHP_dyn_cmp_stat, key_type, value_type)  \
                CDSSTRESS_SplitListMap_case(fixture, test_case, SplitList_Michael_DHP_st_cmp, key_type, value_type)    \
                    CDSSTRESS_SplitListMap_case(                                                                       \
                        fixture, test_case, SplitList_Michael_HP_dyn_less, key_type,                                   \
                        value_type) CDSSTRESS_SplitListMap_case(fixture, test_case, SplitList_Michael_HP_st_less_stat, \
                                                                key_type, value_type)                                  \
                        CDSSTRESS_SplitListMap_case(fixture, test_case, SplitList_Michael_DHP_st_less, key_type,       \
                                                    value_type) CDSSTRESS_SplitListMap_case(fixture, test_case,        \
                                                                                            SplitList_Lazy_HP_dyn_cmp, \
                                                                                            key_type, value_type)      \
                            CDSSTRESS_SplitListMap_case(                                                               \
                                fixture, test_case, SplitList_Lazy_DHP_dyn_cmp_stat, key_type,                         \
                                value_type) CDSSTRESS_SplitListMap_case(fixture, test_case, SplitList_Lazy_DHP_st_cmp, \
                                                                        key_type, value_type)                          \
                                CDSSTRESS_SplitListMap_case(fixture, test_case, SplitList_Lazy_HP_dyn_less, key_type,  \
                                                            value_type)                                                \
                                    CDSSTRESS_SplitListMap_case(fixture, test_case, SplitList_Lazy_DHP_st_less,        \
                                                                key_type, value_type)                                  \
                                        CDSSTRESS_SplitListMap_case(                                                   \
                                            fixture, test_case, SplitList_Lazy_HP_st_less_stat, key_type, value_type)  \
                                            CDSSTRESS_SplitListMap_HP_1(fixture, test_case, key_type, value_type)      \
                                                CDSSTRESS_SplitListMap_HP_2(fixture, test_case, key_type, value_type)
...
#define CDSSTRESS_SplitListMap_RCU(fixture, test_case, key_type, value_type)                                           \
    CDSSTRESS_SplitListMap_case(fixture, test_case, SplitList_Michael_RCU_GPI_dyn_cmp, key_type, value_type)           \
        CDSSTRESS_SplitListMap_case(fixture, test_case, SplitList_Michael_RCU_GPB_dyn_cmp, key_type, value_type)       \
            CDSSTRESS_SplitListMap_case(                                                                               \
                fixture, test_case, SplitList_Michael_RCU_GPB_dyn_cmp_swar, key_type,                                  \
                value_type) CDSSTRESS_SplitListMap_case(fixture, test_case, SplitList_Michael_RCU_GPB_dyn_cmp_stat,    \
                                                        key_type, value_type)                                          \
                CDSSTRESS_SplitListMap_case(                                                                           \
                    fixture, test_case, SplitList_Michael_RCU_GPB_st_cmp, key_type,                                    \
                    value_type) CDSSTRESS_SplitListMap_case(fixture, test_case, SplitList_Michael_RCU_GPI_dyn_less,    \
                                                            key_type, value_type)                                      \
                    CDSSTRESS_SplitListMap_case(                                                                       \
                        fixture, test_case, SplitList_Michael_RCU_GPT_dyn_less, key_type,                              \
                        value_type) CDSSTRESS_SplitListMap_case(fixture, test_case, SplitList_Michael_RCU_GPB_st_less, \
                                                                key_type, value_type)                                  \
                        CDSSTRESS_SplitListMap_case(fixture, test_case, SplitList_Michael_RCU_GPI_st_less_stat,        \
                                                    key_type, value_type)                                              \
                            CDSSTRESS_SplitListMap_case(fixture, test_case, SplitList_Michael_RCU_GPT_st_less_stat,    \
                                                        key_type, value_type)                                          \
                                CDSSTRESS_SplitListMap_case(fixture, test_case, SplitList_Lazy_RCU_GPI_dyn_cmp,        \
                                                            key_type, value_type)                                      \
                                    CDSSTRESS_SplitListMap_case(                                                       \
                                        fixture, test_case, SplitList_Lazy_RCU_GPT_dyn_cmp, key_type,                  \
                                        value_type) CDSSTRESS_SplitListMap_case(fixture, test_case,                    \
                                                                                SplitList_Lazy_RCU_GPB_dyn_cmp_stat,   \
                                                                                key_type, value_type)                  \
                                        CDSSTRESS_SplitListMap_case(                                                   \
                                            fixture, test_case, SplitList_Lazy_RCU_GPB_st_cmp, key_type,               \
                                            value_type) CDSSTRESS_SplitListMap_case(fixture, test_case,                \
                                                                                    SplitList_Lazy_RCU_GPI_dyn_less,   \
                                                                                    key_type, value_type)              \
                                            CDSSTRESS_SplitListMap_case(fixture, test_case,                            \
                                                                        SplitList_Lazy_RCU_GPT_dyn_less, key_type,     \
                                                                        value_type)                                    \
                                                CDSSTRESS_SplitListMap_case(fixture, test_case,                        \
                                                                            SplitList_Lazy_RCU_GPB_st_less, key_type,  \
                                                                            value_type)                                \
                                                    CDSSTRESS_SplitListMap_case(fixture, test_case,                    \
                                                                                SplitList_Lazy_RCU_GPI_st_less_stat,   \
                                                                                key_type, value_type)                  \
                                                        CDSSTRESS_SplitListMap_case(                                   \
                                                            fixture, test_case, SplitList_Lazy_RCU_GPT_st_less_stat,   \
                                                            key_type, value_type)                                      \
                                                            CDSSTRESS_SplitListMap_RCU_1(fixture, test_case, key_type, \
                                                                                         value_type)                   \
                                                                CDSSTRESS_SplitListMap_RCU_2(fixture, test_case,       \
                                                                                             key_type, value_type)
        ...
        CDSSTRESS_SplitListMap_case(fixture, test_case, SplitList_Iterable_HP_dyn_cmp_stat, key_type, value_type)      \
            CDSSTRESS_SplitListMap_case(fixture, test_case, SplitList_Iterable_HP_st_cmp, key_type, value_type)        \
                CDSSTRESS_SplitListMap_case(fixture, test_case, SplitList_Iterable_DHP_dyn_less, key_type, value_type) \
                    CDSSTRESS_SplitListMap_case(fixture, test_case, SplitList_Iterable_HP_st_less, key_type,           \
                                                value_type)                                                            \
                        CDSSTRESS_SplitListMap_case(fixture, test_case, SplitList_Iterable_DHP_st_less_stat, key_type, \
                                                    value_type)
        ...
        CDSSTRESS_SplitListMap_case(fixture, test_case, SplitList_Iterable_DHP_dyn_cmp_stat, key_type, value_type)    \
            CDSSTRESS_SplitListMap_case(fixture, test_case, SplitList_Iterable_DHP_st_cmp, key_type, value_type)      \
                CDSSTRESS_SplitListMap_case(fixture, test_case, SplitList_Iterable_HP_dyn_less, key_type, value_type) \
                    CDSSTRESS_SplitListMap_case(fixture, test_case, SplitList_Iterable_DHP_st_less, key_type,         \
                                                value_type)                                                           \
                        CDSSTRESS_SplitListMap_case(fixture, test_case, SplitList_Iterable_HP_st_less_stat, key_type, \
                                                    value_type)                                                       \
        ...
        CDSSTRESS_SplitListMap_case(fixture, test_case, SplitList_Michael_NOGC_dyn_cmp_stat, key_type, value_type)     \
            CDSSTRESS_SplitListMap_case(fixture, test_case, SplitList_Michael_NOGC_st_cmp, key_type, value_type)       \
                CDSSTRESS_SplitListMap_case(fixture, test_case, SplitList_Michael_NOGC_dyn_less, key_type, value_type) \
                    CDSSTRESS_SplitListMap_case(fixture, test_case, SplitList_Michael_NOGC_st_less, key_type,          \
                                                value_type)                                                            \
                        CDSSTRESS_SplitListMap_case(fixture, test_case, SplitList_Michael_NOGC_st_less_stat, key_type, \
                                                    value_type)                                                        \
                            CDSSTRESS_SplitListMap_case(fixture, test_case, SplitList_Lazy_NOGC_dyn_cmp, key_type,     \
                                                        value_type)                                                    \
                                CDSSTRESS_SplitListMap_case(fixture, test_case, SplitList_Lazy_NOGC_dyn_cmp_stat,      \
                                                            key_type, value_type)                                      \
                                    CDSSTRESS_SplitListMap_case(fixture, test_case, SplitList_Lazy_NOGC_st_cmp,        \
                                                                key_type, value_type)                                  \
                                        CDSSTRESS_SplitListMap_case(fixture, test_case, SplitList_Lazy_NOGC_dyn_less,  \
                                                                    key_type, value_type)                              \
                                            CDSSTRESS_SplitListMap_case(                                               \
                                                fixture, test_case, SplitList_Lazy_NOGC_st_less, key_type, value_type) \
                                                CDSSTRESS_SplitListMap_case(fixture, test_case,                        \
                                                                            SplitList_Lazy_NOGC_st_less_stat,          \
                                                                            key_type, value_type)
