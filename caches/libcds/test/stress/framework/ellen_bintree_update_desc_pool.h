...
typedef cds::memory::bounded_vyukov_queue_pool<update_desc, bounded_update_desc_pool_traits>
...
class internal_node_allocator : public std::allocator_traits<Alloc>::template rebind_alloc<T>, internal_node_counter {
