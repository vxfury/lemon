...
struct Types {
    ...
    struct traits_Treiber_seqcst : public cds::container::treiber_stack::make_traits<
    ...
    struct traits_Treiber_stat : public cds::container::treiber_stack::make_traits<
    ...
    struct traits_Treiber_pause
        : public cds::container::treiber_stack::make_traits<cds::opt::back_off<cds::backoff::pause> >::type {};
    ...
    struct traits_Elimination_on
        : public cds::container::treiber_stack::make_traits<cds::opt::enable_elimination<true> >::type {};
    ...
    struct traits_Elimination_stat
        : public cds::container::treiber_stack::make_traits<
              cds::opt::enable_elimination<true>, cds::opt::stat<cds::intrusive::treiber_stack::stat<> > >::type {};
    ...
    struct traits_Elimination_2ms
        : public cds::container::treiber_stack::make_traits<
              cds::opt::enable_elimination<true>, cds::opt::elimination_backoff<cds::backoff::delay_of<2> > >::type {};
    ...
    struct traits_Elimination_2ms_stat
        : public cds::container::treiber_stack::make_traits<
              cds::opt::enable_elimination<true>, cds::opt::elimination_backoff<cds::backoff::delay_of<2> >,
              cds::opt::stat<cds::intrusive::treiber_stack::stat<> > >::type {};
    ...
    struct traits_Elimination_5ms
        : public cds::container::treiber_stack::make_traits<
              cds::opt::enable_elimination<true>, cds::opt::elimination_backoff<cds::backoff::delay_of<5> > >::type {};
    ...
    struct traits_Elimination_5ms_stat
        : public cds::container::treiber_stack::make_traits<
              cds::opt::enable_elimination<true>, cds::opt::elimination_backoff<cds::backoff::delay_of<5> >,
              cds::opt::stat<cds::intrusive::treiber_stack::stat<> > >::type {};
    ...
    struct traits_Elimination_10ms
        : public cds::container::treiber_stack::make_traits<
              cds::opt::enable_elimination<true>, cds::opt::elimination_backoff<cds::backoff::delay_of<10> > >::type {};
    ...
    struct traits_Elimination_10ms_stat
        : public cds::container::treiber_stack::make_traits<
              cds::opt::enable_elimination<true>, cds::opt::elimination_backoff<cds::backoff::delay_of<10> >,
              cds::opt::stat<cds::intrusive::treiber_stack::stat<> > >::type {};
    ...
    struct traits_Elimination_dyn : public cds::container::treiber_stack::make_traits<
    ...
    struct traits_Elimination_seqcst
        : public cds::container::treiber_stack::make_traits<
              cds::opt::enable_elimination<true>, cds::opt::memory_model<cds::opt::v::sequential_consistent> >::type {};
    ...
    struct traits_Elimination_dyn_stat
        : public cds::container::treiber_stack::make_traits<
              cds::opt::enable_elimination<true>, cds::opt::stat<cds::intrusive::treiber_stack::stat<> >,
              cds::opt::buffer<cds::opt::v::initialized_dynamic_buffer<int> > >::type {};
    ...
    struct traits_Elimination_yield : public cds::container::treiber_stack::make_traits<
                                          cds::opt::enable_elimination<true>, cds::opt::back_off<cds::backoff::yield>,
    ...
    struct traits_Elimination_pause
        : public cds::container::treiber_stack::make_traits<cds::opt::enable_elimination<true>,
    ...
    struct traits_FCStack_stat
        : public cds::container::fcstack::make_traits<cds::opt::stat<cds::container::fcstack::stat<> > >::type {};
    struct traits_FCStack_elimination
        : public cds::container::fcstack::make_traits<cds::opt::enable_elimination<true> >::type {};
    struct traits_FCStack_elimination_stat
        : public cds::container::fcstack::make_traits<cds::opt::stat<cds::container::fcstack::stat<> >,
                                                      cds::opt::enable_elimination<true> >::type {};
    struct traits_FCStack_mutex : public cds::container::fcstack::make_traits<cds::opt::lock_type<std::mutex> >::type {
    };
    ...
    typedef cds::container::FCStack<T, std::stack<T, std::deque<T> >, traits_FCStack_elimination>
        FCStack_deque_elimination;
    typedef cds::container::FCStack<T, std::stack<T, std::deque<T> >, traits_FCStack_elimination_stat>
        FCStack_deque_elimination_stat;
    ...
    typedef cds::container::FCStack<T, std::stack<T, std::vector<T> >, traits_FCStack_elimination>
        FCStack_vector_elimination;
    typedef cds::container::FCStack<T, std::stack<T, std::vector<T> >, traits_FCStack_elimination_stat>
        FCStack_vector_elimination_stat;
    ...
    typedef cds::container::FCStack<T, std::stack<T, std::list<T> >, traits_FCStack_elimination>
        FCStack_list_elimination;
    typedef cds::container::FCStack<T, std::stack<T, std::list<T> >, traits_FCStack_elimination_stat>
...
{
    return o << CDSSTRESS_STAT_OUT(s, m_nPush) << CDSSTRESS_STAT_OUT(s, m_nPushMove) << CDSSTRESS_STAT_OUT(s, m_nPop)
             << CDSSTRESS_STAT_OUT(s, m_nFailedPop) << CDSSTRESS_STAT_OUT(s, m_nCollided)
...
#define CDSSTRESS_TreiberStack(test_fixture)                                                                        \
    CDSSTRESS_Stack_F(test_fixture, Treiber_HP) CDSSTRESS_Stack_F(test_fixture, Treiber_HP_seqcst)                  \
        CDSSTRESS_Stack_F(test_fixture, Treiber_HP_pause) CDSSTRESS_Stack_F(test_fixture, Treiber_HP_exp)           \
            CDSSTRESS_Stack_F(test_fixture, Treiber_HP_stat) CDSSTRESS_Stack_F(test_fixture, Treiber_DHP)           \
                CDSSTRESS_Stack_F(test_fixture, Treiber_DHP_pause) CDSSTRESS_Stack_F(test_fixture, Treiber_DHP_exp) \
                    CDSSTRESS_Stack_F(test_fixture, Treiber_DHP_stat)

#define CDSSTRESS_EliminationStack(test_fixture)                                                                       \
    CDSSTRESS_EliminationStack_F(test_fixture, Elimination_HP) CDSSTRESS_EliminationStack_F(                           \
        test_fixture, Elimination_HP_2ms) CDSSTRESS_EliminationStack_F(test_fixture, Elimination_HP_2ms_stat)          \
        CDSSTRESS_EliminationStack_F(test_fixture, Elimination_HP_5ms) CDSSTRESS_EliminationStack_F(                   \
            test_fixture, Elimination_HP_5ms_stat) CDSSTRESS_EliminationStack_F(test_fixture, Elimination_HP_10ms)     \
            CDSSTRESS_EliminationStack_F(test_fixture, Elimination_HP_10ms_stat) CDSSTRESS_EliminationStack_F(         \
                test_fixture, Elimination_HP_seqcst) CDSSTRESS_EliminationStack_F(test_fixture, Elimination_HP_pause)  \
                CDSSTRESS_EliminationStack_F(test_fixture, Elimination_HP_exp) CDSSTRESS_EliminationStack_F(           \
                    test_fixture, Elimination_HP_stat) CDSSTRESS_EliminationStack_F(test_fixture, Elimination_HP_dyn)  \
                    CDSSTRESS_EliminationStack_F(test_fixture, Elimination_HP_dyn_stat) CDSSTRESS_EliminationStack_F(  \
                        test_fixture, Elimination_DHP) CDSSTRESS_EliminationStack_F(test_fixture, Elimination_DHP_2ms) \
                                            ...
                                            CDSSTRESS_EliminationStack_F(test_fixture, Elimination_DHP_pause)          \
                                                CDSSTRESS_EliminationStack_F(test_fixture, Elimination_DHP_exp)        \
                                                    CDSSTRESS_EliminationStack_F(test_fixture, Elimination_DHP_stat)   \
                                                        CDSSTRESS_EliminationStack_F(test_fixture,                     \
                                                                                     Elimination_DHP_dyn)              \
                                                            CDSSTRESS_EliminationStack_F(test_fixture,                 \
                                                                                         Elimination_DHP_dyn_stat)

#define CDSSTRESS_FCStack(test_fixture)                                                                                \
    CDSSTRESS_Stack_F(test_fixture, FCStack_deque) CDSSTRESS_Stack_F(test_fixture, FCStack_deque_mutex)                \
        CDSSTRESS_Stack_F(test_fixture, FCStack_deque_stat) CDSSTRESS_Stack_F(test_fixture, FCStack_deque_elimination) \
            CDSSTRESS_Stack_F(test_fixture, FCStack_deque_elimination_stat)                                            \
                CDSSTRESS_Stack_F(test_fixture, FCStack_vector) CDSSTRESS_Stack_F(test_fixture, FCStack_vector_mutex)  \
...
#define CDSSTRESS_FCDeque(test_fixture)                                                                           \
    CDSSTRESS_Stack_F(test_fixture, FCDequeL_default) CDSSTRESS_Stack_F(test_fixture, FCDequeL_mutex)             \
        CDSSTRESS_Stack_F(test_fixture, FCDequeL_stat) CDSSTRESS_Stack_F(test_fixture, FCDequeL_elimination)      \
            CDSSTRESS_Stack_F(test_fixture, FCDequeL_elimination_stat)                                            \
                CDSSTRESS_Stack_F(test_fixture, FCDequeR_default) CDSSTRESS_Stack_F(test_fixture, FCDequeR_mutex) \
