...
class FCDequeL : public cds::container::FCDeque<T, Deque, Traits> {
  ...
  public:
    ...
    FCDequeL(unsigned int nCompactFactor ///< Flat combining: publication list compacting factor
             ,
...
class FCDequeR : public cds::container::FCDeque<T, Deque, Traits> {
  ...
  public:
    ...
    FCDequeR(unsigned int nCompactFactor ///< Flat combining: publication list compacting factor
             ,
             unsigned int nCombinePassCount ///< Flat combining: number of combining passes for combiner thread
             )
        : base_class(nCompactFactor, nCombinePassCount)
...
struct traits_FCDeque_stat
    : public cds::container::fcdeque::make_traits<cds::opt::stat<cds::container::fcdeque::stat<>>>::type {};
...
struct traits_FCDeque_elimination_stat
    : public cds::container::fcdeque::make_traits<cds::opt::stat<cds::container::fcdeque::stat<>>,
                                                  cds::opt::enable_elimination<true>>::type {};
struct traits_FCDeque_mutex : public cds::container::fcdeque::make_traits<cds::opt::lock_type<std::mutex>>::type {};
...
struct Types {
    ...
    struct traits_MSQueue_seqcst : public cds::container::msqueue::make_traits<
                                       cds::opt::memory_model<cds::opt::v::sequential_consistent>>::type {};
    ...
    struct traits_MSQueue_ic
        : public cds::container::msqueue::make_traits<cds::opt::item_counter<cds::atomicity::item_counter>>::type {};
    ...
    // MSQueue + stat
    struct traits_MSQueue_stat
        : public cds::container::msqueue::make_traits<cds::opt::stat<cds::container::msqueue::stat<>>>::type {};
    ...
    typedef cds::container::OptimisticQueue<cds::gc::HP, Value, traits_OptimisticQueue_seqcst>
        OptimisticQueue_HP_seqcst;
    typedef cds::container::OptimisticQueue<cds::gc::DHP, Value, traits_OptimisticQueue_seqcst>
        OptimisticQueue_DHP_seqcst;
    ...
    struct traits_OptimisticQueue_stat : public cds::container::optimistic_queue::make_traits<
                                             cds::opt::stat<cds::intrusive::optimistic_queue::stat<>>>::type {};
    ...
    class VyukovMPMCCycleQueue_dyn
      ...
      public:
        VyukovMPMCCycleQueue_dyn() : base_class(1024 * 64) {}
        VyukovMPMCCycleQueue_dyn(size_t nCapacity) : base_class(nCapacity) {}
    ...
    class VyukovMPMCCycleQueue_dyn_ic
      ...
      public:
        VyukovMPMCCycleQueue_dyn_ic() : base_class(1024 * 64) {}
        VyukovMPMCCycleQueue_dyn_ic(size_t nCapacity) : base_class(nCapacity) {}
    ...
    class VyukovMPSCCycleQueue_dyn
      ...
      public:
        VyukovMPSCCycleQueue_dyn() : base_class(1024 * 64) {}
        VyukovMPSCCycleQueue_dyn(size_t nCapacity) : base_class(nCapacity) {}
    ...
    class VyukovMPSCCycleQueue_dyn_ic
      ...
      public:
        VyukovMPSCCycleQueue_dyn_ic() : base_class(1024 * 64) {}
        VyukovMPSCCycleQueue_dyn_ic(size_t nCapacity) : base_class(nCapacity) {}
    ...
    class WeakRingBuffer_dyn : public cds::container::WeakRingBuffer<Value, traits_WeakRingBuffer_dyn> {
        typedef cds::container::WeakRingBuffer<Value, traits_WeakRingBuffer_dyn> base_class;

      public:
        WeakRingBuffer_dyn() : base_class(1024 * 64) {}
        WeakRingBuffer_dyn(size_t nCapacity) : base_class(nCapacity) {}
    ...
    class WeakRingBuffer_void_dyn : public cds::container::WeakRingBuffer<void, traits_WeakRingBuffer_dyn> {
        typedef cds::container::WeakRingBuffer<void, traits_WeakRingBuffer_dyn> base_class;

      public:
        WeakRingBuffer_void_dyn() : base_class(1024 * 64) {}
        WeakRingBuffer_void_dyn(size_t nCapacity) : base_class(nCapacity) {}
    ...
    struct traits_RWQueue_mutex : public cds::container::rwqueue::make_traits<cds::opt::lock_type<std::mutex>>::type {};
    typedef cds::container::RWQueue<Value, traits_RWQueue_mutex> RWQueue_mutex;

    // FCQueue
    struct traits_FCQueue_stat
        : public cds::container::fcqueue::make_traits<cds::opt::stat<cds::container::fcqueue::stat<>>>::type {};
    struct traits_FCQueue_single_mutex_single_condvar
        : public cds::container::fcqueue::make_traits<
              cds::opt::wait_strategy<cds::algo::flat_combining::wait_strategy::single_mutex_single_condvar<>>>::type {
    };
    ...
    struct traits_FCQueue_single_mutex_multi_condvar
        : public cds::container::fcqueue::make_traits<
              cds::opt::wait_strategy<cds::algo::flat_combining::wait_strategy::single_mutex_multi_condvar<>>>::type {};
    ...
    struct traits_FCQueue_multi_mutex_multi_condvar
        : public cds::container::fcqueue::make_traits<
              cds::opt::wait_strategy<cds::algo::flat_combining::wait_strategy::multi_mutex_multi_condvar<>>>::type {};
    ...
    struct traits_FCQueue_elimination_stat
        : public cds::container::fcqueue::make_traits<cds::opt::enable_elimination<true>,
                                                      cds::opt::stat<cds::container::fcqueue::stat<>>>::type {};
    ...
    typedef cds::container::FCQueue<Value, std::queue<Value>, traits_FCQueue_single_mutex_single_condvar>
        FCQueue_deque_wait_ss;
    typedef cds::container::FCQueue<Value, std::queue<Value>, traits_FCQueue_single_mutex_single_condvar_stat>
        FCQueue_deque_wait_ss_stat;
    typedef cds::container::FCQueue<Value, std::queue<Value>, traits_FCQueue_single_mutex_multi_condvar>
        FCQueue_deque_wait_sm;
    typedef cds::container::FCQueue<Value, std::queue<Value>, traits_FCQueue_single_mutex_multi_condvar_stat>
        FCQueue_deque_wait_sm_stat;
    typedef cds::container::FCQueue<Value, std::queue<Value>, traits_FCQueue_multi_mutex_multi_condvar>
        FCQueue_deque_wait_mm;
    typedef cds::container::FCQueue<Value, std::queue<Value>, traits_FCQueue_multi_mutex_multi_condvar_stat>
        FCQueue_deque_wait_mm_stat;

    typedef cds::container::FCQueue<Value, std::queue<Value>, traits_FCQueue_elimination> FCQueue_deque_elimination;
    typedef cds::container::FCQueue<Value, std::queue<Value>, traits_FCQueue_elimination_stat>
        FCQueue_deque_elimination_stat;
    ...
    typedef cds::container::FCQueue<Value, std::queue<Value, std::list<Value>>,
                                    traits_FCQueue_single_mutex_single_condvar>
        FCQueue_list_wait_ss;
    typedef cds::container::FCQueue<Value, std::queue<Value, std::list<Value>>,
                                    traits_FCQueue_single_mutex_single_condvar_stat>
        FCQueue_list_wait_ss_stat;
    typedef cds::container::FCQueue<Value, std::queue<Value, std::list<Value>>,
                                    traits_FCQueue_single_mutex_multi_condvar>
        FCQueue_list_wait_sm;
    typedef cds::container::FCQueue<Value, std::queue<Value, std::list<Value>>,
                                    traits_FCQueue_single_mutex_multi_condvar_stat>
        FCQueue_list_wait_sm_stat;
    typedef cds::container::FCQueue<Value, std::queue<Value, std::list<Value>>,
                                    traits_FCQueue_multi_mutex_multi_condvar>
        FCQueue_list_wait_mm;
    typedef cds::container::FCQueue<Value, std::queue<Value, std::list<Value>>,
                                    traits_FCQueue_multi_mutex_multi_condvar_stat>
        FCQueue_list_wait_mm_stat;

    typedef cds::container::FCQueue<Value, std::queue<Value, std::list<Value>>, traits_FCQueue_elimination>
        FCQueue_list_elimination;
    typedef cds::container::FCQueue<Value, std::queue<Value, std::list<Value>>, traits_FCQueue_elimination_stat>
        FCQueue_list_elimination_stat;
    ...
    typedef details::FCDequeL<Value, fc_details::traits_FCDeque_stat, boost::container::deque<Value>>
        FCDequeL_boost_stat;
    typedef details::FCDequeL<Value, fc_details::traits_FCDeque_elimination, boost::container::deque<Value>>
        FCDequeL_boost_elimination;
    typedef details::FCDequeL<Value, fc_details::traits_FCDeque_elimination_stat, boost::container::deque<Value>>
        FCDequeL_boost_elimination_stat;
    ...
    typedef details::FCDequeR<Value, fc_details::traits_FCDeque_stat, boost::container::deque<Value>>
        FCDequeR_boost_stat;
    typedef details::FCDequeR<Value, fc_details::traits_FCDeque_elimination, boost::container::deque<Value>>
        FCDequeR_boost_elimination;
    typedef details::FCDequeR<Value, fc_details::traits_FCDeque_elimination_stat, boost::container::deque<Value>>
        FCDequeR_boost_elimination_stat;
    ...
    // SegmentedQueue
    class traits_SegmentedQueue_spin_stat : public cds::container::segmented_queue::make_traits<
                                                cds::opt::stat<cds::intrusive::segmented_queue::stat<>>>::type {};
    class traits_SegmentedQueue_spin_padding
        : public cds::container::segmented_queue::make_traits<cds::opt::padding<cds::opt::cache_line_padding>>::type {};
    class traits_SegmentedQueue_mutex_stat
        : public cds::container::segmented_queue::make_traits<cds::opt::stat<cds::intrusive::segmented_queue::stat<>>,
                                                              cds::opt::lock_type<std::mutex>>::type {};
    class traits_SegmentedQueue_mutex
        : public cds::container::segmented_queue::make_traits<cds::opt::lock_type<std::mutex>>::type {};
    class traits_SegmentedQueue_mutex_padding
        : public cds::container::segmented_queue::make_traits<cds::opt::lock_type<std::mutex>,
                                                              cds::opt::padding<cds::opt::cache_line_padding>>::type {};

    typedef cds::container::SegmentedQueue<cds::gc::HP, Value> SegmentedQueue_HP_spin;
    typedef cds::container::SegmentedQueue<cds::gc::HP, Value, traits_SegmentedQueue_spin_padding>
        SegmentedQueue_HP_spin_padding;
    typedef cds::container::SegmentedQueue<cds::gc::HP, Value, traits_SegmentedQueue_spin_stat>
        SegmentedQueue_HP_spin_stat;
    ...
    typedef cds::container::SegmentedQueue<cds::gc::HP, Value, traits_SegmentedQueue_mutex_padding>
        SegmentedQueue_HP_mutex_padding;
    typedef cds::container::SegmentedQueue<cds::gc::HP, Value, traits_SegmentedQueue_mutex_stat>
        SegmentedQueue_HP_mutex_stat;

    typedef cds::container::SegmentedQueue<cds::gc::DHP, Value> SegmentedQueue_DHP_spin;
    typedef cds::container::SegmentedQueue<cds::gc::DHP, Value, traits_SegmentedQueue_spin_padding>
        SegmentedQueue_DHP_spin_padding;
    typedef cds::container::SegmentedQueue<cds::gc::DHP, Value, traits_SegmentedQueue_spin_stat>
        SegmentedQueue_DHP_spin_stat;
    ...
    typedef cds::container::SegmentedQueue<cds::gc::DHP, Value, traits_SegmentedQueue_mutex_padding>
        SegmentedQueue_DHP_mutex_padding;
    typedef cds::container::SegmentedQueue<cds::gc::DHP, Value, traits_SegmentedQueue_mutex_stat>
        SegmentedQueue_DHP_mutex_stat;
};
...
struct TypesFCHeavyValue {
    ...
    typedef details::FCDequeL<Value, cds::container::fcdeque::traits, boost::container::deque<Value>>
        FCDequeL_HeavyValue_boost;
    typedef details::FCDequeL<Value, fc_details::traits_FCDeque_stat, boost::container::deque<Value>>
        FCDequeL_HeavyValue_boost_stat;
    typedef details::FCDequeL<Value, fc_details::traits_FCDeque_elimination, boost::container::deque<Value>>
        FCDequeL_HeavyValue_boost_elimination;
    typedef details::FCDequeL<Value, fc_details::traits_FCDeque_elimination_stat, boost::container::deque<Value>>
        FCDequeL_HeavyValue_boost_elimination_stat;
    ...
    typedef details::FCDequeR<Value, cds::container::fcdeque::traits, boost::container::deque<Value>>
        FCDequeR_HeavyValue_boost;
    typedef details::FCDequeR<Value, fc_details::traits_FCDeque_stat, boost::container::deque<Value>>
        FCDequeR_HeavyValue_boost_stat;
    typedef details::FCDequeR<Value, fc_details::traits_FCDeque_elimination, boost::container::deque<Value>>
        FCDequeR_HeavyValue_boost_elimination;
    typedef details::FCDequeR<Value, fc_details::traits_FCDeque_elimination_stat, boost::container::deque<Value>>
        FCDequeR_HeavyValue_boost_elimination_stat;
};
} // namespace queue
...
{
    return o << CDSSTRESS_STAT_OUT(s, m_nEnqueue) << CDSSTRESS_STAT_OUT(s, m_nEnqMove)
             << CDSSTRESS_STAT_OUT(s, m_nDequeue) << CDSSTRESS_STAT_OUT(s, m_nFailedDeq)
             << CDSSTRESS_STAT_OUT(s, m_nCollided) << static_cast<cds::algo::flat_combining::stat<> const &>(s);
}
...
{
    return o << CDSSTRESS_STAT_OUT(s, m_nPushFront) << CDSSTRESS_STAT_OUT(s, m_nPushFrontMove)
             << CDSSTRESS_STAT_OUT(s, m_nPushBack) << CDSSTRESS_STAT_OUT(s, m_nPushBackMove)
             << CDSSTRESS_STAT_OUT(s, m_nPopFront) << CDSSTRESS_STAT_OUT(s, m_nFailedPopFront)
             << CDSSTRESS_STAT_OUT(s, m_nPopBack) << CDSSTRESS_STAT_OUT(s, m_nFailedPopBack)
             << CDSSTRESS_STAT_OUT(s, m_nCollided) << static_cast<cds::algo::flat_combining::stat<> const &>(s);
}
...
#define CDSSTRESS_MSQueue_1(test_fixture)                                                             \
    CDSSTRESS_Queue_F(test_fixture, MSQueue_HP_seqcst) CDSSTRESS_Queue_F(test_fixture, MSQueue_HP_ic) \
        CDSSTRESS_Queue_F(test_fixture, MSQueue_DHP_seqcst) CDSSTRESS_Queue_F(test_fixture, MSQueue_DHP_ic)

#define CDSSTRESS_MoirQueue_1(test_fixture)                                                               \
    CDSSTRESS_Queue_F(test_fixture, MoirQueue_HP_seqcst) CDSSTRESS_Queue_F(test_fixture, MoirQueue_HP_ic) \
        CDSSTRESS_Queue_F(test_fixture, MoirQueue_DHP_seqcst) CDSSTRESS_Queue_F(test_fixture, MoirQueue_DHP_ic)

#define CDSSTRESS_OptimsticQueue_1(test_fixture)                                                                      \
    CDSSTRESS_Queue_F(test_fixture, OptimisticQueue_HP_seqcst) CDSSTRESS_Queue_F(test_fixture, OptimisticQueue_HP_ic) \
...
#define CDSSTRESS_BasketQueue_1(test_fixture)                                                                 \
    CDSSTRESS_Queue_F(test_fixture, BasketQueue_HP_seqcst) CDSSTRESS_Queue_F(test_fixture, BasketQueue_HP_ic) \
        CDSSTRESS_Queue_F(test_fixture, BasketQueue_DHP_seqcst) CDSSTRESS_Queue_F(test_fixture, BasketQueue_DHP_ic)

#define CDSSTRESS_FCQueue_1(test_fixture)                                                                         \
    CDSSTRESS_Queue_F(test_fixture, FCQueue_deque_wait_ss) CDSSTRESS_Queue_F(test_fixture, FCQueue_deque_wait_sm) \
...
#define CDSSTRESS_FCDeque_1(test_fixture)                                                                           \
    CDSSTRESS_Queue_F(test_fixture, FCDequeL_mutex) CDSSTRESS_Queue_F(test_fixture, FCDequeL_stat)                  \
        CDSSTRESS_Queue_F(test_fixture, FCDequeL_wait_ss) CDSSTRESS_Queue_F(test_fixture, FCDequeL_wait_sm)         \
            CDSSTRESS_Queue_F(test_fixture, FCDequeL_wait_mm) CDSSTRESS_Queue_F(test_fixture, FCDequeL_elimination) \
...
#define CDSSTRESS_FCDeque_HeavyValue_1(test_fixture)                                                                   \
    CDSSTRESS_FCQueue_F(test_fixture, FCDequeL_HeavyValue_wait_ss) CDSSTRESS_FCQueue_F(                                \
        test_fixture, FCDequeL_HeavyValue_wait_ss_stat) CDSSTRESS_FCQueue_F(test_fixture, FCDequeL_HeavyValue_wait_sm) \
        CDSSTRESS_FCQueue_F(test_fixture, FCDequeL_HeavyValue_wait_sm_stat) CDSSTRESS_FCQueue_F(                       \
            test_fixture, FCDequeL_HeavyValue_wait_mm) CDSSTRESS_FCQueue_F(test_fixture,                               \
                                                                           FCDequeL_HeavyValue_wait_mm_stat)           \
            CDSSTRESS_FCQueue_F(test_fixture, FCDequeL_HeavyValue_elimination) CDSSTRESS_FCQueue_F(                    \
                test_fixture, FCDequeL_HeavyValue_elimination_stat) CDSSTRESS_FCQueue_F(test_fixture,                  \
                                                                                        FCDequeL_HeavyValue_boost)     \
                CDSSTRESS_FCQueue_F(test_fixture, FCDequeL_HeavyValue_boost_stat) CDSSTRESS_FCQueue_F(                 \
                    test_fixture, FCDequeL_HeavyValue_boost_elimination)                                               \
                    CDSSTRESS_FCQueue_F(test_fixture, FCDequeL_HeavyValue_boost_elimination_stat) CDSSTRESS_FCQueue_F( \
                        test_fixture, FCDequeR_HeavyValue_default)                                                     \
                        CDSSTRESS_FCQueue_F(test_fixture, FCDequeR_HeavyValue_mutex) CDSSTRESS_FCQueue_F(              \
                            test_fixture, FCDequeR_HeavyValue_stat) CDSSTRESS_FCQueue_F(test_fixture,                  \
                                                                                        FCDequeR_HeavyValue_wait_ss)   \
                            CDSSTRESS_FCQueue_F(test_fixture, FCDequeR_HeavyValue_wait_ss_stat) CDSSTRESS_FCQueue_F(   \
                                test_fixture,                                                                          \
                                FCDequeR_HeavyValue_wait_sm) CDSSTRESS_FCQueue_F(test_fixture,                         \
                                                                                 FCDequeR_HeavyValue_wait_sm_stat)     \
                                CDSSTRESS_FCQueue_F(test_fixture, FCDequeR_HeavyValue_wait_mm) CDSSTRESS_FCQueue_F(    \
                                        ...
                                        CDSSTRESS_FCQueue_F(test_fixture, FCDequeR_HeavyValue_elimination_stat)        \
                                            CDSSTRESS_FCQueue_F(test_fixture, FCDequeR_HeavyValue_boost)               \
                                                CDSSTRESS_FCQueue_F(test_fixture, FCDequeR_HeavyValue_boost_stat)      \
                                                    CDSSTRESS_FCQueue_F(test_fixture,                                  \
                                                                        FCDequeR_HeavyValue_boost_elimination)         \
                                                        CDSSTRESS_FCQueue_F(                                           \
                                                            test_fixture, FCDequeR_HeavyValue_boost_elimination_stat)

#define CDSSTRESS_RWQueue_1(test_fixture) CDSSTRESS_Queue_F(test_fixture, RWQueue_Spin_ic)
...
#define CDSSTRESS_StdQueue_1(test_fixture) \
    CDSSTRESS_Queue_F(test_fixture, StdQueue_deque_Mutex) CDSSTRESS_Queue_F(test_fixture, StdQueue_list_Mutex)
...
#define CDSSTRESS_MSQueue(test_fixture)                                                                             \
    CDSSTRESS_Queue_F(test_fixture, MSQueue_HP) CDSSTRESS_Queue_F(test_fixture, MSQueue_HP_stat) CDSSTRESS_Queue_F( \
        test_fixture, MSQueue_DHP) CDSSTRESS_Queue_F(test_fixture, MSQueue_DHP_stat) CDSSTRESS_MSQueue_1(test_fixture)

#define CDSSTRESS_MoirQueue(test_fixture)                                                                  \
    CDSSTRESS_Queue_F(test_fixture, MoirQueue_HP) CDSSTRESS_Queue_F(test_fixture, MoirQueue_HP_stat)       \
        CDSSTRESS_Queue_F(test_fixture, MoirQueue_DHP) CDSSTRESS_Queue_F(test_fixture, MoirQueue_DHP_stat) \
            CDSSTRESS_MoirQueue_1(test_fixture)

#define CDSSTRESS_OptimsticQueue(test_fixture)                                                                         \
    CDSSTRESS_Queue_F(test_fixture, OptimisticQueue_HP) CDSSTRESS_Queue_F(test_fixture, OptimisticQueue_HP_stat)       \
        CDSSTRESS_Queue_F(test_fixture, OptimisticQueue_DHP) CDSSTRESS_Queue_F(test_fixture, OptimisticQueue_DHP_stat) \
            CDSSTRESS_OptimsticQueue_1(test_fixture)

#define CDSSTRESS_BasketQueue(test_fixture)                                                                    \
    CDSSTRESS_Queue_F(test_fixture, BasketQueue_HP) CDSSTRESS_Queue_F(test_fixture, BasketQueue_HP_stat)       \
        CDSSTRESS_Queue_F(test_fixture, BasketQueue_DHP) CDSSTRESS_Queue_F(test_fixture, BasketQueue_DHP_stat) \
            CDSSTRESS_BasketQueue_1(test_fixture)

#define CDSSTRESS_FCQueue(test_fixture)                                                                           \
    CDSSTRESS_Queue_F(test_fixture, FCQueue_deque) CDSSTRESS_Queue_F(test_fixture, FCQueue_deque_stat)            \
        CDSSTRESS_Queue_F(test_fixture, FCQueue_deque_wait_ss_stat) CDSSTRESS_Queue_F(                            \
            test_fixture, FCQueue_deque_wait_sm_stat) CDSSTRESS_Queue_F(test_fixture, FCQueue_deque_wait_mm_stat) \
            CDSSTRESS_Queue_F(test_fixture, FCQueue_deque_elimination_stat)                                       \
                CDSSTRESS_Queue_F(test_fixture, FCQueue_list) CDSSTRESS_Queue_F(test_fixture, FCQueue_list_stat)  \
...
#define CDSSTRESS_FCDeque(test_fixture)                                                                                \
    CDSSTRESS_Queue_F(test_fixture, FCDequeL_default) CDSSTRESS_Queue_F(test_fixture, FCDequeL_wait_ss_stat)           \
        CDSSTRESS_Queue_F(test_fixture, FCDequeL_wait_sm_stat) CDSSTRESS_Queue_F(test_fixture, FCDequeL_wait_mm_stat)  \
            CDSSTRESS_Queue_F(test_fixture, FCDequeL_elimination_stat)                                                 \
                CDSSTRESS_Queue_F(test_fixture, FCDequeL_boost_stat) CDSSTRESS_Queue_F(test_fixture, FCDequeR_default) \
                    CDSSTRESS_Queue_F(test_fixture, FCDequeR_mutex) CDSSTRESS_Queue_F(test_fixture, FCDequeR_stat)     \
...
#define CDSSTRESS_FCDeque_HeavyValue(test_fixture)                   \
    CDSSTRESS_FCQueue_F(test_fixture, FCDequeL_HeavyValue_default)   \
        CDSSTRESS_FCQueue_F(test_fixture, FCDequeL_HeavyValue_mutex) \
            CDSSTRESS_FCQueue_F(test_fixture, FCDequeL_HeavyValue_stat) CDSSTRESS_FCDeque_HeavyValue_1(test_fixture)

#define CDSSTRESS_RWQueue(test_fixture)                                                          \
    CDSSTRESS_Queue_F(test_fixture, RWQueue_Spin) CDSSTRESS_Queue_F(test_fixture, RWQueue_mutex) \
...
#define CDSSTRESS_WeakRingBuffer(test_fixture) CDSSTRESS_Queue_F(test_fixture, WeakRingBuffer_dyn)

#define CDSSTRESS_WeakRingBuffer_void(test_fixture) CDSSTRESS_Queue_F(test_fixture, WeakRingBuffer_void_dyn)

#define CDSSTRESS_StdQueue(test_fixture)                                                                             \
    CDSSTRESS_Queue_F(test_fixture, StdQueue_deque_Spinlock) CDSSTRESS_Queue_F(test_fixture, StdQueue_list_Spinlock) \
