...
{
    return o << CDSSTRESS_STAT_OUT(s, m_EnqueueCount) << CDSSTRESS_STAT_OUT(s, m_EnqueueRace)
             << CDSSTRESS_STAT_OUT(s, m_DequeueCount) << CDSSTRESS_STAT_OUT(s, m_EmptyDequeue)
             << CDSSTRESS_STAT_OUT(s, m_DequeueRace) << CDSSTRESS_STAT_OUT(s, m_AdvanceTailError)
             << CDSSTRESS_STAT_OUT(s, m_BadTail) << CDSSTRESS_STAT_OUT(s, m_TryAddBasket)
...
static inline property_stream &operator<<(property_stream &o, cds::intrusive::optimistic_queue::stat<Counter> const &s)
{
    return o << CDSSTRESS_STAT_OUT(s, m_EnqueueCount) << CDSSTRESS_STAT_OUT(s, m_EnqueueRace)
             << CDSSTRESS_STAT_OUT(s, m_DequeueCount) << CDSSTRESS_STAT_OUT(s, m_EmptyDequeue)
             << CDSSTRESS_STAT_OUT(s, m_DequeueRace) << CDSSTRESS_STAT_OUT(s, m_AdvanceTailError)
             << CDSSTRESS_STAT_OUT(s, m_BadTail) << CDSSTRESS_STAT_OUT(s, m_FixListCount);
}

static inline property_stream &operator<<(property_stream &o,
                                          cds::intrusive::optimistic_queue::empty_stat const & /*s*/)
{
    return o;
}
...
{
    return o << CDSSTRESS_STAT_OUT(s, m_nPush) << CDSSTRESS_STAT_OUT(s, m_nPushPopulated)
             << CDSSTRESS_STAT_OUT(s, m_nPushContended) << CDSSTRESS_STAT_OUT(s, m_nPop)
             << CDSSTRESS_STAT_OUT(s, m_nPopEmpty) << CDSSTRESS_STAT_OUT(s, m_nPopContended)
             << CDSSTRESS_STAT_OUT(s, m_nCreateSegmentReq) << CDSSTRESS_STAT_OUT(s, m_nDeleteSegmentReq)
             << CDSSTRESS_STAT_OUT(s, m_nSegmentCreated) << CDSSTRESS_STAT_OUT(s, m_nSegmentDeleted);
}
