...
class spsc_queue : public cds_test::stress_fixture {
  ...
  protected:
    ...
    void test_queue(Queue &q)
    {
        ...
        propout() << std::make_pair("queue_size", s_nQueueSize) << std::make_pair("pass_count", s_nPassCount);
        ...
        propout() << std::make_pair("producer_push_count", s_nQueueSize * s_nPassCount)
  ...
  public:
    static void SetUpTestCase()
    {
        ...
        if (s_nPassCount == 0u) s_nPassCount = 1024;
    }
};
...
CDSSTRESS_WeakRingBuffer(spsc_queue) CDSSTRESS_VyukovQueue(spsc_queue) CDSSTRESS_VyukovSingleConsumerQueue(spsc_queue)
