...
struct Types {
    ...
    struct traits_OptimisticQueue_HP_seqcst
        : public cds::intrusive::optimistic_queue::make_traits<
    ...
    struct traits_OptimisticQueue_DHP_seqcst
        : public cds::intrusive::optimistic_queue::make_traits<
              cds::intrusive::opt::hook<cds::intrusive::optimistic_queue::base_hook<cds::opt::gc<cds::gc::DHP>>>,
              cds::opt::memory_model<cds::opt::v::sequential_consistent>>::type {};
    typedef cds::intrusive::OptimisticQueue<cds::gc::DHP, T, traits_OptimisticQueue_DHP_seqcst>
        OptimisticQueue_DHP_seqcst;

    // OptimisticQueue + item counter
    struct traits_OptimisticQueue_HP_ic
        : public cds::intrusive::optimistic_queue::make_traits<
              cds::intrusive::opt::hook<cds::intrusive::optimistic_queue::base_hook<cds::opt::gc<cds::gc::HP>>>,
    ...
    struct traits_OptimisticQueue_DHP_ic
        : public cds::intrusive::optimistic_queue::make_traits<
              cds::intrusive::opt::hook<cds::intrusive::optimistic_queue::base_hook<cds::opt::gc<cds::gc::DHP>>>,
              cds::opt::item_counter<cds::atomicity::item_counter>>::type {};
    ...
    struct traits_OptimisticQueue_HP_stat
        : public cds::intrusive::optimistic_queue::make_traits<
              cds::intrusive::opt::hook<cds::intrusive::optimistic_queue::base_hook<cds::opt::gc<cds::gc::HP>>>,
    ...
    struct traits_OptimisticQueue_DHP_stat
        : public cds::intrusive::optimistic_queue::make_traits<
              cds::intrusive::opt::hook<cds::intrusive::optimistic_queue::base_hook<cds::opt::gc<cds::gc::DHP>>>,
              cds::opt::stat<cds::intrusive::optimistic_queue::stat<>>>::type {};
    ...
    class VyukovMPMCCycleQueue_dyn : public cds::intrusive::VyukovMPMCCycleQueue<T, traits_VyukovMPMCCycleQueue_dyn> {
    ...
    // BasketQueue
    struct traits_BasketQueue_HP
        : public cds::intrusive::basket_queue::make_traits<
              cds::intrusive::opt::hook<cds::intrusive::basket_queue::base_hook<cds::opt::gc<cds::gc::HP>>>>::type {};
    typedef cds::intrusive::BasketQueue<cds::gc::HP, T, traits_BasketQueue_HP> BasketQueue_HP;

    struct traits_BasketQueue_HP_seqcst
        : public cds::intrusive::basket_queue::make_traits<
    ...
    struct traits_BasketQueue_DHP
        : public cds::intrusive::basket_queue::make_traits<
              cds::intrusive::opt::hook<cds::intrusive::basket_queue::base_hook<cds::opt::gc<cds::gc::DHP>>>>::type {};
    typedef cds::intrusive::BasketQueue<cds::gc::DHP, T, traits_BasketQueue_DHP> BasketQueue_DHP;

    struct traits_BasketQueue_DHP_seqcst
        : public cds::intrusive::basket_queue::make_traits<
    ...
    // BasketQueue + stat
    struct traits_BasketQueue_HP_stat
        : public cds::intrusive::basket_queue::make_traits<
              cds::intrusive::opt::hook<cds::intrusive::basket_queue::base_hook<cds::opt::gc<cds::gc::HP>>>,
              cds::opt::stat<cds::intrusive::basket_queue::stat<>>>::type {};
    ...
    class traits_FCQueue_delay2
        : public cds::intrusive::fcqueue::make_traits<cds::opt::wait_strategy<
              cds::algo::flat_combining::wait_strategy::backoff<cds::backoff::delay_of<2>>>>::type {};
    ...
    class traits_FCQueue_delay2_elimination_stat
        : public cds::intrusive::fcqueue::make_traits<
              cds::opt::wait_strategy<cds::algo::flat_combining::wait_strategy::backoff<cds::backoff::delay_of<2>>>,
              cds::opt::stat<cds::intrusive::fcqueue::stat<>>, cds::opt::enable_elimination<true>>::type {};
    class traits_FCQueue_expbackoff_elimination
        : public cds::intrusive::fcqueue::make_traits<cds::opt::enable_elimination<true>,
                                                      cds::opt::elimination_backoff<cds::backoff::Default>>::type {};
    ...
    typedef cds::intrusive::FCQueue<T, boost::intrusive::list<T>, traits_FCQueue_delay2_elimination>
        FCQueue_list_delay2_elimination;
    typedef cds::intrusive::FCQueue<T, boost::intrusive::list<T>, traits_FCQueue_delay2_elimination_stat>
        FCQueue_list_delay2_elimination_stat;
    typedef cds::intrusive::FCQueue<T, boost::intrusive::list<T>, traits_FCQueue_expbackoff_elimination>
        FCQueue_list_expbackoff_elimination;
    typedef cds::intrusive::FCQueue<T, boost::intrusive::list<T>, traits_FCQueue_expbackoff_elimination_stat>
        FCQueue_list_expbackoff_elimination_stat;
    typedef cds::intrusive::FCQueue<T, boost::intrusive::list<T>, traits_FCQueue_wait_ss> FCQueue_list_wait_ss;
    typedef cds::intrusive::FCQueue<T, boost::intrusive::list<T>, traits_FCQueue_wait_ss_stat>
    ...
    typedef cds::intrusive::FCQueue<T, boost::intrusive::list<T>, traits_FCQueue_wait_sm_stat>
    ...
    typedef cds::intrusive::FCQueue<T, boost::intrusive::list<T>, traits_FCQueue_wait_mm_stat>
        FCQueue_list_wait_mm_stat;

    // SegmentedQueue
    class traits_SegmentedQueue_spin_stat : public cds::intrusive::segmented_queue::make_traits<
                                                cds::opt::stat<cds::intrusive::segmented_queue::stat<>>>::type {};
    class traits_SegmentedQueue_spin_padding
        : public cds::intrusive::segmented_queue::make_traits<cds::opt::padding<cds::opt::cache_line_padding>>::type {};
    class traits_SegmentedQueue_mutex_stat
        : public cds::intrusive::segmented_queue::make_traits<cds::opt::stat<cds::intrusive::segmented_queue::stat<>>,
                                                              cds::opt::lock_type<std::mutex>>::type {};
    class traits_SegmentedQueue_mutex
        : public cds::intrusive::segmented_queue::make_traits<cds::opt::lock_type<std::mutex>>::type {};
    class traits_SegmentedQueue_mutex_padding
        : public cds::intrusive::segmented_queue::make_traits<cds::opt::lock_type<std::mutex>,
                                                              cds::opt::padding<cds::opt::cache_line_padding>>::type {};

    typedef cds::intrusive::SegmentedQueue<cds::gc::HP, T> SegmentedQueue_HP_spin;
    typedef cds::intrusive::SegmentedQueue<cds::gc::HP, T, traits_SegmentedQueue_spin_padding>
    ...
    typedef cds::intrusive::SegmentedQueue<cds::gc::HP, T, traits_SegmentedQueue_mutex_padding>
        SegmentedQueue_HP_mutex_padding;
    typedef cds::intrusive::SegmentedQueue<cds::gc::HP, T, traits_SegmentedQueue_mutex_stat>
        SegmentedQueue_HP_mutex_stat;

    typedef cds::intrusive::SegmentedQueue<cds::gc::DHP, T> SegmentedQueue_DHP_spin;
    typedef cds::intrusive::SegmentedQueue<cds::gc::DHP, T, traits_SegmentedQueue_spin_padding>
        SegmentedQueue_DHP_spin_padding;
    typedef cds::intrusive::SegmentedQueue<cds::gc::DHP, T, traits_SegmentedQueue_spin_stat>
    ...
    typedef cds::intrusive::SegmentedQueue<cds::gc::DHP, T, traits_SegmentedQueue_mutex_padding>
        SegmentedQueue_DHP_mutex_padding;
    typedef cds::intrusive::SegmentedQueue<cds::gc::DHP, T, traits_SegmentedQueue_mutex_stat>
...
{
    return o << CDSSTRESS_STAT_OUT(s, m_nEnqueue) << CDSSTRESS_STAT_OUT(s, m_nDequeue)
             << CDSSTRESS_STAT_OUT(s, m_nFailedDeq) << CDSSTRESS_STAT_OUT(s, m_nCollided)
