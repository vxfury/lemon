...
class pqueue_push_pop : public cds_test::stress_fixture {
  ...
  public:
    enum { producer_thread, consumer_thread };
    ...
    class Producer : public cds_test::thread {
      ...
      public:
        Producer(cds_test::thread_pool &pool, PQueue &queue) : base_class(pool, producer_thread), m_Queue(queue) {}

        Producer(Producer &src) : base_class(src), m_Queue(src.m_Queue) {}
        ...
        virtual void test()
        {
            ...
            for (auto it = m_arr.begin(); it != m_arr.end(); ++it) {
                if (!m_Queue.push(value_type(*it))) ++m_nPushError;
            }
        ...
        void prepare(size_t nStart, size_t nEnd)
        {
            ...
            for (size_t i = nStart; i < nEnd; ++i) m_arr.push_back(i);
    ...
    class Consumer : public cds_test::thread {
      ...
      public:
        Consumer(cds_test::thread_pool &pool, PQueue &queue) : base_class(pool, consumer_thread), m_Queue(queue) {}

        Consumer(Consumer &src) : base_class(src), m_Queue(src.m_Queue) {}
  ...
  protected:
    ...
    void test(PQueue &q)
    {
        ...
        propout() << std::make_pair("producer_count", s_nPushThreadCount)
                  << std::make_pair("consunmer_count", s_nPopThreadCount) << std::make_pair("queue_size", s_nQueueSize);
        ...
        propout() << std::make_pair("total_popped", nTotalPopped) << std::make_pair("empty_pop", nPopFailed)
  ...
  public:
    static void SetUpTestCase()
    {
        ...
        if (s_nPushThreadCount == 0u) s_nPushThreadCount = 1;
        if (s_nPopThreadCount == 0u) s_nPopThreadCount = 1;
        if (s_nQueueSize == 0u) s_nQueueSize = 1000;
    }
...
CDSSTRESS_MSPriorityQueue(pqueue_push_pop, MSPriorityQueue_dyn_less) CDSSTRESS_MSPriorityQueue(
    pqueue_push_pop, MSPriorityQueue_dyn_less_stat) CDSSTRESS_MSPriorityQueue(pqueue_push_pop, MSPriorityQueue_dyn_cmp)
...
#define CDSSTRESS_PriorityQueue(fixture_t, pqueue_t)                       \
    ...
    CDSSTRESS_PriorityQueue(pqueue_push_pop, FCPQueue_vector)
        CDSSTRESS_PriorityQueue(pqueue_push_pop, FCPQueue_vector_stat)
            CDSSTRESS_PriorityQueue(pqueue_push_pop, FCPQueue_deque) CDSSTRESS_PriorityQueue(pqueue_push_pop,
                                                                                             FCPQueue_deque_stat)
                                                ...
                                                CDSSTRESS_PriorityQueue(pqueue_push_pop, EllenBinTree_DHP_max)
                                                    CDSSTRESS_PriorityQueue(pqueue_push_pop, EllenBinTree_DHP_max_stat)
                                                        CDSSTRESS_PriorityQueue(pqueue_push_pop, EllenBinTree_DHP_min)
                                                            CDSSTRESS_PriorityQueue(pqueue_push_pop,
    ...
    CDSSTRESS_PriorityQueue(pqueue_push_pop, EllenBinTree_RCU_gpb_max) CDSSTRESS_PriorityQueue(
        pqueue_push_pop, EllenBinTree_RCU_gpb_max_stat) CDSSTRESS_PriorityQueue(pqueue_push_pop,
                                                                                EllenBinTree_RCU_gpb_min)
        CDSSTRESS_PriorityQueue(pqueue_push_pop, EllenBinTree_RCU_gpb_min_stat) CDSSTRESS_PriorityQueue(
            pqueue_push_pop, EllenBinTree_RCU_gpt_max) CDSSTRESS_PriorityQueue(pqueue_push_pop,
                                                                               EllenBinTree_RCU_gpt_max_stat)
            CDSSTRESS_PriorityQueue(pqueue_push_pop,
                                    EllenBinTree_RCU_gpt_min) CDSSTRESS_PriorityQueue(pqueue_push_pop,
                                                                                      EllenBinTree_RCU_gpt_min_stat)
#ifdef CDS_URCU_SIGNAL_HANDLING_ENABLED
                CDSSTRESS_PriorityQueue(pqueue_push_pop, EllenBinTree_RCU_shb_max) CDSSTRESS_PriorityQueue(
                    pqueue_push_pop,
                    EllenBinTree_RCU_shb_max_stat) CDSSTRESS_PriorityQueue(pqueue_push_pop,
                                                                           EllenBinTree_RCU_shb_min) CDSSTRESS_PriorityQueue(pqueue_push_pop,
                                                                                                                             EllenBinTree_RCU_shb_min_stat)
#endif

                    CDSSTRESS_PriorityQueue(pqueue_push_pop, SkipList32_HP_max) CDSSTRESS_PriorityQueue(
                        pqueue_push_pop, SkipList24_HP_max) CDSSTRESS_PriorityQueue(pqueue_push_pop, SkipList16_HP_max)
                        CDSSTRESS_PriorityQueue(pqueue_push_pop, SkipList32_HP_max_stat) CDSSTRESS_PriorityQueue(
                            pqueue_push_pop, SkipList24_HP_max_stat) CDSSTRESS_PriorityQueue(pqueue_push_pop,
                                                                                             SkipList16_HP_max_stat)
                            CDSSTRESS_PriorityQueue(pqueue_push_pop, SkipList32_HP_min) CDSSTRESS_PriorityQueue(
                                pqueue_push_pop, SkipList24_HP_min) CDSSTRESS_PriorityQueue(pqueue_push_pop,
                                                                                            SkipList16_HP_min)
                                CDSSTRESS_PriorityQueue(pqueue_push_pop, SkipList32_HP_min_stat) CDSSTRESS_PriorityQueue(
                                    pqueue_push_pop,
                                    SkipList24_HP_min_stat) CDSSTRESS_PriorityQueue(pqueue_push_pop,
                                                                                    SkipList16_HP_min_stat)
                                    CDSSTRESS_PriorityQueue(pqueue_push_pop, SkipList32_DHP_max) CDSSTRESS_PriorityQueue(
                                        pqueue_push_pop, SkipList24_DHP_max) CDSSTRESS_PriorityQueue(pqueue_push_pop,
                                                                                                     SkipList16_DHP_max)
                                        CDSSTRESS_PriorityQueue(pqueue_push_pop, SkipList32_DHP_max_stat) CDSSTRESS_PriorityQueue(
                                            pqueue_push_pop,
                                            SkipList24_DHP_max_stat) CDSSTRESS_PriorityQueue(pqueue_push_pop,
                                                                                             SkipList16_DHP_max_stat)
                                            CDSSTRESS_PriorityQueue(pqueue_push_pop, SkipList32_DHP_min) CDSSTRESS_PriorityQueue(
                                                pqueue_push_pop,
                                                SkipList24_DHP_min) CDSSTRESS_PriorityQueue(pqueue_push_pop,
                                                                                            SkipList16_DHP_min)
                                                CDSSTRESS_PriorityQueue(pqueue_push_pop, SkipList32_DHP_min_stat) CDSSTRESS_PriorityQueue(
                                                    pqueue_push_pop,
                                                    SkipList24_DHP_min_stat) CDSSTRESS_PriorityQueue(pqueue_push_pop,
                                                                                                     SkipList16_DHP_min_stat)
                                                    CDSSTRESS_PriorityQueue(
                                                        pqueue_push_pop,
                                                        SkipList32_RCU_gpi_max) CDSSTRESS_PriorityQueue(pqueue_push_pop,
                                                                                                        SkipList32_RCU_gpi_min)
                                                        CDSSTRESS_PriorityQueue(
                                                            pqueue_push_pop,
                                                            SkipList32_RCU_gpb_max) CDSSTRESS_PriorityQueue(pqueue_push_pop,
                                                                                                            SkipList24_RCU_gpb_max)
                                                            CDSSTRESS_PriorityQueue(pqueue_push_pop,
                                                                                    SkipList16_RCU_gpb_max)
                                                                CDSSTRESS_PriorityQueue(pqueue_push_pop,
                                                                                        SkipList32_RCU_gpb_min)
                                                                    CDSSTRESS_PriorityQueue(pqueue_push_pop,
                                                                                            SkipList24_RCU_gpb_min)
                                                                        CDSSTRESS_PriorityQueue(pqueue_push_pop,
                                                                                                SkipList16_RCU_gpb_min)
                                                                            CDSSTRESS_PriorityQueue(
                                                                                pqueue_push_pop, SkipList32_RCU_gpt_max)
                                                                                CDSSTRESS_PriorityQueue(
                                                                                    pqueue_push_pop,
                                                                                    SkipList32_RCU_gpt_min)
#ifdef CDS_URCU_SIGNAL_HANDLING_ENABLED
                                                                                    CDSSTRESS_PriorityQueue(
                                                                                        pqueue_push_pop,
                                                                                        SkipList32_RCU_shb_max)
                                                                                        CDSSTRESS_PriorityQueue(
                                                                                            pqueue_push_pop,
                                                                                            SkipList32_RCU_shb_min)
#endif

                                                                                            CDSSTRESS_PriorityQueue(
                                                                                                pqueue_push_pop,
                                                                                                StdPQueue_vector_spin)
                                                                                                CDSSTRESS_PriorityQueue(
                                                                                                    pqueue_push_pop,
                                                                                                    StdPQueue_vector_mutex)
                                                                                                    CDSSTRESS_PriorityQueue(
                                                                                                        pqueue_push_pop,
                                                                                                        StdPQueue_deque_spin)
                                                                                                        CDSSTRESS_PriorityQueue(
                                                                                                            pqueue_push_pop,
                                                                                                            StdPQueue_deque_mutex)
