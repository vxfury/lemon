...
class pqueue_push : public cds_test::stress_fixture {
  ...
  protected:
    ...
    class Producer : public cds_test::thread {
      ...
      public:
        Producer(cds_test::thread_pool &pool, PQueue &queue) : base_class(pool), m_Queue(queue) {}
...
CDSSTRESS_MSPriorityQueue(pqueue_push, MSPriorityQueue_dyn_less) CDSSTRESS_MSPriorityQueue(
    pqueue_push, MSPriorityQueue_dyn_less_stat) CDSSTRESS_MSPriorityQueue(pqueue_push, MSPriorityQueue_dyn_cmp)
...
#define CDSSTRESS_PriorityQueue(fixture_t, pqueue_t)                       \
    ...
    CDSSTRESS_PriorityQueue(pqueue_push, FCPQueue_vector) CDSSTRESS_PriorityQueue(pqueue_push, FCPQueue_vector_stat)
        CDSSTRESS_PriorityQueue(pqueue_push, FCPQueue_deque) CDSSTRESS_PriorityQueue(pqueue_push, FCPQueue_deque_stat)
    ...
    CDSSTRESS_PriorityQueue(pqueue_push, EllenBinTree_RCU_gpb_max) CDSSTRESS_PriorityQueue(
        pqueue_push, EllenBinTree_RCU_gpb_max_stat) CDSSTRESS_PriorityQueue(pqueue_push, EllenBinTree_RCU_gpb_min)
        CDSSTRESS_PriorityQueue(pqueue_push, EllenBinTree_RCU_gpb_min_stat) CDSSTRESS_PriorityQueue(
            pqueue_push, EllenBinTree_RCU_gpt_max) CDSSTRESS_PriorityQueue(pqueue_push, EllenBinTree_RCU_gpt_max_stat)
            CDSSTRESS_PriorityQueue(pqueue_push,
                                    EllenBinTree_RCU_gpt_min) CDSSTRESS_PriorityQueue(pqueue_push,
                                                                                      EllenBinTree_RCU_gpt_min_stat)
#ifdef CDS_URCU_SIGNAL_HANDLING_ENABLED
                CDSSTRESS_PriorityQueue(pqueue_push, EllenBinTree_RCU_shb_max)
                    CDSSTRESS_PriorityQueue(pqueue_push, EllenBinTree_RCU_shb_max_stat) CDSSTRESS_PriorityQueue(
                        pqueue_push, EllenBinTree_RCU_shb_min) CDSSTRESS_PriorityQueue(pqueue_push,
                                                                                       EllenBinTree_RCU_shb_min_stat)
#endif

                        CDSSTRESS_PriorityQueue(pqueue_push, SkipList32_HP_max) CDSSTRESS_PriorityQueue(
                            pqueue_push, SkipList32_HP_max_stat) CDSSTRESS_PriorityQueue(pqueue_push, SkipList32_HP_min)
                            CDSSTRESS_PriorityQueue(pqueue_push, SkipList32_HP_min_stat) CDSSTRESS_PriorityQueue(
                                pqueue_push, SkipList32_DHP_max) CDSSTRESS_PriorityQueue(pqueue_push,
                                                                                         SkipList32_DHP_max_stat)
                                CDSSTRESS_PriorityQueue(pqueue_push, SkipList32_DHP_min) CDSSTRESS_PriorityQueue(
                                    pqueue_push,
                                    SkipList32_DHP_min_stat) CDSSTRESS_PriorityQueue(pqueue_push,
                                                                    ...
                                                                    CDSSTRESS_PriorityQueue(pqueue_push,
                                                                        ...
                                                                        CDSSTRESS_PriorityQueue(pqueue_push,
                                                                            ...
                                                                            CDSSTRESS_PriorityQueue(
                                                                                pqueue_push, StdPQueue_deque_mutex)
