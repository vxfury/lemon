...
struct set_type<tag_EllenBinTreeSet, Key, Val> : public set_type_base<Key, Val> {
    ...
    typedef EllenBinTreeSet<cds::gc::DHP, key_type, key_val, traits_EllenBinTreeSet_yield_dhp>
        EllenBinTreeSet_yield_dhp;
    ...
    struct traits_EllenBinTreeSet_stat
...
static inline void check_stat(cds::intrusive::ellen_bintree::empty_stat const & /*s*/)
{
    ...
    /*
    EXPECT_EQ( ellen_bintree_pool::internal_node_counter::m_nAlloc.get(),
    ellen_bintree_pool::internal_node_counter::m_nFree.get());
    */
}
