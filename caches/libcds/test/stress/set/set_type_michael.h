...
class MichaelHashSet : public cc::MichaelHashSet<GC, List, Traits> {
  ...
  public:
    ...
    MichaelHashSet(Config const &cfg) : base_class(cfg.s_nSetSize, cfg.s_nLoadFactor)
    {
    }
...
struct set_type<tag_MichaelHashSet, Key, Val> : public set_type_base<Key, Val> {
    ...
    struct traits_MichaelSet
        : public cc::michael_set::make_traits<co::hash<hash>,
    ...
    typedef MichaelHashSet<cds::gc::DHP, typename ml::MichaelList_DHP_cmp_stat, traits_MichaelSet>
        MichaelSet_DHP_cmp_stat;
    typedef MichaelHashSet<rcu_gpi, typename ml::MichaelList_RCU_GPI_cmp_stat, traits_MichaelSet>
        MichaelSet_RCU_GPI_cmp_stat;
    typedef MichaelHashSet<rcu_gpb, typename ml::MichaelList_RCU_GPB_cmp_stat, traits_MichaelSet>
        MichaelSet_RCU_GPB_cmp_stat;
    typedef MichaelHashSet<rcu_gpt, typename ml::MichaelList_RCU_GPT_cmp_stat, traits_MichaelSet>
        MichaelSet_RCU_GPT_cmp_stat;
#ifdef CDS_URCU_SIGNAL_HANDLING_ENABLED
    typedef MichaelHashSet<rcu_shb, typename ml::MichaelList_RCU_SHB_cmp_stat, traits_MichaelSet>
        MichaelSet_RCU_SHB_cmp_stat;
#endif
    ...
    typedef MichaelHashSet<cds::gc::HP, typename ml::MichaelList_HP_less_stat, traits_MichaelSet>
        MichaelSet_HP_less_stat;
    typedef MichaelHashSet<cds::gc::DHP, typename ml::MichaelList_DHP_less_stat, traits_MichaelSet>
        MichaelSet_DHP_less_stat;
    typedef MichaelHashSet<rcu_gpi, typename ml::MichaelList_RCU_GPI_less_stat, traits_MichaelSet>
        MichaelSet_RCU_GPI_less_stat;
    typedef MichaelHashSet<rcu_gpb, typename ml::MichaelList_RCU_GPB_less_stat, traits_MichaelSet>
        MichaelSet_RCU_GPB_less_stat;
    typedef MichaelHashSet<rcu_gpt, typename ml::MichaelList_RCU_GPT_less_stat, traits_MichaelSet>
        MichaelSet_RCU_GPT_less_stat;
#ifdef CDS_URCU_SIGNAL_HANDLING_ENABLED
    typedef MichaelHashSet<rcu_shb, typename ml::MichaelList_RCU_SHB_less_stat, traits_MichaelSet>
        MichaelSet_RCU_SHB_less_stat;
#endif

    typedef MichaelHashSet<cds::gc::HP, typename ml::MichaelList_HP_less_seqcst, traits_MichaelSet>
        MichaelSet_HP_less_seqcst;
    typedef MichaelHashSet<cds::gc::DHP, typename ml::MichaelList_DHP_less_seqcst, traits_MichaelSet>
        MichaelSet_DHP_less_seqcst;
    typedef MichaelHashSet<rcu_gpi, typename ml::MichaelList_RCU_GPI_less_seqcst, traits_MichaelSet>
        MichaelSet_RCU_GPI_less_seqcst;
    typedef MichaelHashSet<rcu_gpb, typename ml::MichaelList_RCU_GPB_less_seqcst, traits_MichaelSet>
        MichaelSet_RCU_GPB_less_seqcst;
    typedef MichaelHashSet<rcu_gpt, typename ml::MichaelList_RCU_GPT_less_seqcst, traits_MichaelSet>
        MichaelSet_RCU_GPT_less_seqcst;
#ifdef CDS_URCU_SIGNAL_HANDLING_ENABLED
    typedef MichaelHashSet<rcu_shb, typename ml::MichaelList_RCU_SHB_less_seqcst, traits_MichaelSet>
        MichaelSet_RCU_SHB_less_seqcst;
#endif
    ...
    typedef MichaelHashSet<cds::gc::HP, typename ll::LazyList_HP_cmp_stat, traits_MichaelSet>
        MichaelSet_Lazy_HP_cmp_stat;
    typedef MichaelHashSet<cds::gc::DHP, typename ll::LazyList_DHP_cmp_stat, traits_MichaelSet>
        MichaelSet_Lazy_DHP_cmp_stat;
    typedef MichaelHashSet<rcu_gpi, typename ll::LazyList_RCU_GPI_cmp_stat, traits_MichaelSet>
        MichaelSet_Lazy_RCU_GPI_cmp_stat;
    typedef MichaelHashSet<rcu_gpb, typename ll::LazyList_RCU_GPB_cmp_stat, traits_MichaelSet>
        MichaelSet_Lazy_RCU_GPB_cmp_stat;
    typedef MichaelHashSet<rcu_gpt, typename ll::LazyList_RCU_GPT_cmp_stat, traits_MichaelSet>
        MichaelSet_Lazy_RCU_GPT_cmp_stat;
#ifdef CDS_URCU_SIGNAL_HANDLING_ENABLED
    typedef MichaelHashSet<rcu_shb, typename ll::LazyList_RCU_SHB_cmp_stat, traits_MichaelSet>
        MichaelSet_Lazy_RCU_SHB_cmp_stat;
#endif
    ...
    typedef MichaelHashSet<cds::gc::HP, typename ll::LazyList_HP_less_stat, traits_MichaelSet>
        MichaelSet_Lazy_HP_less_stat;
    typedef MichaelHashSet<cds::gc::DHP, typename ll::LazyList_DHP_less_stat, traits_MichaelSet>
        MichaelSet_Lazy_DHP_less_stat;
    typedef MichaelHashSet<rcu_gpi, typename ll::LazyList_RCU_GPI_less_stat, traits_MichaelSet>
        MichaelSet_Lazy_RCU_GPI_less_stat;
    typedef MichaelHashSet<rcu_gpb, typename ll::LazyList_RCU_GPB_less_stat, traits_MichaelSet>
        MichaelSet_Lazy_RCU_GPB_less_stat;
    typedef MichaelHashSet<rcu_gpt, typename ll::LazyList_RCU_GPT_less_stat, traits_MichaelSet>
        MichaelSet_Lazy_RCU_GPT_less_stat;
#ifdef CDS_URCU_SIGNAL_HANDLING_ENABLED
    typedef MichaelHashSet<rcu_shb, typename ll::LazyList_RCU_SHB_less_stat, traits_MichaelSet>
        MichaelSet_Lazy_RCU_SHB_less_stat;
#endif

    typedef MichaelHashSet<cds::gc::HP, typename ll::LazyList_HP_less_seqcst, traits_MichaelSet>
        MichaelSet_Lazy_HP_less_seqcst;
    typedef MichaelHashSet<cds::gc::DHP, typename ll::LazyList_DHP_less_seqcst, traits_MichaelSet>
        MichaelSet_Lazy_DHP_less_seqcst;
    typedef MichaelHashSet<rcu_gpi, typename ll::LazyList_RCU_GPI_less_seqcst, traits_MichaelSet>
        MichaelSet_Lazy_RCU_GPI_less_seqcst;
    typedef MichaelHashSet<rcu_gpb, typename ll::LazyList_RCU_GPB_less_seqcst, traits_MichaelSet>
        MichaelSet_Lazy_RCU_GPB_less_seqcst;
    typedef MichaelHashSet<rcu_gpt, typename ll::LazyList_RCU_GPT_less_seqcst, traits_MichaelSet>
        MichaelSet_Lazy_RCU_GPT_less_seqcst;
#ifdef CDS_URCU_SIGNAL_HANDLING_ENABLED
    typedef MichaelHashSet<rcu_shb, typename ll::LazyList_RCU_SHB_less_seqcst, traits_MichaelSet>
        MichaelSet_Lazy_RCU_SHB_less_seqcst;
#endif
    ...
    typedef MichaelHashSet<cds::gc::DHP, typename il::IterableList_DHP_cmp, traits_MichaelSet>
        MichaelSet_Iterable_DHP_cmp;

    typedef MichaelHashSet<cds::gc::HP, typename il::IterableList_HP_cmp_stat, traits_MichaelSet>
        MichaelSet_Iterable_HP_cmp_stat;
    typedef MichaelHashSet<cds::gc::DHP, typename il::IterableList_DHP_cmp_stat, traits_MichaelSet>
        MichaelSet_Iterable_DHP_cmp_stat;

    typedef MichaelHashSet<cds::gc::HP, typename il::IterableList_HP_less, traits_MichaelSet>
        MichaelSet_Iterable_HP_less;
    typedef MichaelHashSet<cds::gc::DHP, typename il::IterableList_DHP_less, traits_MichaelSet>
        MichaelSet_Iterable_DHP_less;

    typedef MichaelHashSet<cds::gc::HP, typename il::IterableList_HP_less_stat, traits_MichaelSet>
        MichaelSet_Iterable_HP_less_stat;
    typedef MichaelHashSet<cds::gc::DHP, typename il::IterableList_DHP_less_stat, traits_MichaelSet>
        MichaelSet_Iterable_DHP_less_stat;

    typedef MichaelHashSet<cds::gc::HP, typename il::IterableList_HP_less_seqcst, traits_MichaelSet>
        MichaelSet_Iterable_HP_less_seqcst;
    typedef MichaelHashSet<cds::gc::DHP, typename il::IterableList_DHP_less_seqcst, traits_MichaelSet>
        MichaelSet_Iterable_DHP_less_seqcst;
};
            ...
            CDSSTRESS_MichaelSet_case(fixture, test_case, MichaelSet_RCU_SHB_less, key_type, value_type)             \
                CDSSTRESS_MichaelSet_case(fixture, test_case, MichaelSet_RCU_SHT_less_stat, key_type, value_type)    \
                    CDSSTRESS_MichaelSet_case(fixture, test_case, MichaelSet_Lazy_RCU_SHT_cmp, key_type, value_type) \
                        CDSSTRESS_MichaelSet_case(fixture, test_case, MichaelSet_Lazy_RCU_SHB_cmp_stat, key_type,    \
                                                  value_type)                                                        \
                            CDSSTRESS_MichaelSet_case(fixture, test_case, MichaelSet_Lazy_RCU_SHB_less, key_type,    \
                                                      value_type)                                                    \
                                CDSSTRESS_MichaelSet_case(fixture, test_case, MichaelSet_Lazy_RCU_SHT_less_stat,     \
                                                          key_type, value_type)
    ...
    CDSSTRESS_MichaelSet_case(fixture, test_case, MichaelSet_Iterable_RCU_SHT_cmp, key_type, value_type)          \
        CDSSTRESS_MichaelSet_case(fixture, test_case, MichaelSet_Iterable_RCU_SHB_cmp_stat, key_type, value_type) \
            CDSSTRESS_MichaelSet_case(fixture, test_case, MichaelSet_Iterable_RCU_SHB_less, key_type, value_type) \
                CDSSTRESS_MichaelSet_case(fixture, test_case, MichaelSet_Iterable_RCU_SHT_less_stat, key_type,    \
                                          value_type)
            ...
            CDSSTRESS_MichaelSet_case(fixture, test_case, MichaelSet_RCU_SHT_less, key_type, value_type)             \
                CDSSTRESS_MichaelSet_case(fixture, test_case, MichaelSet_RCU_SHB_less_stat, key_type, value_type)    \
                    CDSSTRESS_MichaelSet_case(fixture, test_case, MichaelSet_Lazy_RCU_SHB_cmp, key_type, value_type) \
                        CDSSTRESS_MichaelSet_case(fixture, test_case, MichaelSet_Lazy_RCU_SHT_cmp_stat, key_type,    \
                                                  value_type)                                                        \
                            CDSSTRESS_MichaelSet_case(fixture, test_case, MichaelSet_Lazy_RCU_SHT_less, key_type,    \
                                                      value_type)                                                    \
                                CDSSTRESS_MichaelSet_case(fixture, test_case, MichaelSet_Lazy_RCU_SHB_less_stat,     \
                                                          key_type, value_type)                                      \
    ...
    CDSSTRESS_MichaelSet_case(fixture, test_case, MichaelSet_Iterable_RCU_SHB_cmp, key_type, value_type)          \
        CDSSTRESS_MichaelSet_case(fixture, test_case, MichaelSet_Iterable_RCU_SHT_cmp_stat, key_type, value_type) \
            CDSSTRESS_MichaelSet_case(fixture, test_case, MichaelSet_Iterable_RCU_SHT_less, key_type, value_type) \
                CDSSTRESS_MichaelSet_case(fixture, test_case, MichaelSet_Iterable_RCU_SHB_less_stat, key_type,    \
                                          value_type)                                                             \
...
#define CDSSTRESS_MichaelSet_HP_1(fixture, test_case, key_type, value_type)                                            \
    CDSSTRESS_MichaelSet_case(fixture, test_case, MichaelSet_DHP_cmp, key_type, value_type) CDSSTRESS_MichaelSet_case( \
        fixture, test_case, MichaelSet_HP_cmp_stat, key_type, value_type)                                              \
                ...
                CDSSTRESS_MichaelSet_case(fixture, test_case, MichaelSet_Lazy_DHP_cmp, key_type, value_type)           \
                    CDSSTRESS_MichaelSet_case(fixture, test_case, MichaelSet_Lazy_HP_cmp_stat, key_type, value_type)   \
                        CDSSTRESS_MichaelSet_case(fixture, test_case, MichaelSet_Lazy_HP_less, key_type, value_type)   \
                            CDSSTRESS_MichaelSet_case(fixture, test_case, MichaelSet_Lazy_DHP_less_stat, key_type,     \
                                                      value_type)

#define CDSSTRESS_MichaelSet_RCU_1(fixture, test_case, key_type, value_type)                                          \
    CDSSTRESS_MichaelSet_case(fixture, test_case, MichaelSet_RCU_GPB_cmp, key_type,                                   \
                              value_type) CDSSTRESS_MichaelSet_case(fixture, test_case, MichaelSet_RCU_GPI_cmp_stat,  \
                                                                    key_type, value_type)                             \
            ...
            CDSSTRESS_MichaelSet_case(fixture, test_case, MichaelSet_RCU_GPI_less, key_type, value_type)              \
                CDSSTRESS_MichaelSet_case(fixture, test_case, MichaelSet_RCU_GPT_less, key_type, value_type)          \
                    CDSSTRESS_MichaelSet_case(fixture, test_case, MichaelSet_RCU_GPB_less_stat, key_type, value_type) \
                                                                                                                      \
                        CDSSTRESS_MichaelSet_case(fixture, test_case, MichaelSet_Lazy_RCU_GPB_cmp, key_type,          \
                                                  value_type)                                                         \
                            CDSSTRESS_MichaelSet_case(fixture, test_case, MichaelSet_Lazy_RCU_GPI_cmp_stat, key_type, \
                                                      value_type)                                                     \
                                CDSSTRESS_MichaelSet_case(fixture, test_case, MichaelSet_Lazy_RCU_GPT_cmp_stat,       \
                                                          key_type, value_type)                                       \
                                    CDSSTRESS_MichaelSet_case(fixture, test_case, MichaelSet_Lazy_RCU_GPI_less,       \
                                                              key_type, value_type)                                   \
                                        CDSSTRESS_MichaelSet_case(fixture, test_case, MichaelSet_Lazy_RCU_GPT_less,   \
                                                                  key_type, value_type)                               \
                                            CDSSTRESS_MichaelSet_case(fixture, test_case,                             \
                                                                      MichaelSet_Lazy_RCU_GPB_less_stat, key_type,    \
                                                                      value_type)                                     \
                                                                                                                      \
...
#define CDSSTRESS_MichaelSet_HP(fixture, test_case, key_type, value_type)                                             \
    CDSSTRESS_MichaelSet_case(fixture, test_case, MichaelSet_HP_cmp, key_type, value_type) CDSSTRESS_MichaelSet_case( \
        fixture, test_case, MichaelSet_DHP_cmp_stat, key_type, value_type)                                            \
                ...
                CDSSTRESS_MichaelSet_case(fixture, test_case, MichaelSet_Lazy_HP_cmp, key_type, value_type)           \
                    CDSSTRESS_MichaelSet_case(fixture, test_case, MichaelSet_Lazy_DHP_cmp_stat, key_type, value_type) \
                        CDSSTRESS_MichaelSet_case(fixture, test_case, MichaelSet_Lazy_DHP_less, key_type, value_type) \
                            CDSSTRESS_MichaelSet_case(fixture, test_case, MichaelSet_Lazy_HP_less_stat, key_type,     \
                                                      value_type)                                                     \
                                                                                                                      \
...
#define CDSSTRESS_MichaelSet_RCU(fixture, test_case, key_type, value_type)                                            \
    CDSSTRESS_MichaelSet_case(fixture, test_case, MichaelSet_RCU_GPI_cmp, key_type,                                   \
                              value_type) CDSSTRESS_MichaelSet_case(fixture, test_case, MichaelSet_RCU_GPT_cmp,       \
                                                                    key_type, value_type)                             \
            ...
            CDSSTRESS_MichaelSet_case(fixture, test_case, MichaelSet_RCU_GPB_less, key_type, value_type)              \
                CDSSTRESS_MichaelSet_case(fixture, test_case, MichaelSet_RCU_GPI_less_stat, key_type, value_type)     \
                    CDSSTRESS_MichaelSet_case(fixture, test_case, MichaelSet_RCU_GPT_less_stat, key_type, value_type) \
                                                                                                                      \
                        CDSSTRESS_MichaelSet_case(fixture, test_case, MichaelSet_Lazy_RCU_GPI_cmp, key_type,          \
                                                  value_type) CDSSTRESS_MichaelSet_case(fixture, test_case,           \
                                                                                        MichaelSet_Lazy_RCU_GPT_cmp,  \
                                                                                        key_type, value_type)         \
                            CDSSTRESS_MichaelSet_case(fixture, test_case, MichaelSet_Lazy_RCU_GPB_cmp_stat, key_type, \
                                                      value_type)                                                     \
                                CDSSTRESS_MichaelSet_case(fixture, test_case, MichaelSet_Lazy_RCU_GPB_less, key_type, \
                                                          value_type)                                                 \
                                    CDSSTRESS_MichaelSet_case(fixture, test_case, MichaelSet_Lazy_RCU_GPI_less_stat,  \
                                                              key_type, value_type)                                   \
                                        CDSSTRESS_MichaelSet_case(fixture, test_case,                                 \
                                                                  MichaelSet_Lazy_RCU_GPT_less_stat, key_type,        \
                                                                  value_type)                                         \
                                                                                                                      \
