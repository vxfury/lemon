...
class CuckooSet : public cc::CuckooSet<V, Traits> {
  ...
  public:
    ...
    CuckooSet(Config const &cfg)
        : cuckoo_base_class(cfg.s_nCuckooInitialSize, static_cast<unsigned int>(cfg.s_nCuckooProbesetSize),
    ...
    {
        return cuckoo_base_class::erase_with(
            key, typename std::conditional<cuckoo_base_class::c_isSorted, Pred, typename Pred::equal_to>::type());
    }
...
struct set_type<tag_CuckooSet, Key, Val> : public set_type_base<Key, Val> {
    ...
    typedef CuckooSet<key_val, traits_CuckooStripedSet<traits_CuckooSet_list_unord_stat>>
        CuckooStripedSet_list_unord_stat;
    typedef CuckooSet<key_val, traits_CuckooRefinableSet<traits_CuckooSet_list_unord_stat>>
    ...
    typedef CuckooSet<key_val, traits_CuckooStripedSet<traits_CuckooSet_list_unord_storehash>>
        CuckooStripedSet_list_unord_storehash;
    typedef CuckooSet<key_val, traits_CuckooRefinableSet<traits_CuckooSet_list_unord_storehash>>
    ...
    typedef CuckooSet<key_val, traits_CuckooRefinableSet<traits_CuckooSet_list_ord_stat>>
        CuckooRefinableSet_list_ord_stat;

    struct traits_CuckooSet_list_ord_storehash : public traits_CuckooSet_list_ord {
        static constexpr const bool store_hash = true;
    };
    typedef CuckooSet<key_val, traits_CuckooStripedSet<traits_CuckooSet_list_ord_storehash>>
        CuckooStripedSet_list_ord_storehash;
    typedef CuckooSet<key_val, traits_CuckooRefinableSet<traits_CuckooSet_list_ord_storehash>>
    ...
    typedef CuckooSet<key_val, traits_CuckooRefinableSet<traits_CuckooSet_vector_unord>>
        CuckooRefinableSet_vector_unord;

    struct traits_CuckooSet_vector_unord_stat : public traits_CuckooSet_vector_unord {
        typedef cc::cuckoo::stat stat;
    };
    typedef CuckooSet<key_val, traits_CuckooStripedSet<traits_CuckooSet_vector_unord_stat>>
        CuckooStripedSet_vector_unord_stat;
    typedef CuckooSet<key_val, traits_CuckooRefinableSet<traits_CuckooSet_vector_unord_stat>>
        CuckooRefinableSet_vector_unord_stat;

    struct traits_CuckooSet_vector_unord_storehash : public traits_CuckooSet_vector_unord {
        static constexpr const bool store_hash = true;
    };
    typedef CuckooSet<key_val, traits_CuckooStripedSet<traits_CuckooSet_vector_unord_storehash>>
        CuckooStripedSet_vector_unord_storehash;
    typedef CuckooSet<key_val, traits_CuckooRefinableSet<traits_CuckooSet_vector_unord_storehash>>
    ...
    typedef CuckooSet<key_val, traits_CuckooStripedSet<traits_CuckooSet_vector_ord_stat>>
        CuckooStripedSet_vector_ord_stat;
    typedef CuckooSet<key_val, traits_CuckooRefinableSet<traits_CuckooSet_vector_ord_stat>>
        CuckooRefinableSet_vector_ord_stat;

    struct traits_CuckooSet_vector_ord_storehash : public traits_CuckooSet_vector_ord {
        static constexpr const bool store_hash = true;
    };
    typedef CuckooSet<key_val, traits_CuckooStripedSet<traits_CuckooSet_vector_ord_storehash>>
        CuckooStripedSet_vector_ord_storehash;
    typedef CuckooSet<key_val, traits_CuckooRefinableSet<traits_CuckooSet_vector_ord_storehash>>
...
#define CDSSTRESS_CuckooSet(fixture, test_case, key_type, value_type)                                                  \
    CDSSTRESS_CuckooSet_case(                                                                                          \
        fixture, test_case, CuckooStripedSet_list_unord, key_type,                                                     \
        value_type) CDSSTRESS_CuckooSet_case(fixture, test_case, CuckooRefinableSet_list_unord, key_type,              \
                                             value_type) CDSSTRESS_CuckooSet_case(fixture, test_case,                  \
                                                                                  CuckooStripedSet_list_unord_stat,    \
                                                                                  key_type, value_type)                \
        CDSSTRESS_CuckooSet_case(fixture, test_case, CuckooRefinableSet_list_unord_stat, key_type,                     \
                                 value_type) CDSSTRESS_CuckooSet_case(fixture, test_case,                              \
                                                                      CuckooStripedSet_list_unord_storehash, key_type, \
                                                                      value_type)                                      \
            CDSSTRESS_CuckooSet_case(                                                                                  \
                fixture, test_case, CuckooRefinableSet_list_unord_storehash, key_type,                                 \
                value_type) CDSSTRESS_CuckooSet_case(fixture, test_case, CuckooStripedSet_list_ord, key_type,          \
                                                     value_type) CDSSTRESS_CuckooSet_case(fixture, test_case,          \
                                                                                          CuckooRefinableSet_list_ord, \
                                                                                          key_type, value_type)        \
                CDSSTRESS_CuckooSet_case(fixture, test_case, CuckooStripedSet_list_ord_stat, key_type, value_type)     \
                    CDSSTRESS_CuckooSet_case(fixture, test_case, CuckooRefinableSet_list_ord_stat, key_type,           \
                                             value_type) CDSSTRESS_CuckooSet_case(fixture, test_case,                  \
                                                                                  CuckooStripedSet_list_ord_storehash, \
                                                                                  key_type, value_type)                \
                        CDSSTRESS_CuckooSet_case(fixture, test_case, CuckooRefinableSet_list_ord_storehash, key_type,  \
                                                 value_type) CDSSTRESS_CuckooSet_case(fixture, test_case,              \
                                                                                      CuckooStripedSet_vector_unord,   \
                                                                                      key_type, value_type)            \
                            CDSSTRESS_CuckooSet_case(fixture, test_case, CuckooRefinableSet_vector_unord, key_type,    \
                                                     value_type)                                                       \
                                CDSSTRESS_CuckooSet_case(fixture, test_case, CuckooStripedSet_vector_unord_stat,       \
                                                         key_type, value_type)                                         \
                                    CDSSTRESS_CuckooSet_case(                                                          \
                                        fixture, test_case, CuckooRefinableSet_vector_unord_stat, key_type,            \
                                        value_type) CDSSTRESS_CuckooSet_case(fixture, test_case,                       \
                                                                             CuckooStripedSet_vector_unord_storehash,  \
                                                                             key_type, value_type)                     \
                                        CDSSTRESS_CuckooSet_case(                                                      \
                                            fixture, test_case, CuckooRefinableSet_vector_unord_storehash, key_type,   \
                                            value_type) CDSSTRESS_CuckooSet_case(fixture, test_case,                   \
                                                                                 CuckooStripedSet_vector_ord,          \
                                                                                 key_type, value_type)                 \
                                            CDSSTRESS_CuckooSet_case(                                                  \
                                                fixture, test_case, CuckooRefinableSet_vector_ord, key_type,           \
                                                value_type) CDSSTRESS_CuckooSet_case(fixture, test_case,               \
                                                                                     CuckooStripedSet_vector_ord_stat, \
                                                                                     key_type, value_type)             \
                                                CDSSTRESS_CuckooSet_case(fixture, test_case,                           \
                                                                         CuckooRefinableSet_vector_ord_stat, key_type, \
                                                                         value_type)                                   \
                                                    CDSSTRESS_CuckooSet_case(fixture, test_case,                       \
                                                                             CuckooStripedSet_vector_ord_storehash,    \
                                                                             key_type, value_type)                     \
                                                        CDSSTRESS_CuckooSet_case(                                      \
                                                            fixture, test_case,                                        \
                                                            CuckooRefinableSet_vector_ord_storehash, key_type,         \
                                                            value_type)
