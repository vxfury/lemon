...
static inline property_stream &operator<<(property_stream &o,
                                          cds::sync::injecting_monitor_traits::empty_stat const & /*s*/)
{
    return o;
}
} // namespace cds_test
...
{
    return o << CDSSTRESS_POOLMONITOR_STAT_OUT(s, m_nLockCount) << CDSSTRESS_POOLMONITOR_STAT_OUT(s, m_nUnlockCount)
             << CDSSTRESS_POOLMONITOR_STAT_OUT(s, m_nMaxLocked) << CDSSTRESS_POOLMONITOR_STAT_OUT(s, m_nLockContention)
