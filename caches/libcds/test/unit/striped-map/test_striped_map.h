...
struct call_find_with {
    ...
    {
        return m.find_with(cds_test::striped_map_fixture::other_item(key), cds_test::striped_map_fixture::other_less(),
                           f);
    }
};
...
struct call_erase_with {
    bool operator()(Map &m, int key) const
    {
        return m.erase_with(cds_test::striped_map_fixture::other_item(key),
                            cds_test::striped_map_fixture::other_less());
    }
...
class StripedMap : public cds_test::striped_map_fixture {
  ...
  protected:
    ...
    void test(Map &m)
    {
        ...
        for (int i = 0; i < static_cast<int>(kkSize); ++i) arrKeys.push_back(key_type(i));
        ...
        // clear
        for (auto const &i : arrKeys) ASSERT_TRUE(m.insert(i));
...
{
    typedef cc::StripedMap<typename TestFixture::container_type, cds::opt::hash<typename TestFixture::hash1>,
...
{
    typedef cc::StripedMap<typename TestFixture::container_type, cds::opt::hash<typename TestFixture::hash1>,
                           cds::opt::less<typename TestFixture::less>, cds::opt::compare<typename TestFixture::cmp>>
        map_type;
...
{
    typedef cc::StripedMap<typename TestFixture::container_type,
                           cds::opt::mutex_policy<cc::striped_set::striping<cds::sync::spin>>,
                           cds::opt::hash<typename TestFixture::hash1>, cds::opt::less<typename TestFixture::less>,
                           cds::opt::compare<typename TestFixture::cmp>>
        map_type;
...
{
    typedef cc::StripedMap<typename TestFixture::container_type, cds::opt::mutex_policy<cc::striped_set::refinable<>>,
                           cds::opt::hash<typename TestFixture::hash1>, cds::opt::compare<typename TestFixture::cmp>>
        map_type;
...
REGISTER_TYPED_TEST_CASE_P(StripedMap, compare, less, cmpmix, spinlock, load_factor_resizing, load_factor_resizing_rt,
                           single_bucket_resizing, single_bucket_resizing_rt, copy_policy_copy, copy_policy_move,
                           copy_policy_swap, copy_policy_special);

REGISTER_TYPED_TEST_CASE_P(RefinableMap, compare, less, cmpmix, spinlock, load_factor_resizing, load_factor_resizing_rt,
                           single_bucket_resizing, single_bucket_resizing_rt, copy_policy_copy, copy_policy_move,
                           copy_policy_swap, copy_policy_special);
} // namespace
