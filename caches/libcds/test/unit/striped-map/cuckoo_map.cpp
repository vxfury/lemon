...
TEST_F(CuckooMap, refinable_list_ordered_cmp)
{
    typedef cc::CuckooMap<key_type, value_type,
                          cc::cuckoo::make_traits<
                              cds::opt::hash<std::tuple<hash1, hash2>>, cds::opt::mutex_policy<cc::cuckoo::refinable<>>,
...
TEST_F(CuckooMap, refinable_vector_ordered_cmp)
{
    typedef cc::CuckooMap<key_type, value_type,
                          cc::cuckoo::make_traits<
                              cds::opt::hash<std::tuple<hash1, hash2>>, cds::opt::mutex_policy<cc::cuckoo::refinable<>>,
                              cds::opt::compare<cmp>, cc::cuckoo::probeset_type<cc::cuckoo::vector<8>>>::type>
        map_type;
...
TEST_F(CuckooMap, refinable_vector_ordered_cmpmix)
{
    typedef cc::CuckooMap<
        ...
        cc::cuckoo::make_traits<cds::opt::hash<std::tuple<hash1, hash2>>,
                                cds::opt::mutex_policy<cc::cuckoo::refinable<>>, cds::opt::less<less>,
                                cds::opt::compare<cmp>, cc::cuckoo::probeset_type<cc::cuckoo::vector<6>>>::type>
        map_type;
