...
TYPED_TEST_P(MichaelList, less_ordered)
{
    typedef cc::MichaelList<typename TestFixture::rcu_type, typename TestFixture::item,
                            typename cc::michael_list::make_traits<
                                cds::opt::less<typename TestFixture::template lt<typename TestFixture::item>>>::type>
        list_type;
...
{
    typedef cc::MichaelList<typename TestFixture::rcu_type, typename TestFixture::item,
                            typename cc::michael_list::make_traits<cds::opt::compare<
                                typename TestFixture::template cmp<typename TestFixture::item>>>::type>
        list_type;
...
REGISTER_TYPED_TEST_CASE_P(MichaelList, less_ordered, compare_ordered, mix_ordered, item_counting, backoff, seq_cst,
                           stat, wrapped_stat);
