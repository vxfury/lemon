...
{
    typedef cc::MichaelKVList<typename TestFixture::rcu_type, typename TestFixture::key_type,
                              typename TestFixture::value_type,
                              typename cc::michael_list::make_traits<cds::opt::less<typename TestFixture::lt> >::type>
        list_type;
...
{
    typedef cc::MichaelKVList<
        typename TestFixture::rcu_type, typename TestFixture::key_type, typename TestFixture::value_type,
        typename cc::michael_list::make_traits<cds::opt::compare<typename TestFixture::cmp> >::type>
        list_type;
...
TYPED_TEST_P(MichaelKVList, mix_ordered)
{
    typedef cc::MichaelKVList<typename TestFixture::rcu_type, typename TestFixture::key_type,
                              typename TestFixture::value_type,
                              typename cc::michael_list::make_traits<cds::opt::compare<typename TestFixture::cmp>,
                                                                     cds::opt::less<typename TestFixture::lt> >::type>
        list_type;
...
TYPED_TEST_P(MichaelKVList, item_counting)
{
    ...
    typedef cc::MichaelKVList<typename TestFixture::rcu_type, typename TestFixture::key_type,
                              typename TestFixture::value_type, traits>
        list_type;
...
REGISTER_TYPED_TEST_CASE_P(MichaelKVList, less_ordered, compare_ordered, mix_ordered, item_counting, backoff, seq_cst,
                           stat, wrapped_stat);
