...
TYPED_TEST_P(LazyList, compare_ordered)
{
    typedef cc::LazyList<typename TestFixture::rcu_type, typename TestFixture::item,
                         typename cc::lazy_list::make_traits<
                             cds::opt::compare<typename TestFixture::template cmp<typename TestFixture::item>>>::type>
        list_type;
...
REGISTER_TYPED_TEST_CASE_P(LazyList, less_ordered, compare_ordered, mix_ordered, item_counting, backoff, seq_cst, mutex,
                           stat, wrapped_stat);
