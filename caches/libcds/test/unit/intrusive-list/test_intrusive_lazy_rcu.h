...
TYPED_TEST_P(IntrusiveLazyList, member_hook)
{
    typedef ci::LazyList<
        ...
        typename ci::lazy_list::make_traits<
            ci::opt::hook<ci::lazy_list::member_hook<offsetof(typename TestFixture::member_item, hMember),
...
{
    struct traits : public ci::lazy_list::traits {
        typedef ci::lazy_list::member_hook<offsetof(typename TestFixture::member_item, hMember),
                                           cds::opt::gc<typename TestFixture::rcu_type>>
            hook;
        typedef typename TestFixture::mock_disposer disposer;
...
REGISTER_TYPED_TEST_CASE_P(IntrusiveLazyList, base_hook, base_hook_cmp, base_hook_item_counting, base_hook_backoff,
