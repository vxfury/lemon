...
TEST_F(IntrusiveIterableList_HP, less)
{
    typedef ci::IterableList<
        gc_type, item_type,
        typename ci::iterable_list::make_traits<ci::opt::disposer<mock_disposer>, cds::opt::less<less<item_type>>,
...
TEST_F(IntrusiveIterableList_HP, compare)
{
    typedef ci::IterableList<
        gc_type, item_type,
        typename ci::iterable_list::make_traits<ci::opt::disposer<mock_disposer>, cds::opt::compare<cmp<item_type>>,
