...
TYPED_TEST_P(IntrusiveMichaelList, base_hook)
{
    typedef ci::MichaelList<
        typename TestFixture::rcu_type, typename TestFixture::base_item,
        typename ci::michael_list::make_traits<
            ...
            cds::opt::less<typename TestFixture::template less<typename TestFixture::base_item>>>::type>
        list_type;
...
TYPED_TEST_P(IntrusiveMichaelList, base_hook_cmp)
{
    typedef ci::MichaelList<
        ...
        typename ci::michael_list::make_traits<
            ci::opt::hook<ci::michael_list::base_hook<cds::opt::gc<typename TestFixture::rcu_type>>>,
            ci::opt::disposer<typename TestFixture::mock_disposer>,
            cds::opt::compare<typename TestFixture::template cmp<typename TestFixture::base_item>>>::type>
        list_type;
...
{
    typedef ci::MichaelList<
        typename TestFixture::rcu_type, typename TestFixture::member_item,
        typename ci::michael_list::make_traits<
            ci::opt::hook<ci::michael_list::member_hook<offsetof(typename TestFixture::member_item, hMember),
                                                        cds::opt::gc<typename TestFixture::rcu_type>>>,
            ci::opt::disposer<typename TestFixture::mock_disposer>,
            cds::opt::less<typename TestFixture::template less<typename TestFixture::member_item>>>::type>
        list_type;
    ...
    typedef ci::MichaelList<
        ...
        typename ci::michael_list::make_traits<
            ci::opt::hook<ci::michael_list::member_hook<offsetof(typename TestFixture::member_item, hMember),
                                                        cds::opt::gc<typename TestFixture::rcu_type>>>,
            ci::opt::disposer<typename TestFixture::mock_disposer>,
            cds::opt::compare<typename TestFixture::template cmp<typename TestFixture::member_item>>>::type>
        list_type;
...
{
    struct traits : public ci::michael_list::traits {
        typedef ci::michael_list::member_hook<offsetof(typename TestFixture::member_item, hMember),
                                              cds::opt::gc<typename TestFixture::rcu_type>>
            hook;
        typedef typename TestFixture::mock_disposer disposer;
...
REGISTER_TYPED_TEST_CASE_P(IntrusiveMichaelList, base_hook, base_hook_cmp, base_hook_item_counting, base_hook_backoff,
                           base_hook_seqcst, base_hook_stat, base_hook_wrapped_stat, member_hook, member_hook_cmp,
                           member_hook_item_counting, member_hook_seqcst, member_hook_back_off, member_hook_stat,
                           member_hook_wrapped_stat);
