...
TEST_F(EllenBinTreeMap_DHP, compare)
{
    typedef cc::EllenBinTreeMap<gc_type, key_type, value_type,
                                typename cc::ellen_bintree::make_map_traits<cds::opt::compare<cmp> >::type>
        map_type;
...
{
    typedef cc::EllenBinTreeMap<gc_type, key_type, value_type,
                                typename cc::ellen_bintree::make_map_traits<cds::opt::less<base_class::less> >::type>
        map_type;
...
TEST_F(EllenBinTreeMap_DHP, cmpmix)
{
    typedef cc::EllenBinTreeMap<
        ...
        typename cc::ellen_bintree::make_map_traits<cds::opt::less<base_class::less>, cds::opt::compare<cmp> >::type>
        map_type;
