...
TEST_F(EllenBinTreeSet_HP, compare)
{
    typedef cc::EllenBinTreeSet<gc_type, key_type, int_item,
                                typename cc::ellen_bintree::make_set_traits<cc::opt::type_traits<generic_traits>,
...
TEST_F(EllenBinTreeSet_HP, less)
{
    typedef cc::EllenBinTreeSet<gc_type, key_type, int_item,
                                typename cc::ellen_bintree::make_set_traits<cc::opt::type_traits<generic_traits>,
                                                                            cds::opt::less<base_class::less> >::type>
        set_type;
...
TEST_F(EllenBinTreeSet_HP, cmpmix)
{
    typedef cc::EllenBinTreeSet<
        gc_type, key_type, int_item,
        typename cc::ellen_bintree::make_set_traits<cc::opt::type_traits<generic_traits>,
                                                    cds::opt::less<base_class::less>, cds::opt::compare<cmp> >::type>
        set_type;
