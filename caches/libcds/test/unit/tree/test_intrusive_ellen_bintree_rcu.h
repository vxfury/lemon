...
TYPED_TEST_P(IntrusiveEllenBinTree, base_cmp)
{
    ...
    typedef ci::EllenBinTree<
        rcu_type, key_type, base_item_type,
        typename ci::ellen_bintree::make_traits<
            ci::opt::type_traits<generic_traits>, ci::opt::hook<ci::ellen_bintree::base_hook<ci::opt::gc<rcu_type>>>,
            ci::opt::compare<typename TestFixture::template cmp<base_item_type>>>::type>
        tree_type;
...
TYPED_TEST_P(IntrusiveEllenBinTree, base_less)
{
    ...
    typedef ci::EllenBinTree<
        ...
        typename ci::ellen_bintree::make_traits<
            ci::opt::type_traits<generic_traits>, ci::opt::hook<ci::ellen_bintree::base_hook<ci::opt::gc<rcu_type>>>,
            ci::opt::less<typename TestFixture::template less<base_item_type>>>::type>
        tree_type;
...
TYPED_TEST_P(IntrusiveEllenBinTree, base_item_counter)
{
    ...
    typedef ci::EllenBinTree<
        rcu_type, key_type, base_item_type,
        typename ci::ellen_bintree::make_traits<ci::opt::type_traits<generic_traits>,
                                                ci::opt::hook<ci::ellen_bintree::base_hook<ci::opt::gc<rcu_type>>>,
                                                ci::opt::compare<typename TestFixture::template cmp<base_item_type>>,
                                                ci::opt::item_counter<typename TestFixture::simple_item_counter>>::type>
        tree_type;
...
TYPED_TEST_P(IntrusiveEllenBinTree, member_cmp)
{
    ...
    typedef ci::EllenBinTree<
        rcu_type, key_type, member_item_type,
        typename ci::ellen_bintree::make_traits<
            ...
            ci::opt::compare<typename TestFixture::template cmp<member_item_type>>>::type>
        tree_type;
...
TYPED_TEST_P(IntrusiveEllenBinTree, member_less)
{
    ...
    typedef ci::EllenBinTree<
        ...
        typename ci::ellen_bintree::make_traits<
            ci::opt::type_traits<generic_traits>,
            ci::opt::hook<ci::ellen_bintree::member_hook<offsetof(member_item_type, hMember), ci::opt::gc<rcu_type>>>,
            ci::opt::less<typename TestFixture::template less<member_item_type>>>::type>
        tree_type;
...
REGISTER_TYPED_TEST_CASE_P(IntrusiveEllenBinTree, base_cmp, base_less, base_item_counter, base_backoff, base_seq_cst,
                           base_update_desc_pool, base_update_desc_lazy_pool, member_cmp, member_less,
                           member_item_counter, member_backoff, member_seq_cst, member_update_desc_pool,
                           member_update_desc_lazy_pool);
