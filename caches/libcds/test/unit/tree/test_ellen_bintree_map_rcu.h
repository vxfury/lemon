...
TYPED_TEST_P(EllenBinTreeMap, compare)
{
    ...
    typedef cc::EllenBinTreeMap<
        ...
        typename cc::ellen_bintree::make_map_traits<cds::opt::compare<typename TestFixture::cmp>>::type>
        map_type;
...
TYPED_TEST_P(EllenBinTreeMap, less)
{
    ...
    typedef cc::EllenBinTreeMap<
        rcu_type, key_type, value_type,
        typename cc::ellen_bintree::make_map_traits<cds::opt::less<typename TestFixture::less>>::type>
        map_type;
    ...
    typedef cc::EllenBinTreeMap<rcu_type, key_type, value_type,
                                typename cc::ellen_bintree::make_map_traits<
                                    ...
                                    cc::ellen_bintree::update_desc_allocator<cds::memory::pool_allocator<
                                        cds_test::update_desc, cds_test::pool_accessor>>>::type>
        map_type;
...
TYPED_TEST_P(EllenBinTreeMap, update_desc_lazy_pool)
{
    ...
    typedef cc::EllenBinTreeMap<rcu_type, key_type, value_type,
                                typename cc::ellen_bintree::make_map_traits<
                                    cds::opt::less<typename TestFixture::less>,
                                    cc::ellen_bintree::update_desc_allocator<cds::memory::pool_allocator<
                                        cds_test::update_desc, cds_test::lazy_pool_accessor>>>::type>
        map_type;
...
TYPED_TEST_P(EllenBinTreeMap, cmpmix)
{
    ...
    typedef cc::EllenBinTreeMap<
        rcu_type, key_type, value_type,
        typename cc::ellen_bintree::make_map_traits<cds::opt::less<typename TestFixture::less>,
...
REGISTER_TYPED_TEST_CASE_P(EllenBinTreeMap, compare, less, update_desc_pool, update_desc_lazy_pool, cmpmix,
                           item_counting, backoff, stat, copy_policy);
