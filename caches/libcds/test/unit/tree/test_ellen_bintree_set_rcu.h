...
TYPED_TEST_P(EllenBinTreeSet, compare)
{
    ...
    typedef cc::EllenBinTreeSet<
        rcu_type, int, int_item,
        typename cc::ellen_bintree::make_set_traits<cds::opt::compare<typename TestFixture::cmp>,
                                                    cc::ellen_bintree::key_extractor<key_extractor> >::type>
        set_type;
...
TYPED_TEST_P(EllenBinTreeSet, less)
{
    ...
    typedef cc::EllenBinTreeSet<
        rcu_type, int, int_item,
        typename cc::ellen_bintree::make_set_traits<cds::opt::less<typename TestFixture::less>,
                                                    cc::ellen_bintree::key_extractor<key_extractor> >::type>
        set_type;
...
REGISTER_TYPED_TEST_CASE_P(EllenBinTreeSet, compare, less, cmpmix, update_desc_pool, update_desc_lazy_pool,
                           item_counting, backoff, stat, seq_cst);
} // namespace
