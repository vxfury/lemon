  ...
  protected:
    ...
    void SetUp()
    {
        typedef ci::MoirQueue<
            ...
            typename ci::msqueue::make_traits<ci::opt::hook<ci::msqueue::base_hook<ci::opt::gc<gc_type>>>>::type>
            queue_type;
...
{
    typedef cds::intrusive::MoirQueue<
        gc_type, base_item_type,
        typename ci::msqueue::make_traits<ci::opt::disposer<mock_disposer>,
                                          ci::opt::hook<ci::msqueue::base_hook<ci::opt::gc<gc_type>>>>::type>
        test_queue;
...
TEST_F(IntrusiveMoirQueue_DHP, member_hook)
{
    typedef cds::intrusive::MoirQueue<
        ...
        typename ci::msqueue::make_traits<
            ...
            ci::opt::hook<ci::msqueue::member_hook<offsetof(member_item_type, hMember), ci::opt::gc<gc_type>>>>::type>
        test_queue;
...
{
    struct traits : public ci::msqueue::traits {
        typedef ci::msqueue::member_hook<offsetof(member_item_type, hMember), ci::opt::gc<gc_type>> hook;
        typedef mock_disposer disposer;
        typedef cds::atomicity::item_counter item_counter;
        typedef ci::msqueue::stat<> stat;
        typedef cds::opt::v::sequential_consistent memory_model;
