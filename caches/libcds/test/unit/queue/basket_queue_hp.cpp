...
TEST_F(BasketQueue_HP, item_counting)
{
    typedef cds::container::BasketQueue<
        gc_type, int,
        typename cds::container::basket_queue::make_traits<cds::opt::item_counter<cds::atomicity::item_counter> >::type>
        test_queue;
...
TEST_F(BasketQueue_HP, aligned)
{
    typedef cds::container::BasketQueue<
        gc_type, int,
        typename cds::container::basket_queue::make_traits<cds::opt::memory_model<cds::opt::v::relaxed_ordering>,
