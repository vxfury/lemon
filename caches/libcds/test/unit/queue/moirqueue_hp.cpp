...
TEST_F(MoirQueue_HP, item_counting)
{
    typedef cds::container::MoirQueue<
        gc_type, int,
        typename cds::container::msqueue::make_traits<cds::opt::item_counter<cds::atomicity::item_counter> >::type>
        test_queue;
...
TEST_F(MoirQueue_HP, relaxed)
{
    typedef cds::container::MoirQueue<
        gc_type, int,
        typename cds::container::msqueue::make_traits<cds::opt::item_counter<cds::atomicity::item_counter>,
...
TEST_F(MoirQueue_HP, aligned)
{
    typedef cds::container::MoirQueue<
        gc_type, int,
        typename cds::container::msqueue::make_traits<cds::opt::memory_model<cds::opt::v::relaxed_ordering>,
                                                      cds::opt::padding<32> >::type>
        test_queue;
