...
TEST_F(FCQueue, std_single_mutex_single_condvar_heavy_value)
{
    typedef fc_test::heavy_value<> ValueType;
    typedef cds::container::FCQueue<ValueType, std::queue<ValueType, std::deque<ValueType>>,
                                    cds::container::fcqueue::make_traits<cds::opt::wait_strategy<
...
{
    typedef cds::container::FCQueue<int, std::queue<int, std::deque<int>>,
                                    cds::container::fcqueue::make_traits<cds::opt::enable_elimination<true>>::type>
        queue_type;
...
{
    typedef cds::container::FCQueue<
        int, std::queue<int, std::deque<int>>,
        cds::container::fcqueue::make_traits<
...
{
    typedef cds::container::FCQueue<
        std::string, std::queue<std::string, std::deque<std::string>>,
        cds::container::fcqueue::make_traits<
            cds::opt::enable_elimination<true>,
...
{
    typedef cds::container::FCQueue<int, std::queue<int, std::deque<int>>,
                                    cds::container::fcqueue::make_traits<cds::opt::lock_type<std::mutex>>::type>
        queue_type;
...
{
    typedef cds::container::FCQueue<
        int, std::queue<int, std::list<int>>,
        cds::container::fcqueue::make_traits<
            cds::opt::wait_strategy<cds::algo::flat_combining::wait_strategy::single_mutex_single_condvar<5>>>::type>
        queue_type;
...
TEST_F(FCQueue, std_list_elimination_multi_mutex_multi_condvar)
{
    typedef cds::container::FCQueue<
        ...
        cds::container::fcqueue::make_traits<
            cds::opt::enable_elimination<true>,
            cds::opt::wait_strategy<cds::algo::flat_combining::wait_strategy::multi_mutex_multi_condvar<5>>>::type>
        queue_type;
