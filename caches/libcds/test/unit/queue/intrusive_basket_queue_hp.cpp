...
TEST_F(IntrusiveBasketQueue_HP, defaulted)
{
    typedef cds::intrusive::BasketQueue<gc_type, base_item_type,
                                        typename ci::basket_queue::make_traits<ci::opt::disposer<mock_disposer>>::type>
        test_queue;
...
{
    typedef cds::intrusive::BasketQueue<
        gc_type, base_item_type,
        typename ci::basket_queue::make_traits<ci::opt::disposer<mock_disposer>,
                                               ci::opt::hook<ci::basket_queue::base_hook<ci::opt::gc<gc_type>>>>::type>
        test_queue;
...
{
    struct traits : public ci::basket_queue::traits {
        typedef ci::basket_queue::member_hook<offsetof(member_item_type, hMember), ci::opt::gc<gc_type>> hook;
        typedef mock_disposer disposer;
        typedef cds::atomicity::item_counter item_counter;
        typedef ci::basket_queue::stat<> stat;
        typedef cds::opt::v::sequential_consistent memory_model;
