...
class IntrusiveFCQueue : public ::testing::Test {
  protected:
    ...
    struct base_hook_item : public Hook {
        ...
        base_hook_item() : nDisposeCount(0) {}
    };
    ...
    struct member_hook_item {
        ...
        member_hook_item() : nDisposeCount(0) {}
    };
  ...
  protected:
    ...
    void test(Queue &q)
    {
        ...
        q.apply([&sum](underlying_queue_type &queue) {
            for (auto const &el : queue) sum += el.nVal;
        });
        ...
        // clear with disposer
        for (size_t i = 0; i < nSize; ++i) q.push(arr[i]);
...
TEST_F(IntrusiveFCQueue, base)
{
    ...
    typedef cds::intrusive::FCQueue<value_type, boost::intrusive::list<value_type>,
                                    cds::intrusive::fcqueue::make_traits<cds::intrusive::opt::disposer<disposer>>::type>
        queue_type;
...
{
    typedef base_hook_item<boost::intrusive::list_base_hook<>> value_type;
    struct traits : public cds::intrusive::fcqueue::make_traits<cds::intrusive::opt::disposer<disposer>,
...
TEST_F(IntrusiveFCQueue, base_elimination_multi_mutex_multi_condvar)
{
    ...
    struct traits
        : public cds::intrusive::fcqueue::make_traits<
              cds::intrusive::opt::disposer<disposer>, cds::opt::enable_elimination<true>,
...
TEST_F(IntrusiveFCQueue, member)
{
    ...
    typedef boost::intrusive::member_hook<value_type, boost::intrusive::list_member_hook<>, &value_type::hMember>
        member_option;
...
TEST_F(IntrusiveFCQueue, member_single_mutex_single_condvar)
{
    ...
    typedef cds::intrusive::FCQueue<
        value_type, boost::intrusive::list<value_type, member_option>,
        cds::intrusive::fcqueue::make_traits<
            cds::intrusive::opt::disposer<disposer>,
...
TEST_F(IntrusiveFCQueue, slist_member)
{
    ...
    typedef boost::intrusive::member_hook<value_type, boost::intrusive::slist_member_hook<>, &value_type::hMember>
        member_option;

    typedef cds::intrusive::FCQueue<
        value_type, boost::intrusive::slist<value_type, member_option, boost::intrusive::cache_last<true>>,
        cds::intrusive::fcqueue::make_traits<cds::intrusive::opt::disposer<disposer>>::type>
        queue_type;
