...
class SkipListMap : public cds_test::container_map_rcu {
  ...
  protected:
    ...
    void test(Map &m)
    {
        ...
        // get_min
        for (int i = static_cast<int>(kkSize); i > 0; --i) ASSERT_TRUE(m.insert(i));
        ...
        // get_max
        for (int i = 0; i < static_cast<int>(kkSize); ++i) ASSERT_TRUE(m.insert(i));
...
TYPED_TEST_P(SkipListMap, compare)
{
    ...
    typedef cc::SkipListMap<rcu_type, key_type, value_type,
                            typename cc::skip_list::make_traits<cds::opt::compare<typename TestFixture::cmp> >::type>
        map_type;
...
TYPED_TEST_P(SkipListMap, less)
{
    ...
    typedef cc::SkipListMap<rcu_type, key_type, value_type,
                            typename cc::skip_list::make_traits<cds::opt::less<typename TestFixture::less> >::type>
        map_type;
...
TYPED_TEST_P(SkipListMap, cmpmix)
{
    ...
    typedef cc::SkipListMap<rcu_type, key_type, value_type,
                            typename cc::skip_list::make_traits<cds::opt::less<typename TestFixture::less>,
...
REGISTER_TYPED_TEST_CASE_P(SkipListMap, compare, less, cmpmix, item_counting, backoff, stat, xorshift32, xorshift24,
                           xorshift16, turbo32, turbo24, turbo16);
