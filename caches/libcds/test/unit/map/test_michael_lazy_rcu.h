...
TYPED_TEST_P(MichaelLazyMap, less)
{
    ...
    typedef cc::LazyKVList<rcu_type, key_type, value_type,
                           typename cc::lazy_list::make_traits<cds::opt::less<typename TestFixture::less> >::type>
        list_type;
...
REGISTER_TYPED_TEST_CASE_P(MichaelLazyMap, compare, less, cmpmix, backoff, seq_cst, mutex, stat, wrapped_stat);
} // namespace
