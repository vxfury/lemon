...
TEST_F(FeldmanHashMap_HP, compare)
{
    typedef cc::FeldmanHashMap<gc_type, key_type, value_type,
                               typename cc::feldman_hashmap::make_traits<cds::opt::compare<cmp>>::type>
        map_type;
...
{
    typedef cc::FeldmanHashMap<gc_type, key_type, value_type,
                               typename cc::feldman_hashmap::make_traits<cds::opt::less<less>>::type>
        map_type;
...
TEST_F(FeldmanHashMap_HP, cmpmix)
{
    typedef cc::FeldmanHashMap<
        ...
        typename cc::feldman_hashmap::make_traits<cds::opt::less<less>, cds::opt::compare<cmp>>::type>
        map_type;
...
TEST_F(FeldmanHashMap_HP, byte_cut)
{
    typedef cc::FeldmanHashMap<
        ...
        typename cc::feldman_hashmap::make_traits<
            cds::opt::compare<cmp>, cc::feldman_hashmap::hash_splitter<cds::algo::byte_splitter<key_type>>>::type>
        map_type;
