...
REGISTER_TYPED_TEST_CASE_P(SplitListLazyMap, compare, less, cmpmix, item_counting, stat, back_off, mutex, free_list,
                           static_bucket_table, static_bucket_table_free_list);
