...
TYPED_TEST_P(MichaelMap, compare)
{
    ...
    typedef cc::MichaelHashMap<
        rcu_type, list_type, typename cc::michael_map::make_traits<cds::opt::hash<typename TestFixture::hash1> >::type>
        map_type;
...
TYPED_TEST_P(MichaelMap, less)
{
    ...
    typedef cc::MichaelKVList<rcu_type, key_type, value_type,
                              typename cc::michael_list::make_traits<cds::opt::less<typename TestFixture::less> >::type>
        list_type;
...
REGISTER_TYPED_TEST_CASE_P(MichaelMap, compare, less, cmpmix, backoff, seq_cst, stat, wrapped_stat);
} // namespace
