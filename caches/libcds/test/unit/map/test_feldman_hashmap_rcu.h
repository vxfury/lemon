...
TYPED_TEST_P(FeldmanHashMap, compare)
{
    ...
    typedef cc::FeldmanHashMap<
        rcu_type, key_type, value_type,
        typename cc::feldman_hashmap::make_traits<cds::opt::compare<typename TestFixture::cmp>>::type>
        map_type;
...
TYPED_TEST_P(FeldmanHashMap, less)
{
    ...
    typedef cc::FeldmanHashMap<
        rcu_type, key_type, value_type,
        typename cc::feldman_hashmap::make_traits<cds::opt::less<typename TestFixture::less>>::type>
        map_type;
...
TYPED_TEST_P(FeldmanHashMap, cmpmix)
{
    ...
    typedef cc::FeldmanHashMap<
        rcu_type, key_type, value_type,
        typename cc::feldman_hashmap::make_traits<cds::opt::less<typename TestFixture::less>,
...
TYPED_TEST_P(FeldmanHashMap, explicit_key_size)
{
    ...
    struct map_traits : public cc::feldman_hashmap::traits {
        enum : size_t { hash_size = sizeof(int) + sizeof(uint16_t) };
...
TYPED_TEST_P(FeldmanHashMap, byte_cut)
{
    ...
    typedef cc::FeldmanHashMap<rcu_type, key_type, value_type,
                               typename cc::feldman_hashmap::make_traits<
                                   ...
                                   cc::feldman_hashmap::hash_splitter<cds::algo::byte_splitter<key_type>>>::type>
        map_type;
...
REGISTER_TYPED_TEST_CASE_P(FeldmanHashMap, defaulted, compare, less, cmpmix, backoff, stat, explicit_key_size, byte_cut,
                           byte_cut_explicit_key_size);
} // namespace
