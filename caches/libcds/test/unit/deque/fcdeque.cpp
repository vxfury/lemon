...
class FCDeque : public ::testing::Test {
  protected:
    ...
    void test(Deque &dq)
    {
        ...
        // push_back/pop_back
        for (int i = 0; i < static_cast<int>(c_nSize); ++i) EXPECT_TRUE(dq.push_back(i));
        EXPECT_EQ(dq.size(), c_nSize);
        ...
        // push_front/pop_back
        for (int i = 0; i < static_cast<int>(c_nSize); ++i) EXPECT_TRUE(dq.push_front(i));
        EXPECT_EQ(dq.size(), c_nSize);
...
{
    typedef cds::container::FCDeque<int, std::deque<int>,
                                    cds::container::fcdeque::make_traits<cds::opt::enable_elimination<true>>::type>
        deque_type;
...
{
    typedef cds::container::FCDeque<
        int, std::deque<int>,
        cds::container::fcdeque::make_traits<
            cds::opt::enable_elimination<true>,
            cds::opt::wait_strategy<cds::algo::flat_combining::wait_strategy::single_mutex_single_condvar<3>>>::type>
        deque_type;
...
TEST_F(FCDeque, std_statistics)
{
    typedef cds::container::FCDeque<
        int, std::deque<int>,
        cds::container::fcdeque::make_traits<cds::opt::stat<cds::container::fcdeque::stat<>>>::type>
        deque_type;
...
{
    struct deque_traits : public cds::container::fcdeque::make_traits<cds::opt::enable_elimination<true>>::type {
...
{
    typedef cds::container::FCDeque<
        int, boost::container::deque<int>,
        cds::container::fcdeque::make_traits<
            cds::opt::enable_elimination<true>,
            cds::opt::wait_strategy<cds::algo::flat_combining::wait_strategy::single_mutex_multi_condvar<5>>>::type>
        deque_type;
...
TEST_F(FCDeque, boost_mutex)
{
    typedef cds::container::FCDeque<
        int, boost::container::deque<int>,
        cds::container::fcdeque::make_traits<cds::opt::enable_elimination<true>, cds::opt::lock_type<std::mutex>>::type>
        deque_type;
...
TEST_F(FCDeque, boost_mutex_multi_mutex_multi_condvar)
{
    typedef cds::container::FCDeque<
        int, boost::container::deque<int>,
        cds::container::fcdeque::make_traits<
            cds::opt::enable_elimination<true>, cds::opt::lock_type<std::mutex>,
