...
class IntrusiveSplitLazySet : public cds_test::intrusive_set_rcu {
  ...
  public:
    ...
    typedef typename base_class::base_int_item<ci::split_list::node<ci::lazy_list::node<rcu_type, std::mutex>>>
    ...
    typedef typename base_class::member_int_item<ci::split_list::node<ci::lazy_list::node<rcu_type, std::mutex>>>
...
TYPED_TEST_P(IntrusiveSplitLazySet, base_cmp)
{
    ...
    typedef ci::LazyList<
        rcu_type, base_item_type,
        typename ci::lazy_list::make_traits<ci::opt::hook<ci::lazy_list::base_hook<ci::opt::gc<rcu_type>>>,
                                            ci::opt::compare<item_cmp>, ci::opt::disposer<mock_disposer>>::type>
        bucket_type;

    typedef ci::SplitListSet<rcu_type, bucket_type, typename ci::split_list::make_traits<ci::opt::hash<hash_int>>::type>
        set_type;
...
TYPED_TEST_P(IntrusiveSplitLazySet, base_less)
{
    ...
    typedef ci::LazyList<
        rcu_type, base_item_type,
        typename ci::lazy_list::make_traits<ci::opt::hook<ci::lazy_list::base_hook<ci::opt::gc<rcu_type>>>,
                                            ci::opt::less<item_less>, ci::opt::disposer<mock_disposer>>::type>
        bucket_type;

    typedef ci::SplitListSet<rcu_type, bucket_type,
                             typename ci::split_list::make_traits<
                                 ci::opt::hash<hash_int>, ci::opt::item_counter<cds::atomicity::item_counter>>::type>
        set_type;
...
TYPED_TEST_P(IntrusiveSplitLazySet, member_cmp)
{
    ...
    typedef ci::LazyList<
        rcu_type, member_item_type,
        typename ci::lazy_list::make_traits<
            ci::opt::hook<ci::lazy_list::member_hook<offsetof(member_item_type, hMember), ci::opt::gc<rcu_type>>>,
            ci::opt::compare<item_cmp>, ci::opt::disposer<mock_disposer>>::type>
        bucket_type;
...
TYPED_TEST_P(IntrusiveSplitLazySet, member_less)
{
    ...
    typedef ci::SplitListSet<
        rcu_type, bucket_type,
        typename ci::split_list::make_traits<ci::opt::hash<hash_int>, ci::opt::back_off<cds::backoff::pause>>::type>
        set_type;
...
TYPED_TEST_P(IntrusiveSplitLazySet, member_mutex)
{
    ...
    struct list_traits : public ci::lazy_list::traits {
        typedef ci::lazy_list::member_hook<offsetof(member_mutex_item_type, hMember), ci::opt::gc<rcu_type>,
...
REGISTER_TYPED_TEST_CASE_P(IntrusiveSplitLazySet, base_cmp, base_less, base_cmpmix, base_mutex,
                           base_static_bucket_table, base_static_bucket_table_free_list, base_free_list, member_cmp,
                           member_less, member_cmpmix, member_mutex, member_static_bucket_table,
                           member_static_bucket_table_free_list, member_free_list);
