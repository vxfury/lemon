...
TEST_F(IntrusiveSplitListLazySet_DHP, base_static_bucket_table)
{
    ...
    typedef ci::SplitListSet<
        gc_type, bucket_type,
        ci::split_list::make_traits<ci::opt::hash<hash_int>, ci::opt::item_counter<cds::atomicity::item_counter>,
                                    ci::split_list::dynamic_bucket_table<false>>::type>
        set_type;
...
TEST_F(IntrusiveSplitListLazySet_DHP, base_free_list)
{
    ...
    typedef ci::SplitListSet<
        gc_type, bucket_type,
        ci::split_list::make_traits<ci::opt::hash<hash_int>, ci::opt::item_counter<cds::atomicity::item_counter>,
                                    ci::opt::free_list<ci::FreeList>>::type>
        set_type;
...
TEST_F(IntrusiveSplitListLazySet_DHP, base_static_bucket_table_free_list)
{
    ...
    typedef ci::SplitListSet<gc_type, bucket_type,
                             ci::split_list::make_traits<
                                 ci::opt::hash<hash_int>, ci::opt::item_counter<cds::atomicity::item_counter>,
                                 ci::split_list::dynamic_bucket_table<false>, ci::opt::free_list<ci::FreeList>>::type>
        set_type;
