...
TYPED_TEST_P(IntrusiveFeldmanHashSet, less)
{
    typedef ci::FeldmanHashSet<
        typename TestFixture::rcu_type, typename TestFixture::int_item,
        typename ci::feldman_hashset::make_traits<
            ci::feldman_hashset::hash_accessor<typename TestFixture::hash_accessor>, ci::opt::less<std::less<int>>,
            ci::opt::disposer<typename TestFixture::mock_disposer>>::type>
        set_type;
...
TYPED_TEST_P(IntrusiveFeldmanHashSet, explicit_hash_size)
{
    struct traits : public ci::feldman_hashset::traits {
        ...
        enum : size_t { hash_size = sizeof(std::declval<typename TestFixture::key_val>().nKey) };
...
REGISTER_TYPED_TEST_CASE_P(IntrusiveFeldmanHashSet, compare, less, cmpmix, backoff, stat, explicit_hash_size, byte_cut,
                           byte_cut_explicit_hash_size);
