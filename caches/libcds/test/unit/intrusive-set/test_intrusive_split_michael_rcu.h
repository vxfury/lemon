...
class IntrusiveSplitMichaelSet : public cds_test::intrusive_set_rcu {
  ...
  public:
    ...
    typedef typename base_class::member_int_item<ci::split_list::node<ci::michael_list::node<rcu_type>>>
        member_item_type;
...
TYPED_TEST_P(IntrusiveSplitMichaelSet, base_cmp)
{
    ...
    typedef ci::MichaelList<
        ...
        typename ci::michael_list::make_traits<ci::opt::hook<ci::michael_list::base_hook<ci::opt::gc<rcu_type>>>,
...
TYPED_TEST_P(IntrusiveSplitMichaelSet, member_cmp)
{
    ...
    typedef ci::MichaelList<
        ...
        typename ci::michael_list::make_traits<
            ci::opt::hook<ci::michael_list::member_hook<offsetof(member_item_type, hMember), ci::opt::gc<rcu_type>>>,
            ci::opt::compare<item_cmp>, ci::opt::disposer<mock_disposer>>::type>
        bucket_type;
...
REGISTER_TYPED_TEST_CASE_P(IntrusiveSplitMichaelSet, base_cmp, base_less, base_cmpmix, base_static_bucket_table,
                           base_static_bucket_table_free_list, base_free_list, base_bit_reverse_swar,
                           base_bit_reverse_lookup, base_bit_reverse_muldiv, member_cmp, member_less, member_cmpmix,
                           member_static_bucket_table, member_static_bucket_table_free_list, member_free_list);
