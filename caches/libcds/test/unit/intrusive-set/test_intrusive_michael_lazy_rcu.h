...
TYPED_TEST_P(IntrusiveMichaelLazySet, base_cmp)
{
    ...
    typedef ci::MichaelHashSet<rcu_type, bucket_type,
                               typename ci::michael_set::make_traits<ci::opt::hash<hash_int>>::type>
        set_type;
...
REGISTER_TYPED_TEST_CASE_P(IntrusiveMichaelLazySet, base_cmp, base_less, base_cmpmix, base_mutex, base_stat,
                           base_wrapped_stat, member_cmp, member_less, member_cmpmix, member_mutex, member_stat,
                           member_wrapped_stat);
