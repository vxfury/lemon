...
#define TEST_32BIT(x)                          \
    TEST_F(bit_reversal32, x)                  \
    {                                          \
        test<cds::algo::bit_reversal::x>();    \
    }                                          \
    TEST_F(bit_reversal32, x##_eq)             \
    {                                          \
        test_eq<cds::algo::bit_reversal::x>(); \
    }

#define TEST_64BIT(x)                          \
    TEST_F(bit_reversal64, x)                  \
    {                                          \
        test<cds::algo::bit_reversal::x>();    \
    }                                          \
    TEST_F(bit_reversal64, x##_eq)             \
    {                                          \
        test_eq<cds::algo::bit_reversal::x>(); \
    }
