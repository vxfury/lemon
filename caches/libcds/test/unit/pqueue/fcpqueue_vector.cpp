...
TEST_F(FCPQueue, vector_empty_wait_strategy)
{
    ...
    typedef cds::container::FCPriorityQueue<value_type, std::priority_queue<value_type, std::vector<value_type>, less>,
                                            pqueue_traits>
        pqueue_type;
...
TEST_F(FCPQueue, vector_mutex)
{
    typedef cds::container::FCPriorityQueue<
        value_type, std::priority_queue<value_type>,
...
TEST_F(FCPQueue, vector_single_mutex_single_condvar)
{
    typedef cds::container::FCPriorityQueue<
        ...
        cds::container::fcpqueue::make_traits<
            ...
            cds::opt::wait_strategy<cds::algo::flat_combining::wait_strategy::single_mutex_single_condvar<1000>>>::type>
        pqueue_type;
