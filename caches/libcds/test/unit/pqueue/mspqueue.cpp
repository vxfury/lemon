  ...
  protected:
    ...
    void test(PQueue &pq)
    {
        ...
        for (value_type *p = pFirst; p < pLast; ++p) {
            switch (pq.size() & 3) {
                case 0:
                    ASSERT_TRUE(pq.push_with([p](value_type &dest) {
                        dest = *p;
                    }));
                    break;
                case 1:
        ...
        while (pq.size() > 1) {
            if (pq.size() & 1) {
                ...
                ASSERT_TRUE(pq.pop_with([&key](value_type &src) {
                    key = src.k;
                }));
...
{
    typedef cds::container::MSPriorityQueue<
        MSPQueue::value_type, cds::container::mspriority_queue::make_traits<cds::opt::buffer<dyn_buffer_type> >::type>
        pqueue;
...
{
    typedef cds::container::MSPriorityQueue<
        value_type, cds::container::mspriority_queue::make_traits<cds::opt::buffer<dyn_buffer_type>,
                                                                  cds::opt::compare<compare> >::type>
        pqueue;
...
TEST_F(MSPQueue, dynamic_less)
{
    typedef cds::container::MSPriorityQueue<
        value_type,
        cds::container::mspriority_queue::make_traits<cds::opt::buffer<dyn_buffer_type>, cds::opt::less<less> >::type>
        pqueue;
...
TEST_F(MSPQueue, dynamic_mutex)
{
    typedef cds::container::MSPriorityQueue<
        value_type,
        cds::container::mspriority_queue::make_traits<cds::opt::buffer<dyn_buffer_type>, cds::opt::compare<compare>,
...
{
    typedef cds::container::MSPriorityQueue<MSPQueue::value_type, cds::container::mspriority_queue::make_traits<
                                                                      cds::opt::buffer<static_buffer_type> >::type>
        pqueue;
...
{
    typedef cds::container::MSPriorityQueue<
        value_type, cds::container::mspriority_queue::make_traits<cds::opt::buffer<static_buffer_type>,
                                                                  cds::opt::compare<compare> >::type>
        pqueue;
...
{
    typedef cds::container::MSPriorityQueue<value_type, cds::container::mspriority_queue::make_traits<
                                                            cds::opt::buffer<static_buffer_type>, cds::opt::less<less>,
                                                            cds::opt::lock_type<std::mutex> >::type>
        pqueue;
