...
{
    typedef cds::intrusive::MSPriorityQueue<
        value_type, cds::intrusive::mspriority_queue::make_traits<cds::opt::buffer<dyn_buffer_type>,
                                                                  cds::opt::less<std::less<value_type> > >::type>
        pqueue;
...
TEST_F(IntrusiveMSPQueue, dynamic_cmp_less)
{
    typedef cds::intrusive::MSPriorityQueue<
        value_type, cds::intrusive::mspriority_queue::make_traits<cds::opt::buffer<dyn_buffer_type>,
                                                                  ...
                                                                  cds::opt::compare<IntrusiveMSPQueue::compare> >::type>
        pqueue;
...
{
    typedef cds::intrusive::MSPriorityQueue<
        value_type, cds::intrusive::mspriority_queue::make_traits<cds::opt::buffer<static_buffer_type>,
