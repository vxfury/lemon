...
TYPED_TEST_P(MichaelSet, compare)
{
    ...
    typedef cc::MichaelHashSet<
        rcu_type, list_type,
        typename cc::michael_set::make_traits<cds::opt::hash<typename TestFixture::hash_int> >::type>
        set_type;
...
REGISTER_TYPED_TEST_CASE_P(MichaelSet, compare, less, cmpmix, item_counting, backoff, seq_cst, stat, wrapped_stat);
