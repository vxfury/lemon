        ...
        for (auto idx : indices) {
            ...
            switch (idx % 11) {
                ...
                case 1:
                    ...
                    break;
                case 2:
                    EXPECT_TRUE(s.insert(i, [](value_type &v) {
                        ++v.nFindCount;
                    }));
                    EXPECT_FALSE(s.insert(i, [](value_type &v) {
                        ++v.nFindCount;
                    }));
                    ...
                    break;
                case 3:
                    EXPECT_TRUE(s.insert(i.key(), [](value_type &v) {
                        ++v.nFindCount;
                    }));
                    EXPECT_FALSE(s.insert(i.key(), [](value_type &v) {
                        ++v.nFindCount;
                    }));
                    EXPECT_TRUE(s.find(i.nKey, [](value_type const &v, int key) {
                        EXPECT_EQ(v.key(), key);
