...
TYPED_TEST_P(SplitListLazySet, compare)
{
    ...
    typedef cc::SplitListSet<
        rcu_type, int_item,
        typename cc::split_list::make_traits<cc::split_list::ordered_list<cc::lazy_list_tag>, cds::opt::hash<hash_int>,
                                             cc::split_list::ordered_list_traits<typename cc::lazy_list::make_traits<
                                                 cds::opt::compare<typename TestFixture::cmp> >::type> >::type>
        set_type;
...
TYPED_TEST_P(SplitListLazySet, less)
{
    ...
    typedef cc::SplitListSet<
        ...
        typename cc::split_list::make_traits<cc::split_list::ordered_list<cc::lazy_list_tag>, cds::opt::hash<hash_int>,
                                             cc::split_list::ordered_list_traits<typename cc::lazy_list::make_traits<
                                                 cds::opt::less<typename TestFixture::less> >::type> >::type>
        set_type;
...
TYPED_TEST_P(SplitListLazySet, free_list)
{
    ...
    typedef cc::SplitListSet<
        ...
        typename cc::split_list::make_traits<cc::split_list::ordered_list<cc::lazy_list_tag>, cds::opt::hash<hash_int>,
                                             cc::split_list::ordered_list_traits<typename cc::lazy_list::make_traits<
                                                 cds::opt::less<typename TestFixture::less> >::type>,
                                             cds::opt::free_list<cds::intrusive::FreeList> >::type>
        set_type;
...
REGISTER_TYPED_TEST_CASE_P(SplitListLazySet, compare, less, cmpmix, item_counting, stat, back_off, mutex,
                           static_bucket_table, free_list, static_bucket_table_free_list);
