...
{
    typedef cc::IterableList<gc_type, int_item, typename cc::iterable_list::make_traits<cds::opt::compare<cmp> >::type>
        list_type;
...
TEST_F(MichaelIterableSet_HP, less)
{
    typedef cc::IterableList<gc_type, int_item,
                             typename cc::iterable_list::make_traits<cds::opt::less<base_class::less> >::type>
        list_type;
