...
TYPED_TEST_P(FeldmanHashSet, defaulted)
{
    ...
    typedef cc::FeldmanHashSet<
        rcu_type, int_item,
        typename cc::feldman_hashset::make_traits<cc::feldman_hashset::hash_accessor<get_hash>>::type>
        set_type;
...
TYPED_TEST_P(FeldmanHashSet, compare)
{
    ...
    typedef cc::FeldmanHashSet<
        rcu_type, int_item,
        typename cc::feldman_hashset::make_traits<cc::feldman_hashset::hash_accessor<get_hash>,
...
TYPED_TEST_P(FeldmanHashSet, less)
{
    ...
    typedef cc::FeldmanHashSet<rcu_type, int_item,
                               typename cc::feldman_hashset::make_traits<cc::feldman_hashset::hash_accessor<get_hash>,
                                                                         cds::opt::less<std::less<int>>>::type>
        set_type;
...
TYPED_TEST_P(FeldmanHashSet, cmpmix)
{
    ...
    typedef cc::FeldmanHashSet<rcu_type, int_item,
                               typename cc::feldman_hashset::make_traits<
                                   cc::feldman_hashset::hash_accessor<get_hash>, cds::opt::less<std::less<int>>,
                                   cds::opt::compare<typename TestFixture::cmp>>::type>
        set_type;
...
TYPED_TEST_P(FeldmanHashSet, explicit_hash_size)
{
    ...
    struct set_traits : public cc::feldman_hashset::traits {
        enum : size_t { hash_size = sizeof(std::declval<int_item>().nKey) };
...
REGISTER_TYPED_TEST_CASE_P(FeldmanHashSet, defaulted, compare, less, cmpmix, item_counting, backoff, stat,
                           explicit_hash_size, byte_cut, byte_cut_explicit_hash_size);
} // namespace
