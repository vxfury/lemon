...
TEST_F(IntrusiveTreiberStack_HP, relaxed)
{
    typedef cds::intrusive::TreiberStack<
        ...
        typename ci::treiber_stack::make_traits<ci::opt::memory_model<ci::opt::v::relaxed_ordering>>::type>
        stack_type;
...
TEST_F(IntrusiveTreiberStack_HP, elimination)
{
    typedef cds::intrusive::TreiberStack<
        gc_type, base_hook_item<gc_type>,
        typename ci::treiber_stack::make_traits<cds::opt::enable_elimination<true>>::type>
        stack_type;
