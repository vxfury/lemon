  ...
  protected:
    ...
    void test()
    {
        ...
        stack.apply([&sum](underlying_stack_type &stack) {
            for (auto const &el : stack) sum += el.nVal;
        });
        EXPECT_EQ(sum, 6);
...
TEST_F(IntrusiveFCStack, slist_elimination_disposer)
{
    ...
    struct stack_traits
        : public cds::intrusive::fcstack::make_traits<
              cds::opt::enable_elimination<true>, cds::intrusive::opt::disposer<mock_disposer>,
...
{
    typedef base_hook_item<boost::intrusive::slist_base_hook<>> value_type;
    typedef cds::intrusive::FCStack<
        value_type, boost::intrusive::slist<value_type>,
        cds::intrusive::fcstack::make_traits<
            cds::opt::enable_elimination<true>, cds::opt::stat<cds::intrusive::fcstack::stat<>>,
...
TEST_F(IntrusiveFCStack, slist_member_empty_wait_strategy)
{
    ...
    typedef cds::intrusive::FCStack<value_type, boost::intrusive::slist<value_type, member_option>, stack_traits>
        stack_type;
    test<stack_type>();
}
...
TEST_F(IntrusiveFCStack, slist_member_elimination_stat)
{
    ...
    typedef cds::intrusive::FCStack<
        value_type, boost::intrusive::slist<value_type, member_option>,
        cds::intrusive::fcstack::make_traits<
            cds::opt::enable_elimination<true>, cds::opt::stat<cds::intrusive::fcstack::stat<>>,
            cds::opt::wait_strategy<cds::algo::flat_combining::wait_strategy::single_mutex_multi_condvar<>>>::type>
        stack_type;
...
TEST_F(IntrusiveFCStack, list_mutex)
{
    ...
    typedef cds::intrusive::FCStack<value_type, boost::intrusive::list<value_type>,
                                    cds::intrusive::fcstack::make_traits<cds::opt::lock_type<std::mutex>>::type>
        stack_type;
    test<stack_type>();
}
...
TEST_F(IntrusiveFCStack, list_elimination_stat)
{
    typedef base_hook_item<boost::intrusive::list_base_hook<>> value_type;
    typedef cds::intrusive::FCStack<
        value_type, boost::intrusive::list<value_type>,
        cds::intrusive::fcstack::make_traits<
            cds::opt::enable_elimination<true>, cds::opt::stat<cds::intrusive::fcstack::stat<>>,
            cds::opt::wait_strategy<cds::algo::flat_combining::wait_strategy::multi_mutex_multi_condvar<>>>::type>
        stack_type;
