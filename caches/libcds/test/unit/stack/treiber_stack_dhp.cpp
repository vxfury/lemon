...
TEST_F(TreiberStack_DHP, backoff)
{
    typedef cc::TreiberStack<gc_type, int,
                             typename cc::treiber_stack::make_traits<cds::opt::back_off<cds::backoff::yield>>::type>
        stack_type;
...
TEST_F(TreiberStack_DHP, alloc)
{
    ...
    typedef cc::TreiberStack<
        gc_type, int,
        typename cc::treiber_stack::make_traits<cds::opt::back_off<cds::backoff::pause>,
                                                cds::opt::memory_model<cds::opt::v::relaxed_ordering>,
                                                cds::opt::allocator<std::allocator<foo>>>::type>
        stack_type;
...
{
    typedef cc::TreiberStack<gc_type, int,
                             typename cc::treiber_stack::make_traits<cds::opt::enable_elimination<true>>::type>
        stack_type;
...
TEST_F(TreiberStack_DHP, elimination_dynamic)
{
    typedef cc::TreiberStack<gc_type, int,
                             typename cc::treiber_stack::make_traits<
                                 ...
                                 cds::opt::buffer<cds::opt::v::initialized_dynamic_buffer<void *>>>::type>
        stack_type;
...
{
    typedef cc::TreiberStack<gc_type, int,
                             typename cc::treiber_stack::make_traits<cds::opt::enable_elimination<true>,
                                                                     cds::opt::stat<cc::treiber_stack::stat<>>>::type>
        stack_type;
