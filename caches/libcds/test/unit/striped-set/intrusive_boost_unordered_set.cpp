...
struct dyn_buffer : public ci::opt::v::initialized_dynamic_buffer<T, Alloc> {
  ...
  public:
    ...
    dyn_buffer() : base_class(Capacity) {}
};

TEST_F(IntrusiveStripedBoostUnorderedSet, basehook)
{
    typedef ci::StripedSet<bi::unordered_set<base_item, bi::hash<hash1>, bi::equal<equal_to<base_item>>,
                                             bi::power_2_buckets<true>, bi::incremental<true>>,
...
TEST_F(IntrusiveStripedBoostUnorderedSet, basehook_resize_bucket_threshold)
{
    typedef ci::StripedSet<
        bi::unordered_set<base_item, bi::hash<hash1>, bi::equal<equal_to<base_item>>, bi::power_2_buckets<true>,
                          bi::incremental<true>>,
        cds::intrusive::opt::hash<hash2>,
...
TEST_F(IntrusiveStripedBoostUnorderedSet, basehook_resize_bucket_threshold_rt)
{
    typedef ci::StripedSet<bi::unordered_set<base_item, bi::hash<hash1>, bi::equal<equal_to<base_item>>,
                                             bi::power_2_buckets<true>, bi::incremental<true>>,
                           ci::opt::hash<hash2>, ci::opt::buffer<dyn_buffer<64, cds::any_type>>,
...
TEST_F(IntrusiveStripedBoostUnorderedSet, memberhook)
{
    typedef ci::StripedSet<
        bi::unordered_set<
            member_item, bi::member_hook<member_item, bi::unordered_set_member_hook<>, &member_item::hMember>,
            bi::hash<hash1>, bi::equal<equal_to<member_item>>, bi::power_2_buckets<true>, bi::incremental<true>>,
        cds::intrusive::opt::hash<hash2>>
        set_type;
...
TEST_F(IntrusiveStripedBoostUnorderedSet, refinable_basehook)
{
    typedef ci::StripedSet<bi::unordered_set<base_item, bi::hash<hash1>, bi::equal<equal_to<base_item>>,
                                             bi::power_2_buckets<true>, bi::incremental<true>>,
                           cds::intrusive::opt::hash<hash2>, ci::opt::mutex_policy<ci::striped_set::refinable<>>>
        set_type;
...
TEST_F(IntrusiveStripedBoostUnorderedSet, refinable_basehook_resize_bucket_threshold)
{
    typedef ci::StripedSet<
        bi::unordered_set<base_item, bi::hash<hash1>, bi::equal<equal_to<base_item>>, bi::power_2_buckets<true>,
                          bi::incremental<true>>,
        ci::opt::mutex_policy<ci::striped_set::refinable<>>, cds::intrusive::opt::hash<hash2>,
        cds::intrusive::opt::buffer<cds::intrusive::opt::v::initialized_static_buffer<cds::any_type, 64>>,
        cds::intrusive::opt::resizing_policy<ci::striped_set::single_bucket_size_threshold<256>>>
        set_type;
...
TEST_F(IntrusiveStripedBoostUnorderedSet, refinable_basehook_resize_bucket_threshold_rt)
{
    typedef ci::StripedSet<bi::unordered_set<base_item, bi::hash<hash1>, bi::equal<equal_to<base_item>>,
                                             bi::power_2_buckets<true>, bi::incremental<true>>,
                           ci::opt::hash<hash2>, ci::opt::mutex_policy<ci::striped_set::refinable<>>,
