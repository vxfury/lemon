...
struct test_traits {
    ...
    typedef bi::set<base_item, bi::compare<cds_test::intrusive_set::less<base_item>>
                                   CDS_BOOST_INTRUSIVE_KEY_OF_VALUE_OPTION(base_item)>
        base_hook_container;

    typedef bi::set<member_item, bi::member_hook<member_item, bi::set_member_hook<>, &member_item::hMember>,
                    bi::compare<cds_test::intrusive_set::less<member_item>> CDS_BOOST_INTRUSIVE_KEY_OF_VALUE_OPTION(
                        member_item)>
