...
struct test_traits {
    ...
    typedef bi::treap_set<base_item, bi::compare<cds_test::intrusive_set::less<base_item>>,
                          bi::priority<priority_cmp<base_item>>>
        base_hook_container;

    typedef bi::treap_set<member_item, bi::member_hook<member_item, bi::bs_set_member_hook<>, &member_item::hMember>,
