...
TEST_F(CuckooSet, striped_list_ordered_cmp)
{
    typedef cc::CuckooSet<int_item,
                          cc::cuckoo::make_traits<cds::opt::hash<std::tuple<hash1, hash2>>, cds::opt::compare<cmp>,
                                                  cc::cuckoo::probeset_type<cc::cuckoo::list>>::type>
        set_type;
...
TEST_F(CuckooSet, striped_vector_ordered_cmp)
{
    typedef cc::CuckooSet<int_item,
                          cc::cuckoo::make_traits<cds::opt::hash<std::tuple<hash1, hash2>>, cds::opt::compare<cmp>,
                                                  cc::cuckoo::probeset_type<cc::cuckoo::vector<8>>>::type>
        set_type;
...
{
    typedef cc::CuckooSet<int_item,
                          cc::cuckoo::make_traits<cds::opt::hash<std::tuple<hash1, hash2>>, cds::opt::less<less>,
                                                  cc::cuckoo::probeset_type<cc::cuckoo::list>>::type>
        set_type;
...
TEST_F(CuckooSet, striped_vector_ordered_less)
{
    typedef cc::CuckooSet<int_item,
                          cc::cuckoo::make_traits<cds::opt::hash<std::tuple<hash1, hash2>>, cds::opt::less<less>,
                                                  cc::cuckoo::probeset_type<cc::cuckoo::vector<6>>>::type>
        set_type;
...
{
    typedef cc::CuckooSet<
        int_item, cc::cuckoo::make_traits<cds::opt::hash<std::tuple<hash1, hash2>>, cds::opt::less<less>,
                                          cds::opt::compare<cmp>, cc::cuckoo::probeset_type<cc::cuckoo::list>>::type>
        set_type;
...
{
    typedef cc::CuckooSet<int_item, cc::cuckoo::make_traits<cds::opt::hash<std::tuple<hash1, hash2>>,
                                                            cds::opt::less<less>, cds::opt::compare<cmp>,
                                                            cc::cuckoo::probeset_type<cc::cuckoo::vector<6>>>::type>
        set_type;
...
TEST_F(CuckooSet, striped_list_ordered_stat)
{
    typedef cc::CuckooSet<
        int_item,
        cc::cuckoo::make_traits<cds::opt::hash<std::tuple<hash1, hash2>>, cds::opt::less<less>, cds::opt::compare<cmp>,
                                cds::opt::stat<cc::cuckoo::stat>, cc::cuckoo::probeset_type<cc::cuckoo::list>>::type>
        set_type;
...
TEST_F(CuckooSet, striped_vector_ordered_stat)
{
    typedef cc::CuckooSet<int_item,
                          cc::cuckoo::make_traits<cds::opt::hash<std::tuple<hash1, hash2>>, cds::opt::less<less>,
                                                  cds::opt::compare<cmp>, cds::opt::stat<cc::cuckoo::stat>,
                                                  cc::cuckoo::probeset_type<cc::cuckoo::vector<8>>>::type>
        set_type;
...
TEST_F(CuckooSet, striped_list_ordered_storehash)
{
    typedef cc::CuckooSet<
        int_item,
        cc::cuckoo::make_traits<cds::opt::hash<std::tuple<hash1, hash2>>, cds::opt::less<less>, cds::opt::compare<cmp>,
                                cc::cuckoo::probeset_type<cc::cuckoo::list>, cc::cuckoo::store_hash<true>>::type>
        set_type;
...
TEST_F(CuckooSet, striped_vector_ordered_storehash)
{
    typedef cc::CuckooSet<
        int_item,
        cc::cuckoo::make_traits<cds::opt::hash<std::tuple<hash1, hash2>>, cds::opt::less<less>, cds::opt::compare<cmp>,
                                cc::cuckoo::probeset_type<cc::cuckoo::vector<6>>, cc::cuckoo::store_hash<true>>::type>
        set_type;
...
{
    typedef cc::CuckooSet<
        int_item, cc::cuckoo::make_traits<cds::opt::hash<std::tuple<hash1, hash2>>,
                                          cds::opt::mutex_policy<cc::cuckoo::refinable<>>, cds::opt::compare<cmp>,
                                          cc::cuckoo::probeset_type<cc::cuckoo::list>>::type>
        set_type;
...
{
    typedef cc::CuckooSet<int_item,
                          cc::cuckoo::make_traits<cds::opt::hash<std::tuple<hash1, hash2>>,
                                                  cds::opt::mutex_policy<cc::cuckoo::refinable<>>, cds::opt::less<less>,
                                                  cc::cuckoo::probeset_type<cc::cuckoo::list>>::type>
        set_type;
...
TEST_F(CuckooSet, refinable_list_ordered_storehash)
{
    typedef cc::CuckooSet<int_item,
                          cc::cuckoo::make_traits<cds::opt::hash<std::tuple<hash1, hash2>>,
                                                  cds::opt::mutex_policy<cc::cuckoo::refinable<>>, cds::opt::less<less>,
                                                  cds::opt::compare<cmp>, cc::cuckoo::probeset_type<cc::cuckoo::list>,
                                                  cc::cuckoo::store_hash<true>>::type>
        set_type;
...
TEST_F(CuckooSet, refinable_vector_ordered_storehash)
{
    typedef cc::CuckooSet<
        int_item, cc::cuckoo::make_traits<cds::opt::hash<std::tuple<hash1, hash2>>,
                                          cds::opt::mutex_policy<cc::cuckoo::refinable<>>, cds::opt::less<less>,
                                          cds::opt::compare<cmp>, cc::cuckoo::probeset_type<cc::cuckoo::vector<6>>,
                                          cc::cuckoo::store_hash<true>>::type>
        set_type;
