...
class container_set : public fixture {
  public:
    ...
    struct int_item : public stat {
        ...
        int_item(int_item const &src) : stat(src), nKey(src.nKey), nVal(src.nVal), strVal(src.strVal) {}

        int_item(int_item &&src) : stat(src), nKey(src.nKey), nVal(src.nVal), strVal(std::move(src.strVal)) {}
