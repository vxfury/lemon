...
TEST_F(IntrusiveCuckooSet, striped_list_basehook_ordered_cmp)
{
    ...
    typedef ci::CuckooSet<item_type,
                          ci::cuckoo::make_traits<
                              ci::opt::hook<ci::cuckoo::base_hook<ci::cuckoo::probeset_type<item_type::probeset_type>>>,
                              ci::opt::hash<std::tuple<hash1, hash2>>, ci::opt::compare<cmp<item_type>>,
...
TEST_F(IntrusiveCuckooSet, striped_list_basehook_ordered_less)
{
    ...
    typedef ci::CuckooSet<item_type,
                          ci::cuckoo::make_traits<
                              ci::opt::hook<ci::cuckoo::base_hook<ci::cuckoo::probeset_type<item_type::probeset_type>>>,
                              ci::opt::hash<std::tuple<hash1, hash2>>, ci::opt::less<less<item_type>>,
                              ci::opt::disposer<mock_disposer>>::type>
        set_type;
...
TEST_F(IntrusiveCuckooSet, striped_list_basehook_ordered_cmpmix)
{
    ...
    typedef ci::CuckooSet<item_type,
                          ci::cuckoo::make_traits<
                              ci::opt::hook<ci::cuckoo::base_hook<ci::cuckoo::probeset_type<item_type::probeset_type>>>,
                              ci::opt::hash<std::tuple<hash1, hash2>>, ci::opt::less<less<item_type>>,
                              ci::opt::compare<cmp<item_type>>, ci::opt::disposer<mock_disposer>>::type>
        set_type;
...
TEST_F(IntrusiveCuckooSet, striped_list_basehook_ordered_stat)
{
    ...
    typedef ci::CuckooSet<
        item_type,
        ci::cuckoo::make_traits<
            ci::opt::hook<ci::cuckoo::base_hook<ci::cuckoo::probeset_type<item_type::probeset_type>>>,
            ci::opt::hash<std::tuple<hash1, hash2>>, ci::opt::less<less<item_type>>, ci::opt::compare<cmp<item_type>>,
            ci::opt::stat<ci::cuckoo::stat>, ci::opt::disposer<mock_disposer>>::type>
        set_type;
...
TEST_F(IntrusiveCuckooSet, striped_list_basehook_unordered_storehash)
{
    ...
    struct set_traits : public ci::cuckoo::traits {
        typedef ci::cuckoo::base_hook<ci::cuckoo::probeset_type<item_type::probeset_type>,
...
TEST_F(IntrusiveCuckooSet, striped_list_basehook_ordered_storehash)
{
    ...
    typedef ci::CuckooSet<item_type,
                          ci::cuckoo::make_traits<
                              ci::opt::hook<ci::cuckoo::base_hook<ci::cuckoo::probeset_type<item_type::probeset_type>,
                                                                  ci::cuckoo::store_hash<item_type::hash_array_size>>>,
                              cds::opt::hash<std::tuple<hash1, hash2>>, cds::opt::less<less<item_type>>,
                              cds::opt::compare<cmp<item_type>>, ci::opt::disposer<mock_disposer>>::type>
        set_type;
...
TEST_F(IntrusiveCuckooSet, refinable_list_basehook_ordered_cmp)
{
    ...
    typedef ci::CuckooSet<item_type,
                          ci::cuckoo::make_traits<
                              ci::opt::hook<ci::cuckoo::base_hook<ci::cuckoo::probeset_type<item_type::probeset_type>>>,
                              ci::opt::mutex_policy<ci::cuckoo::refinable<>>, ci::opt::hash<std::tuple<hash1, hash2>>,
                              ci::opt::compare<cmp<item_type>>, ci::opt::disposer<mock_disposer>>::type>
        set_type;
...
TEST_F(IntrusiveCuckooSet, refinable_list_basehook_ordered_less)
{
    ...
    typedef ci::CuckooSet<item_type,
                          ci::cuckoo::make_traits<
                              ci::opt::hook<ci::cuckoo::base_hook<ci::cuckoo::probeset_type<item_type::probeset_type>>>,
                              ci::opt::mutex_policy<ci::cuckoo::refinable<>>, ci::opt::hash<std::tuple<hash1, hash2>>,
                              ci::opt::less<less<item_type>>, ci::opt::disposer<mock_disposer>>::type>
        set_type;
...
TEST_F(IntrusiveCuckooSet, refinable_list_basehook_ordered_cmpmix)
{
    ...
    typedef ci::CuckooSet<
        ...
        ci::cuckoo::make_traits<
            ci::opt::hook<ci::cuckoo::base_hook<ci::cuckoo::probeset_type<item_type::probeset_type>>>,
            ci::opt::mutex_policy<ci::cuckoo::refinable<>>, ci::opt::hash<std::tuple<hash1, hash2>>,
            ci::opt::less<less<item_type>>, ci::opt::compare<cmp<item_type>>, ci::opt::disposer<mock_disposer>>::type>
        set_type;
...
TEST_F(IntrusiveCuckooSet, refinable_list_basehook_ordered_stat)
{
    ...
    typedef ci::CuckooSet<item_type,
                          ci::cuckoo::make_traits<
                              ci::opt::hook<ci::cuckoo::base_hook<ci::cuckoo::probeset_type<item_type::probeset_type>>>,
                              ci::opt::mutex_policy<ci::cuckoo::refinable<>>, ci::opt::hash<std::tuple<hash1, hash2>>,
                              ci::opt::less<less<item_type>>, ci::opt::compare<cmp<item_type>>,
                              ci::opt::stat<ci::cuckoo::stat>, ci::opt::disposer<mock_disposer>>::type>
        set_type;
...
TEST_F(IntrusiveCuckooSet, refinable_list_basehook_ordered_storehash)
{
    ...
    typedef ci::CuckooSet<
        ...
        ci::cuckoo::make_traits<
            ci::opt::hook<ci::cuckoo::base_hook<ci::cuckoo::probeset_type<item_type::probeset_type>,
                                                ci::cuckoo::store_hash<item_type::hash_array_size>>>,
            ci::opt::mutex_policy<ci::cuckoo::refinable<>>, cds::opt::hash<std::tuple<hash1, hash2>>,
            cds::opt::less<less<item_type>>, cds::opt::compare<cmp<item_type>>, ci::opt::disposer<mock_disposer>>::type>
        set_type;
    ...
    typedef ci::CuckooSet<
        ...
        ci::cuckoo::make_traits<
            ci::opt::hook<ci::cuckoo::member_hook<offsetof(item_type, hMember),
                                                  ci::cuckoo::probeset_type<item_type::member_type::probeset_type>>>,
            ci::opt::mutex_policy<ci::cuckoo::refinable<>>, ci::opt::hash<std::tuple<hash1, hash2>>,
            ci::opt::less<less<item_type>>, ci::opt::compare<cmp<item_type>>, ci::opt::stat<ci::cuckoo::stat>,
            ci::opt::disposer<mock_disposer>>::type>
        set_type;
