        ...
        for (auto idx : indices) {
            ...
            switch (idx % 8) {
                case 0:
                    ...
                    updResult = s.update(
                        i,
                        [](bool bNew, value_type &val, value_type const &arg) {
                            EXPECT_FALSE(bNew);
                ...
                case 1:
                    ...
                    updResult = s.update(
                        i.key(),
                        [](bool bNew, value_type &val, int arg) {
                            EXPECT_FALSE(bNew);
                    ...
                    break;
                case 2:
                    ASSERT_TRUE(s.insert(i, [](value_type &v) {
                        ++v.nFindCount;
                    }));
                    ASSERT_FALSE(s.insert(i, [](value_type &v) {
                        ++v.nFindCount;
                    }));
                    ...
                    break;
                case 3:
                    ASSERT_TRUE(s.insert(i.key(), [](value_type &v) {
                        ++v.nFindCount;
                    }));
                    ASSERT_FALSE(s.insert(i.key(), [](value_type &v) {
                        ++v.nFindCount;
                    }));
                    ASSERT_TRUE(s.find(i.nKey, [](value_type const &v, int key) {
                        EXPECT_EQ(v.key(), key);
                ...
                case 4:
                    ...
                    updResult = s.update(
                        i,
                        [](bool bNew, value_type &v, value_type const &arg) {
                            EXPECT_FALSE(bNew);
                            EXPECT_EQ(v.key(), arg.key());
                            ++v.nUpdateNewCount;
                        },
                ...
                case 5:
                    ...
                    updResult = s.update(
                        i.key(),
                        [](bool bNew, value_type &v, int arg) {
                            EXPECT_FALSE(bNew);
                            EXPECT_EQ(v.key(), arg);
                            ++v.nUpdateNewCount;
                        },
...
{
    typedef cc::StripedSet<typename TestFixture::container_type, cds::opt::hash<typename TestFixture::hash1>,
...
{
    typedef cc::StripedSet<typename TestFixture::container_type,
...
{
    typedef cc::StripedSet<typename TestFixture::container_type, cds::opt::mutex_policy<cc::striped_set::refinable<>>,
...
REGISTER_TYPED_TEST_CASE_P(StripedSet, compare, less, cmpmix, spinlock, load_factor_resizing, load_factor_resizing_rt,
                           single_bucket_resizing, single_bucket_resizing_rt, copy_policy_copy, copy_policy_move,
                           copy_policy_swap, copy_policy_special);

REGISTER_TYPED_TEST_CASE_P(RefinableSet, compare, less, cmpmix, spinlock, load_factor_resizing, load_factor_resizing_rt,
                           single_bucket_resizing, single_bucket_resizing_rt, copy_policy_copy, copy_policy_move,
                           copy_policy_swap, copy_policy_special);
