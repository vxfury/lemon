MACRO (ConfigureTarget target)
  ...
  IF (MSAN)
    ...
    TARGET_COMPILE_OPTIONS(
      ${target}
      PRIVATE $<$<COMPILE_LANG_AND_ID:C,AppleClang,Clang>:-fsanitize=memory
              -fsanitize-memory-track-origins -fno-omit-frame-pointer>
              $<$<COMPILE_LANG_AND_ID:CXX,AppleClang,Clang>:-fsanitize=memory
              -fsanitize-memory-track-origins -fno-omit-frame-pointer>
    )
  ENDIF ()
  ...
  IF (ASAN)
    ...
    TARGET_COMPILE_OPTIONS(
      ${target}
      PRIVATE $<$<COMPILE_LANG_AND_ID:C,AppleClang,Clang>:-fsanitize=address
              -fsanitize-address-use-after-scope -fno-omit-frame-pointer>
              $<$<COMPILE_LANG_AND_ID:CXX,AppleClang,Clang>:-fsanitize=address
              -fsanitize-address-use-after-scope -fno-omit-frame-pointer>
    )
    TARGET_LINK_OPTIONS(
      ${target} PRIVATE
      $<$<COMPILE_LANG_AND_ID:C,AppleClang,Clang>:-fsanitize=address
      -fsanitize-address-use-after-scope -fno-omit-frame-pointer>
      $<$<COMPILE_LANG_AND_ID:CXX,AppleClang,Clang>:-fsanitize=address
      -fsanitize-address-use-after-scope -fno-omit-frame-pointer>
    )
...
IF (COV)
  ...
  ADD_CUSTOM_TARGET(
    ...
    COMMAND ${GCOVR_COMMAND} -r ${CMAKE_SOURCE_DIR} --html --html-details
            ${CMAKE_BINARY_DIR}/report/coverage/full.html
    WORKING_DIRECTORY ${CMAKE_BINARY_DIR}
  )
  # cmake-format: on
  FILE(GLOB_RECURSE CLEAN_GCNOS ${PROJECT_BINARY_DIR}/*.gcno)
  FILE(GLOB_RECURSE CLEAN_GCDAS ${PROJECT_BINARY_DIR}/*.gcda)
  SET_PROPERTY(DIRECTORY APPEND PROPERTY ADDITIONAL_MAKE_CLEAN_FILES ${CLEAN_GCNOS} ${CLEAN_GCDAS})
ENDIF ()
